...
<li><a href="comercial.php">GESTION COMERCIAL</a></li>
  ...
  <form action="cotizacion_general_materia_prima_ref.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="MM_validateForm('Str_referencia_m','','R');return document.MM_returnValue"><table id="tabla2">
      <tr id="tr1">
        ...
        <td width="306" nowrap="nowrap" id="codigo">VERSION: 2 </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" id="fuente2">Nombre del Cliente</td>
      </tr>
      <tr>
        <td colspan="2" id="fuente1"><select name="clientes" id="clientes">
          <option value="">*</option>
          <?php
do {  
?>
...
?>
      ...
      <tr id="tr1">
        <td colspan="3" id="titulo2">MATERIA PRIMA</td>
      </tr>
      <tr id="tr1">
        <td colspan="4" id="titulo1">CARACTERISTICAS PRINCIPALES</td>
        </tr>
      <tr>
        <td id="fuente1">&nbsp;</td>
        <td id="fuente1">&nbsp;</td>
...
do {  
?>
          <option value="<?php echo $row_verlinc['id_mp_vta']?>"><?php echo $row_verlinc['Str_nombre']?></option>
          <?php
