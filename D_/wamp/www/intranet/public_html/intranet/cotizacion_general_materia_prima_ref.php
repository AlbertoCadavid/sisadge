...
$colname_ver_linc = "1";
if (isset($_GET['Str_referencia_m'])) 
{
  $colname_ver_linc = (get_magic_quotes_gpc()) ? $_GET['Str_referencia_m'] : addslashes($_GET['Str_referencia_m']);
}
mysql_select_db($database_conexion1, $conexion1);
$query_verlinc = sprintf("SELECT * FROM Tbl_mp_vta WHERE id_mp_vta",$colname_ver_linc);
...
<li><a href="comercial.php">GESTION COMERCIAL</a></li>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" onsubmit="MM_validateForm('Str_nit','','R','N_precio_vnta_m','','RisNum','N_cantidad_m','','RisNum');return document.MM_returnValue"><table id="tabla2">
      <tr id="tr1">
        <td width="187" nowrap="nowrap" id="codigo">CODIGO : R1-F08 </td>
        <td width="187" nowrap="nowrap" id="titulo2">Cotizacion Materia Prima</td>
      ...
      <tr>
        ...
        <input name="Str_nit" type="text" id="Str_nit" readonly="readonly" />
        </strong></td>
...
?>
      ...
      <tr>
        ...
        <td colspan="2" id="dato1">Crear Cliente <a href="perfil_cliente_add.php" target="_self">Aqu&iacute;</a></td>
        </tr>      
      <tr id="tr1">
      ...
      <tr>
        ...
        <td id="fuente1">Url Archivo Adjunto</td>
        <td colspan="2" id="fuente1"></td>
      </tr>
      <tr>
        <td id="fuente1"><select name="Str_referencia_m" id="Str_referencia_m">
          <option value="">*</option>
          <?php
do {  
?>
          <option value="<?php echo $row_verlinc['Str_nombre']?>*<?php echo $row_verlinc['Str_linc_archivo']?>"><?php echo $row_verlinc['Str_nombre']?></option>
          <?php
...
?>
        ...
        <td colspan="3" id="fuente1"> <?php echo $row_verlinc['Str_linc_archivo']; ?></td>
        </tr>
      <tr>
        <td id="fuente4">&nbsp;</td>
        <td id="fuente4">&nbsp;</td>
      ...
      <tr id="tr1">
        ...
        <tr>
          ...
          <td width="172" id="fuente1">Cantidad Unidades</td>
        </tr>
        <tr>
          <td  id="fuente1"><select name="Str_moneda_m" id="B_moneda_m">
            ...
            <input name="N_precio_vnta_m" type="text" id="N_precio_vnta_m" size="15" /></td>
          <td id="dato1">
          ...
          <td id="fuente1"><input name="N_cantidad_m" type="text" id="N_cantidad_m" value="" size="15" /></td>
        </tr>
        <tr>
          <td colspan="4" id="fuente1">Incoterms: </td>
        </tr>
        <tr>
          <td colspan="4" id="fuente1"><select name="Str_incoterms_m" id="Str_incoterms_m">
            <option value="">*</option>
            ...
            <a href="archivosc/CuadroIncoterms.pdf" target="_blank">Ver Cuadro</a></td>
      <tr>
        <td id="fuente1">&nbsp;</td>
        <td id="fuente1">&nbsp;</td>
        <td colspan="2" id="fuente1">&nbsp;</td>
      ...
      <tr>
        <td colspan="4" id="dato1"><textarea name="nota_m" cols="78" rows="2" id="nota_m"onKeyUp="conMayusculas(this)" onClick="this.value = ''">*</textarea></td>
      </tr>
      <tr>
        <td colspan="4" id="dato1">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="4" id="fuente2"><input name="responsable_modificacion" type="hidden" value="" />
