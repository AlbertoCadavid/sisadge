                      ...
                      ?> -->
                        ...
                        ?> -->
                              ...
                              <select class="busqueda selectsMini" name="mes" id="mes">
                                ...
                                do {
                                ?>
                                  <option value="<?php echo $row_mensual['id_mensual'] ?>" <?php if (!(strcmp($row_mensual['id_mensual'], $_GET['mes']))) {
                                                                                            echo "selected=\"selected\"";
                                                                                          } ?>>
  ...
  $(document).ready(function() {
    ...
    var alerta = "<?php echo $alerta ?>"
     if(alerta){
       ...
       window.location.assign(url+"produccion_registro_impresion_listado.php")
     }
  });
</script>
