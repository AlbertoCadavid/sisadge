...
//SELECT * FROM TblImpresionRollo ORDER BY id_op_r DESC
mysql_select_db($database_conexion1, $conexion1);
$var1 = $_GET['op'];
$var2 = $_GET['id_ref'];
$anyo = $_GET['anyo'];
...
if($var1!= '')
{
$query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE id_op='$var1' ORDER BY id_op DESC";
}
//FILTRA REF LLENO
if($var2 != '')
{
$query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE id_ref_op='$var2' ORDER BY id_op DESC";
}
//FILTRA MES LLENO
if($var3 !='')
{
$query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE MONTH(fecha_registro_op)='$var3' AND b_borrado_op='0' ORDER BY fecha_registro_op DESC";
}*/
...
{
  $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE  Tbl_orden_produccion.id_op NOT IN(SELECT TblImpresionRollo.id_op_r FROM TblImpresionRollo GROUP BY TblImpresionRollo.id_op_r DESC) AND Tbl_orden_produccion.id_op NOT IN(SELECT Tbl_reg_produccion.id_op_rp FROM Tbl_reg_produccion WHERE Tbl_reg_produccion.id_proceso_rp ='2') ORDER BY Tbl_orden_produccion.id_op DESC";
}
 //FILTRA ESTADO LIQUIDADO
if($var1 == '0' && $var2 == '0' && $var3 == '0' && $anyo=='0' && $estado =='1')
{
  $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE  Tbl_orden_produccion.id_op IN(SELECT TblImpresionRollo.id_op_r FROM TblImpresionRollo GROUP BY TblImpresionRollo.id_op_r DESC) AND Tbl_orden_produccion.id_op IN(SELECT Tbl_reg_produccion.id_op_rp FROM Tbl_reg_produccion WHERE Tbl_reg_produccion.id_proceso_rp ='2') ORDER BY Tbl_orden_produccion.id_op DESC";
}
//FILTRA SIN LIQUIDAR
...
//FILTRA OP LLENO
 ...
 if($var1 == '0' && $var2 == '0' && $var3 == '0' && $anyo!='0' && $estado =='0')
 {
   $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE YEAR(Tbl_orden_produccion.fecha_registro_op)='$anyo' AND Tbl_orden_produccion.id_op NOT IN(SELECT TblImpresionRollo.id_op_r FROM TblImpresionRollo GROUP BY TblImpresionRollo.id_op_r DESC) AND Tbl_orden_produccion.id_op NOT IN(SELECT Tbl_reg_produccion.id_op_rp FROM Tbl_reg_produccion WHERE Tbl_reg_produccion.id_proceso_rp ='2') ORDER BY Tbl_orden_produccion.id_op DESC";
 }
  //FILTRA ESTADO LIQUIDADO
 if($var1 == '0' && $var2 == '0' && $var3 == '0' && $anyo!='0' && $estado =='1')
 {
   $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE YEAR(Tbl_orden_produccion.fecha_registro_op)='$anyo' AND Tbl_orden_produccion.id_op IN(SELECT TblImpresionRollo.id_op_r FROM TblImpresionRollo GROUP BY TblImpresionRollo.id_op_r DESC) AND Tbl_orden_produccion.id_op IN(SELECT Tbl_reg_produccion.id_op_rp FROM Tbl_reg_produccion WHERE Tbl_reg_produccion.id_proceso_rp ='2') ORDER BY Tbl_orden_produccion.id_op DESC";
 }
 ...
 if($var1 == '0' && $var2 == '0' && $var3 != '0' && $anyo!='0' && $estado =='0')
 {
   $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE MONTH(Tbl_orden_produccion.fecha_registro_op)='$var3' AND YEAR(Tbl_orden_produccion.fecha_registro_op)='$anyo' AND Tbl_orden_produccion.id_op NOT IN(SELECT TblImpresionRollo.id_op_r FROM TblImpresionRollo GROUP BY TblImpresionRollo.id_op_r DESC) AND Tbl_orden_produccion.id_op NOT IN(SELECT Tbl_reg_produccion.id_op_rp FROM Tbl_reg_produccion WHERE Tbl_reg_produccion.id_proceso_rp ='2') ORDER BY Tbl_orden_produccion.id_op DESC";
 }
  //FILTRA ESTADO LIQUIDADO
 if($var1 == '0' && $var2 == '0' && $var3 != '0' && $anyo!='0' && $estado =='1')
 {
   $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE MONTH(Tbl_orden_produccion.fecha_registro_op)='$var3' AND YEAR(Tbl_orden_produccion.fecha_registro_op)='$anyo' AND Tbl_orden_produccion.id_op IN(SELECT TblImpresionRollo.id_op_r FROM TblImpresionRollo GROUP BY TblImpresionRollo.id_op_r DESC) AND Tbl_orden_produccion.id_op IN(SELECT Tbl_reg_produccion.id_op_rp FROM Tbl_reg_produccion WHERE Tbl_reg_produccion.id_proceso_rp ='2') ORDER BY Tbl_orden_produccion.id_op DESC";
 }
 //FILTRA SIN LIQUIDADO
 if($var1 == '0' && $var2 == '0' && $var3 != '0' && $anyo!='0' && $estado =='2')
 {
                ...
                <tr>
                  <td colspan="9" id="fuente2">
                    ...
                    <select class="busqueda selectsMini" name="mes" id="mes">
                      ...
                      do {  
                        ?>
                        <option value="<?php echo $row_mensual['id_mensual']?>"<?php if (!(strcmp($row_mensual['id_mensual'], $_GET['mes']))) {echo "selected=\"selected\"";} ?>>
                  ...
                  <select class='busqueda selectsMini' name="estado" id="estado">
                    <option value=""<?php if (!(strcmp("", $_GET['estado']))) {echo "selected=\"selected\"";} ?>>ESTADO</option>
                    <option value="0"<?php if (!(strcmp("0", $_GET['estado']))) {echo "selected=\"selected\"";} ?>>INGRESADA</option>
                    <option value="1"<?php if (!(strcmp("1", $_GET['estado']))) {echo "selected=\"selected\"";} ?>>LIQUIDADO</option>
                    <option value="2"<?php if (!(strcmp("2", $_GET['estado']))) {echo "selected=\"selected\"";} ?>>SIN LIQUIDAR</option>
                  </select> 
                    ...
                    <td id="dato2">
                     <?php if($existenuevamezcla >= '1' || $refNuevaNueva >= '1' ):  ?>
                      <?php if($procesoNuevo==2 ): ?>
                        <a href="javascript:popUp('view_index.php?c=cmezclasIm&a=Mezcla&cod_ref=<?php echo $refNueva;?>','870','710')"><img src="images/e.gif" style="cursor:hand;" alt="VISUALIZAR CARACTERISTICA" title="VISUALIZAR CARACTERISTICA" border="0" /></a>
                        ...
                        <?php endif; ?>
                        <?php else: ?>
                          <a href="javascript:popUp('view_index.php?c=cmezclasIm&a=Mezcla&cod_ref=<?php echo $id_ref_pr;?>','870','710')"><img src="images/e_rojo.gif" style="cursor:hand;" alt="LE FALTO AGREGAR LA MEZCLA DE ESTA REFERENCIA EN IMPRESION" title="LE FALTO AGREGAR LA MEZCLA DE ESTA REFERENCIA EN IMPRESION" border="0" /></a>
