...
case '1':
        ...
        $nitc=$_POST['Str_nit'];
           //echo $_POST['Str_referencia_m'];die;
        ...
        if($numestado >='1')
        {
         ...
         $refmp = $_POST['N_referencia'];
         $sqlmasterct="SELECT * FROM Tbl_cotiza_materia_p WHERE N_cotizacion ='$n_cot' and Str_referencia='$refmp' and Str_nit='$nit'";
         $resultmasterct= mysql_query($sqlmasterct);
         $nummasterct = mysql_num_rows($resultmasterct);
         if($nummasterct =='0')
           {
        ...
        $sqlmaster="SELECT * FROM Tbl_maestra_mp WHERE N_cotizacion ='$n_cot' and N_referencia='$refmp' and Str_nit='$nit'"; 
        $resultmaster= mysql_query($sqlmaster);
        $nummaster = mysql_num_rows($resultmaster);
        if($nummaster =='0')
          {
            //no se guarda en tbl_cliente_referencia como en las demas cotizaciones de bolsa lamina y pk
        ...
        header("location:cotizacion_g_materiap_vista.php?Str_nit=" . $_POST['Str_nit'] . "&N_cotizacion=" . $N_cotizacion .  "&tipo=" . $_POST['tipo_usuario'] );
...
case'3':
        ...
        $error = "Error al enviar el Archivo";
                ...
                $archivof = "archivosc/archivos_pdf_mp/".$nom1; 
              }
        }        

        //VERIFICAR SI EXISTE LA MATERIA PRIMA EN TBL_MP_VTA        
        $sqlmaster="SELECT * FROM Tbl_mp_vta WHERE id_mp_vta = ".$_POST['id_mp_vta']; 
        $resultmaster= mysql_query($sqlmaster);
        $nummaster = mysql_num_rows($resultmaster);
        if($nummaster =='0')
          {
               ...
               $msn = "No se guardo codigo: " .$_POST['id_mp_vta']. " porque ya existe!"; 
          }
                header('location:cotizacion_general_materia_prima_ref_nueva.php?msn='.$msn);
   break;
   return '0'; 
   case'4':
                ...
                $error = "Error al enviar el Archivo";
                        ...
                        $archivo = "archivosc/archivos_pdf_mp/".$nombre1; 
                       }	
                }	
