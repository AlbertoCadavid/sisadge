...
$sqlobsoleta="UPDATE Tbl_cotiza_laminas SET B_estado='3' WHERE N_cotizacion='$cotiz' and N_referencia_c='$ref' and Str_nit='$nitc'";//se deja obsoleta la ultima cotiz y queda activa esta ultima que se guarda
$resultobsoleta=mysql_query($sqlobsoleta);  
} 
$insertSQL = sprintf("INSERT INTO Tbl_cotiza_laminas (N_cotizacion, N_referencia_c, Str_nit, N_ancho, N_repeticion, N_calibre,Str_tipo_coextrusion,Str_capa_ext_coext,Str_capa_inter_coext,N_embobinado, Str_plazo,N_cantidad_metros_r, Str_incoterms, B_impresion, N_colores_impresion, B_cyreles, N_cantidad, N_peso_max, N_diametro_max, Str_moneda, N_precio_k, Str_unidad_vta, fecha_creacion, Str_usuario, N_comision, B_estado,B_generica,N_precio_old,impuesto,valor_impuesto) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$insertSQL2 =  "INSERT INTO Tbl_cotiza_lamina_obs ( N_cotizacion,N_referencia_c,Str_nit, texto) VALUES ($N_cotizacion,".$_POST['N_referencia'].",'".$_POST['Str_nit']."','".$_POST['nota_l']."')";
