...
//SI EL ITEM TIENE REMISIONES 
                      ...
                      <td id="talla2"><input type="hidden" name="items" id="items" value="<?php echo $row_detalle['id_items']; ?>"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000">

                        <?php echo $row_detalle['int_consecutivo_io']; ?></a></td>
                        <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>404.php','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['int_cod_ref_io']; ?></a></td>
                        <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php $mp=$row_detalle['id_mp_vta_io'];
                        $sqlmp="SELECT * FROM Tbl_mp_vta WHERE id_mp_vta='$mp'";
                        $resultmp= mysql_query($sqlmp);
                        $nump= mysql_num_rows($resultmp);
                        if($nump >='1')
                       ...
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['int_cod_cliente_io']; ?></a></td>
                       <td id="talla2"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['int_cantidad_io']; ?></a></td>
                       <td id="talla2"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php if($row_detalle['int_cantidad_rest_io']==''){echo '0.00';}else{echo $row_detalle['int_cantidad_rest_io'];} ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['str_unidad_io']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['str_moneda_io']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['trm']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['int_precio_trm']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['N_precio_old']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['fecha_entrega_io']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['fecha_modif_io']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['responsable_modif_io']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php $subtotal=$subtotal+ ($row_detalle['int_cantidad_io']*$row_detalle['N_precio_old']); echo ($row_detalle['int_cantidad_io']*$row_detalle['N_precio_old']);//$row_detalle['int_total_item_io']; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php $cad5 = htmlentities($row_detalle['str_direccion_desp_io']);echo $cad5; ?></a></td>
                       <td id="talla1"><a href="javascript:verFoto('orden_compra_cl_edit_detalle.php?id_oc=<?php echo $row_orden_compra['id_c_oc']; ?>&id_items=<?php echo $row_detalle['id_items']; ?>&fecha=<?php echo $row_orden_compra['fecha_ingreso_oc']; ?>&nit_c=<?php echo $row_cliente['nit_c']; ?>&id_mp_vta_io=<?php echo $row_detalle['id_mp_vta_io']; ?>&int_cod_ref_io=<?php echo $row_detalle['int_cod_ref_io']; ?>','1300','550')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_detalle['cobra_cyrel']==1 ? 'SI':'NO' ; ?></a></td>
