...
<td id="titular2">EVALUACION DE DESEMPE&Ntilde;O DEL PROVEEDOR DE <?php echo $row_proveedor['tipo_servicio_p'];?></td>
</tr>
...
<tr>
  ...
  <tr>
          <td colspan="12" id="fondo1">Insumos Criticos</td>
          <td colspan="10" id="fondo1">+ 7 DIAS</td>
   </tr>
            <?php do { ?>
