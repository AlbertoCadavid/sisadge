...
$fecha = $anual.'-'.$mes.'-'. $dia;
//Filtra todos vacios
if($n_oc== '0' && $codigo == '0' && $anual == '0' && $mes == '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY oc_ing DESC","",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos ORDER BY oc_ing DESC";
}
//Filtra n_oc lleno
if($n_oc != '0' && $codigo == '0' && $anual == '0' && $mes == '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY oc_ing DESC","WHERE oc_ing='$n_oc'",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE oc_ing = $n_oc";
}
//Filtra codigo lleno
if($n_oc == '0' && $codigo != '0' && $anual == '0' && $mes == '0' && $dia== '0' && $dia== '0')
{
  $row_ingresos= $conexion->buscarListar("tblingresos","*","ORDER BY oc_ing DESC","WHERE id_insumo_ing='$codigo'",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE id_insumo_ing = $codigo";
}
//Filtra año lleno
if($n_oc == '0' && $codigo == '0' && $anual != '0' && $mes == '0' && $dia== '0')
{
  $row_ingresos= $conexion->buscarListar("tblingresos","*","ORDER BY oc_ing DESC","WHERE YEAR(fecha_ing) = '$anual'",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE YEAR(fecha_ing) = '$anual'";
}
//Filtra mes lleno
if($n_oc == '0' && $codigo == '0' && $anual == '0' && $mes != '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY oc_ing DESC","WHERE MONTH(fecha_ing) = '$mes'",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE MONTH(fecha_ing) = '$mes'";
}
//Filtra menos dia
if($n_oc!= '0' && $codigo != '0' && $anual != '0' && $mes != '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY oc_ing DESC","WHERE oc_ing = $n_oc AND id_insumo_ing = $codigo AND YEAR(fecha_ing) = '$anual' AND MONTH(fecha_ing) = '$mes'",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE oc_ing = $n_oc AND id_insumo_ing = $codigo AND YEAR(fecha_ing) = '$anual' AND MONTH(fecha_ing) = '$mes'";
}
//todos llenos
if($n_oc!= '0' && $codigo != '0' && $anual != '0' && $mes != '0' && $dia != '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE oc_ing = $n_oc AND id_insumo_ing = $codigo AND fecha_ing = '$fecha'",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos="SELECT * FROM TblIngresos WHERE oc_ing = $n_oc AND id_insumo_ing = $codigo AND fecha_ing = '$fecha' order by fecha_ing DESC ";
}
//Filtra codigo, año y mes llenos
if($n_oc== '0' && $codigo != '0' && $anual != '0' && $mes != '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE id_insumo_ing = $codigo AND YEAR(fecha_ing) = $anual AND MONTH(fecha_ing) = '$mes' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE id_insumo_ing = $codigo AND YEAR(fecha_ing) = $anual AND MONTH(fecha_ing) = '$mes'";
}
//Filtra año y mes llenos
if($n_oc== '0' && $codigo == '0' && $anual != '0' && $mes != '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE YEAR(fecha_ing) = '$anual' AND MONTH(fecha_ing) = '$mes' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE YEAR(fecha_ing) = '$anual' AND MONTH(fecha_ing) = '$mes'";
}
//Filtra oc año y mes llenos
if($n_oc!= '0' && $codigo == '0' && $anual != '0' && $mes != '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE oc_ing = $n_oc AND  YEAR(fecha_ing) = '$anual' AND MONTH(fecha_ing) = '$mes' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE oc_ing = $n_oc AND  YEAR(fecha_ing) = '$anual' AND MONTH(fecha_ing) = '$mes'";
}
//Filtra oc y fecha llenos
if($n_oc!= '0' && $codigo == '0' && $anual != '0' && $mes == '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE oc_ing = $n_oc AND YEAR(fecha_ing) = '$anual' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE oc_ing = $n_oc AND YEAR(fecha_ing) = '$anual'";
}
//Filtra oc y mes llenos
if($n_oc!= '0' && $codigo == '0' && $anual == '0' && $mes != '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE oc_ing = $n_oc AND MONTH(fecha_ing) = '$mes' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE oc_ing = $n_oc AND MONTH(fecha_ing) = '$mes'";
}
//Filtra codigo y año llenos
if($n_oc== '0' && $codigo != '0' && $anual != '0' && $mes == '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE id_insumo_ing = $codigo AND YEAR(fecha_ing) = '$anual' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE id_insumo_ing = $codigo AND YEAR(fecha_ing) = '$anual'";
}
//Filtra codigo, y mes llenos
if($n_oc== '0' && $codigo != '0' && $anual == '0' && $mes != '0' && $dia== '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE id_insumo_ing = $codigo AND MONTH(fecha_ing) = '$mes' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE id_insumo_ing = $codigo AND MONTH(fecha_ing) = '$mes'";
}
//Filtra codigo, mes, dia llenos
if($n_oc== '0' && $codigo != '0' && $anual == '0' && $mes != '0' && $dia!= '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE id_insumo_ing = $codigo AND MONTH(fecha_ing) = '$mes' AND  DAY(fecha_ing) = '$dia' ",$maxRows_ingresos,$pageNum_ingresos,"" );
//$query_ingresos = "SELECT * FROM TblIngresos WHERE id_insumo_ing = $codigo AND MONTH(fecha_ing) = '$mes' AND  DAY(fecha_ing) = '$dia'";
}
//Filtra solo fechas
if($n_oc== '0' && $codigo == '0' && $anual != '0' && $mes != '0' && $dia!= '0')
{
  $row_ingresos = $conexion->buscarListar("tblingresos","*","ORDER BY fecha_ing DESC","WHERE fecha_ing = '$fecha' ",$maxRows_ingresos,$pageNum_ingresos,"" );
...
if (isset($_GET['totalRows_ingresos'])) {
  ...
  $totalRows_ingresos = $conexion->conteo('orden_compra_bolsas'); 
} 
$totalPages_ingresos = floor($totalRows_ingresos/$maxRows_ingresos)-1;

$queryString_ingresos = "";
if (!empty($_SERVER['QUERY_STRING'])) {
  $params = explode("&", $_SERVER['QUERY_STRING']);
  $newParams = array();
  foreach ($params as $param) {
    if (stristr($param, "pageNum_ingresos") == false && 
        stristr($param, "totalRows_ingresos") == false) {
      array_push($newParams, $param);
    }
  }
  if (count($newParams) != 0) {
    $queryString_ingresos = "&" . htmlentities(implode("&", $newParams));
  }
}
$queryString_ingresos = sprintf("&totalRows_ingresos=%d%s", $totalRows_ingresos, $queryString_ingresos);
  ...
  <td id="fuente2">
        ...
        <select class="selectsMedio busqueda" name="n_oc" id="n_oc">
         <option value="0"<?php if (!(strcmp("0", $_GET['n_oc']))) {echo "selected=\"selected\"";} ?>>O.C.</option>
            ...
            <option value="<?php echo $row_lista['oc_ing']?>"<?php if (!(strcmp($row_lista['oc_ing'], $_GET['n_oc']))) {echo "selected=\"selected\"";} ?>><?php echo $row_lista['oc_ing']?></option>
        ...
        <select class="selectsMedio busqueda" name="codigo" id="codigo">
         <option value="0"<?php if (!(strcmp("0", $_GET['codigo']))) {echo "selected=\"selected\"";} ?>>CODIGO</option>
            ...
            <option value="<?php echo $row_codigo['id_insumo']?>"<?php if (!(strcmp($row_codigo['id_insumo'], $_GET['codigo']))) {echo "selected=\"selected\"";} ?>><?php echo $row_codigo['codigo_insumo']?></option>
        ...
        <select class="selectsMedio busqueda" name="anual" id="anual">
         <option value="0"<?php if (!(strcmp("0", $_GET['anual']))) {echo "selected=\"selected\"";} ?>>A&Ntilde;O</option>
      ...
      <select class="selectsMedio busqueda" name="mes" id="mes">
       <option value="0"<?php if (!(strcmp("0", $_GET['mes']))) {echo "selected=\"selected\"";} ?>>MES</option>
         ...
         <option value="<?php echo $row_mes['id_mensual']?>"<?php if (!(strcmp($row_mes['id_mensual'], $_GET['mes']))) {echo "selected=\"selected\"";} ?>><?php echo $row_mes['mensual']?></option>
    ...
    <!--dias -->
      <select class="selectsMedio busqueda" name="dia" id="dia">
       <option value="0"<?php if (!(strcmp("0", $_GET['dia']))) {echo "selected=\"selected\"";} ?>>DIA</option>
