...
if($var1!= '')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM Tbl_reg_produccion WHERE id_op_rp='$var1' AND id_proceso_rp='2' GROUP BY id_op_rp DESC";
}
//FILTRA REF LLENO
if($var2 != '')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM Tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND id_proceso_rp='2' GROUP BY id_op_rp DESC";
}
//FILTRA MES LLENO
if($var3 != '')
{
...
if($var1 != '0' && $var2 == '0' && $var3 == '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA OP, AÑO LLENO
if($var1 != '0' && $var2 == '0' && $var3 == '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND YEAR(fecha_ini_rp)='$anyo' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA OP, MES LLENO
if($var1 != '0' && $var2 == '0' && $var3 != '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA OP, AÑO, MES LLENO
if($var1 != '0' && $var2 == '0' && $var3 != '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND YEAR(fecha_ini_rp)='$anyo' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF LLENO
if($var1 == '0' && $var2 != '0' && $var3 == '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF, AÑO LLENO
if($var1 == '0' && $var2 != '0' && $var3 == '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND YEAR(fecha_ini_rp)='$anyo' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF, MES LLENO
if($var1 == '0' && $var2 != '0' && $var3 != '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF, AÑO, MES LLENO
if($var1 == '0' && $var2 != '0' && $var3 != '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND YEAR(fecha_ini_rp)='$anyo' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA AÑO
if($var1 == '0' && $var2 == '0' && $var3 == '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE YEAR(fecha_ini_rp)='$anyo' AND id_proceso_rp='2' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA MES AÑO
if($var1 == '0' && $var2 == '0' && $var3 != '0' && $anyo != '0')
{
                        ...
                        { 
                          ...
                          { 
                           ...
                           <td id="dato2">
                            ...
                            if($rolloE > $rolloI ){  ?>
                              <a href="javascript:verFoto('produccion_impresion_stiker_rollo_add.php?id_op_r=<?php echo $row_orden_produccion['id_op_rp']; ?>','870','710')"><img src="images/mas.gif" alt="ADD ROLLOS" title="ADD ROLLOS" border="0" style="cursor:hand;" />
                              </a>
                           </td>       
                          <?php }else{?>
                            <a href="javascript:verFoto('produccion_impresion_listado_rollos.php?id_op_r=<?php echo $row_orden_produccion['id_op_rp']; ?>','870','710')"><img src="images/completo.gif" alt="COMPLETOS" title="COMPLETOS" border="0" style="cursor:hand;" />
                            </a>
                          <?php } ?>
                          <td id="dato2">
                           <?php 
                           ...
                           <td nowrap="nowrap" id="dato2">
                            ...
                            if($numrtintas >= '1') 
                              ...
                              <?php }else{?>
                                <a href="javascript:verFoto('produccion_regist_impre_kilos_prod.php?id_op=<?php echo $row_orden_produccion['id_op_rp']; ?>&amp;fecha=<?php echo $row_orden_produccion['fecha_ini_rp']; ?>&amp;rollo=<?php echo $id_ref_pm;?>&amp;id_ref=<?php echo $id_ref;?>','840','640')">sin tintas</a>  	    
                              <?php } ?>  
                            </td>      
                            <td nowrap="nowrap" id="dato2">
                              <?php
