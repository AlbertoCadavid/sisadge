          ...
          <td>
            <div class="panel panel-primary">
              ...
              <div class="row">
                ...
                <div class="span3">
                  <img src="images/ciclo1.gif" alt="RESTAURAR" border="0" style="cursor:hand;" onClick="window.history.go()" />
                  <img src="images/impresor.gif" onClick="window.print();" style="cursor:hand;" alt="IMPRIMIR" border="0" />
                  <?php if ($row_existe['correo'] == '') { ?>
                    <?php if ($row_existe['id_remision'] == '') { ?>
                      <a href="insumos_interno_entrada_salida_edit.php?id_remision=<?php echo $row_existe['id_remision']; ?>">
                        <img src="images/menos.gif" alt="EDITAR" border="0" /></a>
                    <?php } else { ?>
                      <a href="insumos_interno_entrada_salida_edit.php?id_remision=<?php echo $_GET['id_remision']; ?>">
                        <img src="images/menos.gif" alt="EDITAR" border="0" />
                      </a>
                    <?php } ?>
                  <?php } else { ?>
                    <?php if ($row_existe['id_remision'] == '') { ?>
                      <a href="insumos_devolucion_producto_terminado_edit.php?id_remision=<?php echo $row_existe['id_remision']; ?>">
                        <img src="images/menos.gif" alt="EDITAR" border="0" /></a>
                    <?php } else { ?>
                      <a href="insumos_devolucion_producto_terminado_edit.php?id_remision=<?php echo $_GET['id_remision']; ?>">
                        <img src="images/menos.gif" alt="EDITAR" border="0" />
                      </a>
                    <?php } ?>

                  <?php } ?>
                  <a href="insumos_interno_listado.php">
                    <img src="images/identico.gif" alt="LISTADO" border="0" />
                  </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
              ...
              <div class="panel-body">
                ...
                <div align="center">
                  <table>
                    <tr>
                      <td>
                        <h2 style="text-align: right;">REMISION <?php echo strtoupper($row_existe['entrada']); ?> </h2>
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <table class="table table-bordered table-sm">
                  ...
                  <tr>
                    <td align="center">
                      <h3> N&deg; <?php echo $row_existe['id_remision']; ?> </h3>
                    </td>
                  </tr>
                  <tr>
                ...
                <?php } else { ?>
                  <td colspan="5"><strong>EMAIL VENDEDOR: </strong><?php echo $row_existe['correo']; ?> </td>
            ...
            <table id="example" class="display" style="width:100%" border="1">
              <thead>
                <tr>
                  ...
                  <th>CANTIDAD</th>
                  <th>NUMERACION INICIAL</th>
                  <th>NUMERACION FINAL</th>
                  <th>NUM CAJA</th>
                  <th>ORDEN COMPRA</th>
                </tr>
              </thead>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var email = "<?php echo $row_existe['correo']; ?>";
    if (email != '') {
      consultasItemsVistaProdTerminado(id_remision)
    } else {
