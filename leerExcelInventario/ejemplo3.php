...
$rutaArchivo = __DIR__."/CARTERA.xlsx";
...
for ($indiceHoja = 0; $indiceHoja < $totalDeHojas; $indiceHoja++) {
    ...
    foreach ($hojaActual->getRowIterator() as $fila) {
        foreach ($fila->getCellIterator() as $celda) {
           ...
           /* if($columna.$fila && $fila >2 && $valorRaw!='' )
            echo "en $columna$fila valor $valorRaw<br>";*/
            echo "En <strong>$columna$fila</strong> tenemos el valor <strong>$valorRaw</strong><br> ";
