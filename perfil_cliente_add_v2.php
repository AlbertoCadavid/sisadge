...
$num1=mysql_num_rows($ver_bodegas);
 ...
 <script> 
  ...
  title="LISTADO CLIENTES" border="0" style="cursor:hand;"></a><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR"title="RESTAURAR" border="0" style="cursor:hand;"/></a></td>
       ...
       <tr>
       <td id="dato_1">NIT  000000000000000-000</td>
  ...
  <input type="text" id="nit_c" name="nit_c" value="" size="30" onChange="if (form1.nit_c.value) {MayusEspacio(this); DatosGestiones('1','nit_c',form1.nit_c.value); } else { alert('Debe digitar el NIT para validar su existencia en la BD'); };desapareceClick(this);" >
       ...
       <tr>
       <td id="dato_1"><input name="nombre_c" type="text" onBlur="MayusculaSinEspacios(this),desapareceClick(this)" onChange="if (form1.nombre_c.value) { DatosGestiones('2','nombre_c',form1.nombre_c.value); } else { alert('Debe digitar el Nombre para validar su existencia en la BD'); };desapareceClick(this);" value="" size="30" maxlength="100" required>      </td>
  ...
  /*   //CONSULTA PAIS        
    ...
    ?>
       ...
       <tr>
       <td id="dato_1"><input name="direccion_c" id="dirC" type="text" onBlur="copiadirC();conMayusculas(this)" value="" size="50" maxlength="150" required></td>
  ...
  /*   //CONSULTA CIUDADES      
    ...
    ?>
       ...
       <tr>
       <td id="dato_1"><input name="direccion_envio_factura_c" id="dirF" type="text"  value="" size="50" maxlength="100" required></td>
