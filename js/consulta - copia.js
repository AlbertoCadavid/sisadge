...
{
		 //RESTA FECHAS
		 if(document.getElementById("id_proceso_rp").value =='4') {var kilos_r = document.getElementById("int_total_kilos_rp").value;}
		 else{var kilos_r = (document.getElementById("int_kilos_prod_rp").value);}
		...
		//los tiempos muertos y standby termino minutos
 		var TotTiemKilxH=(DespTm);	 
			...
			var kilos_r = (document.getElementById("int_kilos_prod_rp").value)
		    var horas_real = document.getElementById("Optimo_rp").value; 
			 
            var elem = horas_real.split(':');
            var hora = parseInt(elem[0]*60);
            var minu = parseInt(elem[1]);
 			var TTMint = parseInt(hora + minu); //tiempo real en minutos
			var TDMint = parseInt(TTMint-DespTm);
    		var TsecKH = (TDMint*60);//con descuento tiempo convierto a segundos
   			var ThrsKH = Math.floor(TsecKH/3600);
			var TminuKH = Math.floor((TsecKH%3600)/60);
			if(TminuKH<10) TminuKH = "0" + TminuKH; 
			var horas_real_fin = ThrsKH + ":" + TminuKH + ":" + '00'
			document.getElementById("Optimo_rp").value= horas_real_fin 
			document.getElementById("horas_real").value = horas_real
			var minuto=parseFloat(minu/60);<!--minutos en terminos de hora-->
   			var KilosxtHT =(parseFloat(kilos_r)/parseFloat(ThrsKH+minuto)); 
 			var KilosxtHoraT = KilosxtHT.toFixed(2);
			...
			secKH = secKH % 60;
			if(secKH<10 && secKH > 0) secKH = "0" + secKH;   
			if(minuKH<10 && minuKH > 0) minuKH = "0" + minuKH; 
			...
			var minuRO = Math.floor((secRO%3600)/60); 
 			secRO = secRO % 60;
			if(secRO<10 && secRO>0) secRO = "0" + secRO;   
			if(minuRO<10 && minuRO>0) minuRO = "0" + minuRO; 
...
{
window.location ='cotizacion_general_bolsa_generica.php?id_ref='+document.form1.ref.value+'&N_cotizacion='+document.form1.N_cotizacion.value+'&Str_nit='+document.form1.Str_nit.value;
}
function consultaexistente3(selec) 
{
window.location ='cotizacion_general_bolsa_generica.php?id_ref='+document.form1.ref2.value+'&N_cotizacion='+document.form1.N_cotizacion.value+'&Str_nit='+document.form1.Str_nit.value;
}
...
function adelanto()
{
	...
	if(adelanto!=0){
    	var nuevo_total=(valortotal-adelanto)//ya tiene el valor iva; 
    	document.form1.total_oc.value=nuevo_total;

	}else{
		document.form1.total_oc.value=reserva_total_oc;
	}
...
function rte_fte(){
	...
	if(const_fte!=0){
	   ...
	   document.form1.fte_oc.value=valor_const_fte.toFixed(4);
	   ...
	   document.form1.total_oc.value=  (valor_total); 
		...
		document.form1.total_oc.value=parseFloat(document.form1.total_oc.value)+parseFloat(document.form1.fte_oc.value); 
...
function fte_iva(){
	...
	if(const_fte_iva!=0){
	   ...
	   document.form1.fte_iva_oc.value=valor_const_fte_iva.toFixed(4);
	   var total = parseFloat(reserva_total_oc)-(parseFloat(valor_const_fte_iva+total_todas));
	   var valor_total=total.toFixed(2); 
	   document.form1.total_oc.value=  (valor_total); 
	}else if(const_fte_iva==0){
		document.form1.total_oc.value=parseFloat(document.form1.total_oc.value)+parseFloat(document.form1.fte_iva_oc.value); 
...
function fte_ica(){
	...
	if(const_fte_ica!=0){
	   ...
	   document.form1.fte_ica_oc.value=valor_const_fte_ica.toFixed(4);
	   var total = parseFloat(reserva_total_oc)-(parseFloat(valor_const_fte_ica+total_todas));
	   var valor_total=total.toFixed(2); 
	   document.form1.total_oc.value=  (valor_total); 
	}else if(const_fte_ica==0){
		document.form1.total_oc.value=parseFloat(document.form1.total_oc.value)+parseFloat(document.form1.fte_ica_oc.value); 
		document.form1.fte_ica_oc.value=0
	}
}


function decimalesForm(input)
{
 totales = input.toLocaleString();
...
{
var rev=(parseInt(document.form1.reven_r.value) + parseInt(document.form1.corte_r.value) + parseInt(document.form1.calib_r.value) + parseInt(document.form1.arrug_r.value) + parseInt(document.form1.medid_r.value) + parseInt(document.form1.desca_r.value) + parseInt(document.form1.trata_r.value));
document.form1.bandera_r.value=rev;
}
//ESTIQUERS DE ROLLOS IMPRESION
function sumaBanderasI(){ 
	var suma = (parseInt(document.form1.desf_r.value)+ parseInt(document.form1.tante_r.value)+ parseInt(document.form1.manch_r.value)+ parseInt(document.form1.color_r.value)+ parseInt(document.form1.empat_r.value)+ parseInt(document.form1.medid_r.value)+ parseInt(document.form1.rasqueta_r.value));
...
alert("La numeracion inicial: "+cadena+adesde+" o final: "+cadena+ahasta+" de uno de los faltantes, no debe ser Menor que la numeracion inicial: "+cadena+Alfa+" del paquete")
return false; }
return true;
}
