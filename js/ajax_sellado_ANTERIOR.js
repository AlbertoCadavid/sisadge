// JavaScript Document
	...
	function getClientData(clientId,dato,rollo,dato2)
	{
		var client=clientId;
...
/*		var clientId2 = document.getElementById('clientID2').value.replace(/[^0-9]/g,'');
		...
		if( clientId!=currentClientID){
			...
			ajax.requestFile = 'consulta_registro_sellado.php?getClientId='+dato+'&getRollo='+dato2;// Specifying which file to get
