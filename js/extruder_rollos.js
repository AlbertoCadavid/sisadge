...
function parcial() {
  swal(
    ...
    function (isConfirm) {
      var txt;
      if (isConfirm === true) {
        swal("Liquidar Rollo!", "ok para Liquidar Total.", "success");
        txt = 0;
      } else if (isConfirm === false) {
        swal("Dejar Parcial", "ok para Dejar parcial :)", "error");
        txt = 1;
      } else {
...
function restaMetros() {
  ...
  if (metrolineal <= metroultimoparcial) {
    swal(
      "Error",
      "Los metros FINALES no pueden ser MENORES a los del PARCIAL",
      "error"
    );
...
function validaTodoExtruderVarios() {
  var indice0 = document.getElementById("montaje").value;
  var indice1 = document.getElementById("turno_r").value;
  var indice2 = document.getElementById("maquina").selectedIndex;
  var indice5 = document.getElementById("metro_r").value;
  var indice6 = document.getElementById("kilos_r").value;
  var indice7 = document.getElementById("num_rollos").value;
  var fecha_inicial = document.getElementById("fecha_ini_rp").value;
  var fecha_final = document.getElementById("fecha_fin_rp").value;

  if (indice7 == "") {
    swal("Error", "Seleccione la cantidad de rollos a ingresar!", "error");
    return false;
  } else if (indice0 == "") {
    swal("Error", "Seleccione el OPERARIO!", "error");
...
function validaTodoExtruderParcial() {
  var indice0 = document.getElementById("montaje").value;
  var indice1 = document.getElementById("turno_r").value;
  var indice2 = document.getElementById("maquina").selectedIndex;
  var indice5 = document.getElementById("metro_r").value;
...
function validaTodoExtruderVariosParciales() {
  var indice0 = document.getElementById("montaje").value;
  var indice1 = document.getElementById("turno_r").value;
  var indice2 = document.getElementById("maquina").selectedIndex;
  var indice5 = document.getElementById("metro_r").value;
  ...
  var fecha_inicial = document.getElementById("fecha_ini_rp").value;
  var fecha_final = document.getElementById("fecha_fin_rp").value;
  // Obtener todos los checkboxes con el nombre 'rollos_elegidos[]'
  var checkboxes = document.querySelectorAll('input[name="rollos_elegidos[]"]');
  ...
  if (!alMenosUnoSeleccionado) {
    swal("Error", "Debe seleccionar al menos un rollo.", "error");
