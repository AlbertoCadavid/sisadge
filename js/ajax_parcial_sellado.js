// JavaScript Document
	...
	function getClientData2(clientId,dato)
	{
		var client=clientId;
...
/*		var clientId2 = document.getElementById('clientID2').value.replace(/[^0-9]/g,'');
		...
		if( clientId!=currentClientID){
			...
			ajax.requestFile = 'consulta_registro_sellado_parcial.php?getClientId='+dato;// Specifying which file to get
	...
	{
		document.getElementById('clientId').onblur = getClientData2;
