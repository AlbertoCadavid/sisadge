...
WHERE a.tipo_empleado IN(5,10) AND b.fecha BETWEEN DATE_FORMAT('$FECHA_NOVEDAD_IMP', '%Y-%m-01') AND DATE_FORMAT('$FECHA_NOVEDAD_IMP', '%Y-%m-31')"; //IN(5,10)novedad impresion 
  ...
  $updateSQL2 = sprintf(
    "UPDATE Tbl_reg_produccion SET id_op_rp=%s, int_cod_ref_rp=%s, version_ref_rp=%s, rollo_rp=%s, int_kilos_prod_rp=%s, int_kilos_desp_rp=%s, int_total_kilos_rp=%s, int_totalKilos_tinta_rp=%s, porcentaje_op_rp=%s, int_metro_lineal_rp=%s, total_horas_rp=%s, rodamiento_rp=%s, horas_muertas_rp=%s, horas_prep_rp=%s, str_maquina_rp=%s, str_responsable_rp=%s, fecha_ini_rp=%s, fecha_fin_rp=%s, int_kilosxhora_rp=%s,int_metroxmin_rp=%s, int_cod_empleado_rp=%s, int_cod_liquida_rp=%s, costo=%s WHERE id_rp=%s",
...
<body onLoad="restakilosT();restakilosD();">
  ...
  <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="return validacion_unodelosdos_imp()">
    <table align="center" class="table table-bordered table-sm">
      ...
      <tr>
        <td colspan="4" id="numero2">ROLLO N&deg; <?php echo $row_rollo_impresion_edit['rollo_r'];
                                                  if ($max_rolloE != '') {
                                                    echo " de " . $max_rolloE;
                                                  } ?>
          ...
          <input type="hidden" name="id_rp" id="id_rp" value="<?php echo $row_liquidado_edit['id_rp']; ?>">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2" id="fuente1"><input type="number" name="ref_r" id="ref_r" min="0" max="20" style=" width:100px" value="<?php echo $row_rollo_impresion_edit['ref_r']; ?>" readonly>
          ...
          <input name="str_responsable_rp" type="hidden" id="str_responsable_rp" value="<?php echo $row_usuario['nombre_usuario']; ?>" />
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="fuente1"><select name="tratInter_r" id="tratInter_r" style="width:100px">
            <option value="N.A" <?php if (!(strcmp('N.A', $row_rollo_impresion_edit['tratInter_r']))) {
                                  echo "selected=\"selected\"";
                                } ?>>N.A</option>
            <option value="UNA CARA" <?php if (!(strcmp('UNA CARA', $row_rollo_impresion_edit['tratInter_r']))) {
                                        echo "selected=\"selected\"";
                                      } ?>>UNA CARA</option>
            <option value="DOBLE CARA" <?php if (!(strcmp('DOBLE CARA', $row_rollo_impresion_edit['tratInter_r']))) {
                                          echo "selected=\"selected\"";
                                        } ?>>DOBLE CARA</option>
          </select></td>
        <td id="fuente1">TRATADO EXTERNO</td>
        <td colspan="2" id="fuente1"><select name="tratExt_r" id="tratExt_r" style="width:100px">
            <option value="N.A" <?php if (!(strcmp('N.A', $row_rollo_impresion_edit['tratExt_r']))) {
                                  echo "selected=\"selected\"";
                                } ?>>N.A</option>
            <option value="UNA CARA" <?php if (!(strcmp('UNA CARA', $row_rollo_impresion_edit['tratExt_r']))) {
                                        echo "selected=\"selected\"";
                                      } ?>>UNA CARA</option>
            <option value="DOBLE CARA" <?php if (!(strcmp('DOBLE CARA', $row_rollo_impresion_edit['tratExt_r']))) {
                                          echo "selected=\"selected\"";
                                        } ?>>DOBLE CARA</option>
          </select></td>
      </tr>
      ...
      <tr>
        ...
        <td id="fuente1">
          ...
          <select name="cod_empleado_r" style="width:120px" id="operario" onFocus="">
            <option value="" <?php if (!(strcmp("", $row_rollo_impresion_edit['int_cod_empleado_r']))) {
                                echo "selected=\"selected\"";
                              } ?>>Seleccione</option>
            <?php foreach ($row_codigo_empleado as $row_codigo_empleado) { ?>
              <option value="<?php echo $row_codigo_empleado['codigo_empleado'] ?>" <?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $row_rollo_impresion_edit['cod_empleado_r']))) {
                                                                                      echo "selected=\"selected\"";
        ...
        <td colspan="2" id="fuente1">
          ...
          <select name="cod_auxiliar_r" style="width:120px" id="auxiliar">
            <option value="" <?php if (!(strcmp("", $row_rollo_impresion_edit['cod_auxiliar_r']))) {
                                echo "selected=\"selected\"";
                              } ?>>Seleccione</option>
            <?php foreach ($row_revisor as $row_revisor) { ?>
              <option value="<?php echo $row_revisor['codigo_empleado'] ?>" <?php if (!(strcmp($row_revisor['codigo_empleado'], $row_rollo_impresion_edit['cod_auxiliar_r']))) {
                                                                              echo "selected=\"selected\"";
      ...
      <tr>
        ...
        <td colspan="2" id="fuente1"><select name="str_maquina_rp" id="maquina" style="width:120px" onblur="validacion_unodelosdos_imp();">
            <option value="" <?php if (!(strcmp("", $row_liquidado_edit['str_maquina_rp']))) {
                                echo "selected=\"selected\"";
                              } ?>>Seleccione</option>
            <?php
            do {
            ?>
              <option value="<?php echo $row_maquinas['id_maquina'] ?>" <?php if (!(strcmp($row_maquinas['id_maquina'], $row_liquidado_edit['str_maquina_rp']))) {
                                                                          echo "selected=\"selected\"";
      ...
      <tr>
        ...
        <td id="fuente1"><input name="fechaI_r" id="fecha_ini_rp" type="datetime-local" min="2000-01-02" value="<?php echo muestradatelocal($row_rollo_impresion_edit['fechaI_r']); ?>" onChange="alerta2();restakilosT();" required />
          <input name="fechaExt" id="fechaExt" type="hidden" value="<?php echo $fechaExt; ?>">
        </td>
      ...
      <tr>
        ...
        <td id="fuente1">
          <input name="metro_r" type="number" id="metro_r" min="1" style="width:100px" required="required" value="<?php echo $metroExt == '' ? $row_rollo_impresion_edit['metro_r'] : $metroExt; ?>" <?php echo ($id_co != 501) ? 'readonly'  : ''; ?> onChange="restakilosT();" />
        ...
        <td id="fuente1" width='105px'><input name="metro_r2" type="number" id="metro_r2" min="1" style="width:100px" value="<?php echo $row_liquidado_edit['int_metro_lineal_rp'] == '' ? $row_rollo_impresion_edit['metro_r'] : $row_liquidado_edit['int_metro_lineal_rp']; ?>" required onChange="restakilosT();" <?php echo ($id_co != 501) ? 'readonly'  : ''; ?> /></td>
        <td id="fuente1">TIEMPO TOTAL</td>
        
      </tr>
      <tr>
        <td id="fuente1"><strong>PESO INICIAL:</strong></td>
        <td id="fuente7"><input type="number" name="int_kilos_prod_rp" id="int_kilos_prod_rp" size="12" style="width:100px" value="<?php echo $row_liquidado_edit['int_kilos_prod_rp']; ?>" <?php echo ($id_co != 501) ? 'readonly'  : ''; ?>>
        <input name="kilos_r" type="hidden" id="int_kilos_prod_rp2" min="1.00" step="0.01" style="width:100px" value="<?php echo $row_liquidado_edit['int_total_kilos_rp']; ?>" required readonly />
      </td>
      <td id="fuente1"><strong>PESO FINAL:</strong></td>
      <td id="fuente7"><input name="int_total_kilos_rp" type="number" id="int_total_kilos_rp" min="1.00" step="0.01" style="width:100px" value="<?php echo $row_liquidado_edit['int_total_kilos_rp']; ?>" required <?php echo ($id_co != 501) ? 'readonly'  : ''; ?> /></td>
              ...
              <?php for ($k = 0; $k <= $totalRows_tiempoMuerto - 1; $k++) { ?>
                <tr>
                  <td id="fuente1"><?php $id1 = mysql_result($tiempoMuerto, $k, id_rpt_rt);
                                    ...
                                    if ($numtm >= '1') {
                                      $nombre = mysql_result($resulttm, 0, 'nombre_rtp');
                                      echo $nombre;
                                    } ?>
                    <strong>
                  ...
                  <td id="fuente1"><?php $var1 = mysql_result($tiempoMuerto, $k, muertos);
                                    echo $var1;
                                    $totalTM = $totalTM + $var1; ?></td>
                  <td colspan="2" id="fuente1"><a href="javascript:eliminar_varias('id_rtei',<?php $delrt = mysql_result($tiempoMuerto, $k, id_rt);
                                                                                              echo $delrt; ?>,'id_r',<?php echo $row_rp_edit['id_r']; ?>,'produccion_impresion_stiker_rollo_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a></td>
                </tr><?php } ?>
              <tr>
              ...
              <?php for ($x = 0; $x <= $totalRows_tiempoPreparacion - 1; $x++) { ?>
                <tr>
                  ...
                  <td id="fuente1"><?php $var2 = mysql_result($tiempoPreparacion, $x, preparacion);
                                    echo $var2;
                                    $totalTP = $totalTP + $var2; ?></td>
                  <td colspan="2" id="fuente1"><a href="javascript:eliminar_varias('id_rpei',<?php $delrp = mysql_result($tiempoPreparacion, $x, id_rt);
                                                                                              echo $delrp; ?>,'id_r',<?php echo $row_rp_edit['id_r']; ?>,'produccion_impresion_stiker_rollo_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a></td>
                </tr>
              <?php } ?>
              <tr>
                <td id="fuente1">TOTAL</td>
              ...
              <?php for ($i = 0; $i <= $totalRows_desperdicio - 1; $i++) { ?>
                <tr>
                  <td id="fuente1"><?php $id3 = mysql_result($desperdicio, $i, id_rpd_rd);
                                    ...
                                    if ($numrtd >= '1') {
                                      $nombre2 = mysql_result($resultrtd, 0, 'nombre_rtp');
                                      echo $nombre2;
                                    } ?>
                  ...
                  <td id="fuente1"><?php $var3 = mysql_result($desperdicio, $i, desperdicio);
                                    echo $var3;
                                    $totalMDD = $totalMDD + $var3; ?>
                  </td>
                  <td colspan="2" id="fuente1"><a href="javascript:eliminar_varias('id_rdei',<?php $delrd = mysql_result($desperdicio, $i, id_rd);
                                                                                              echo $delrd; ?>,'id_r',<?php echo $row_rp_edit['id_r']; ?>,'produccion_impresion_stiker_rollo_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a></td>
                </tr>
              <?php } ?>
              <tr>
                <td id="fuente1">TOTAL</td>
                <td id="fuente1" above><strong>
                  ...
                  <input name="valor_desp_rd[]" type="hidden" id="valor_desp_rd[]" value="<?php echo $totalMDD; ?>" size="6" /> <!--onClick="getSumD();"--><!--importante porque me acumula lo ingresado-->
                </td>
                <td colspan="2" id="fuente1">&nbsp;</td>
              </tr>
            <?php } ?>
            ...
            <?php if ($row_totalTintas['op_rp'] != '') { ?>
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td colspan="3" id="fuente1"><?php $Cant = $row_totalTintas['valor_prod_rp'];
                                                echo $Cant;
                                                $TotalTintas += $Cant; ?></td>
                </tr>
