    ...
    <table id="tablainterna" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td nowrap id="detalle1"><?php $id_m = $row_orden_produccion['maquina_imp_op'];
                                  ...
                                  if ($numm >= '1') {
                                    $nombre_m = mysql_result($resultm, 0, 'nombre_maquina');
                                    $cm = $nombre_m;
                                    echo $cm;
                                  }
                                  ?></td>
                      ...
                      <?php for ($y = 0; $y <= 5; $y++) { ?><!--for ($y=0;$y<=$totalRows_unidad_uno-1;$y++)// TRAE TODOS LOS REGISTROS-->
                        <tr>
                          ...
                          <td id="talla1"><?php $var = mysql_result($unidad_uno, $y, descripcion_insumo);
                                          echo $var; ?></td>
                          <td id="talla1"><?php $var1 = mysql_result($unidad_uno, $y, str_valor_pmi);
                                          echo $var1; ?></td>
                        </tr> <?php  } ?>
                    </table>
                  <?php  } ?>
                    ...
                    <table>
                      ...
                      <?php for ($x = 0; $x <= 5; $x++) { ?><tr>
                          ...
                          <td id="talla1"><?php $var = mysql_result($unidad_dos, $x, descripcion_insumo);
                                          echo $var; ?></td>
                          <td id="talla1"><?php $var1 = mysql_result($unidad_dos, $x, str_valor_pmi);
                                          echo $var1; ?></td>
                        </tr> <?php  } ?>
                    </table>
                  <?php  } ?>
                    ...
                    <table>
                      ...
                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                          ...
                          <td id="talla1"><?php $var = mysql_result($unidad_tres, $y, descripcion_insumo);
                                          echo $var; ?></td>
                          <td id="talla1"><?php $var1 = mysql_result($unidad_tres, $y, str_valor_pmi);
                                          echo $var1; ?></td>
                        </tr>
                      <?php  } ?>
                    </table>
                    ...
                    <table>
                      ...
                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                          ...
                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_cuatro, $y, str_nombre_m);
                                                  echo $id_m; ?></td>
                          <td id="detalle1"><?php $var = mysql_result($unidad_cuatro, $y, descripcion_insumo);
                                            echo $var; ?></td>
                          <td id="talla1"><?php $var = mysql_result($unidad_cuatro, $y, str_valor_pmi);
                                          echo $var; ?></td>
                        </tr>
                      <?php  } ?>
                    </table>
                    ...
                    <table>
                      ...
                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                          ...
                          <td id="talla1"><?php $var = mysql_result($unidad_cinco, $y, descripcion_insumo);
                                          echo $var; ?></td>
                          <td id="talla1"><?php $var = mysql_result($unidad_cinco, $y, str_valor_pmi);
                                          echo $var; ?></td>
                        </tr>
                      <?php  } ?>
                    </table>
                    ...
                    <table>
                      ...
                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                          ...
                          <td id="talla1"><?php $var = mysql_result($unidad_seis, $y, descripcion_insumo);
                                          echo $var; ?></td>
                          <td id="talla1"><?php $var = mysql_result($unidad_seis, $y, str_valor_pmi);
                                          echo $var; ?></td>
                        </tr>
                      <?php  } ?>
                    </table>
                    ...
                    <table>
                      ...
                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                          ...
                          <td id="talla1"><?php $var = mysql_result($unidad_siete, $y, descripcion_insumo);
                                          echo $var; ?></td>
                          <td id="talla1"><?php $var = mysql_result($unidad_siete, $y, str_valor_pmi);
                                          echo $var; ?></td>
                        </tr>
                      <?php  } ?>
                    </table>
                    ...
                    <table>
                      ...
                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                          ...
                          <td id="talla1"><?php $var = mysql_result($unidad_ocho, $y, descripcion_insumo);
                                          echo $var; ?></td>
                          <td id="talla1"><?php $var = mysql_result($unidad_ocho, $y, str_valor_pmi);
                                          echo $var; ?></td>
                        </tr>
                      <?php  } ?>
                    </table>
      ...
      <tr>
        <?php for ($x = 0; $x <= $totalRows_caract_valor - 1; $x++) { ?>
          <td width="130" id="fuente3"><?php $id_cv = mysql_result($caract_valor, $x, id_cv);
        ...
        <td colspan="9">
          <table width="100%">
            ...
            <tr>
              ...
              <td id="detalle1"><?php echo $row_ref_op['solapa_ref']; ?> <?php if ($row_ref_op['b_solapa_caract_ref'] == 2) {
                                                                            echo "Sencilla";
                                                                          } else if ($row_ref_op['b_solapa_caract_ref'] == 1) {
                                                                            echo "Doble";
                                                                          } else {
                                                                            echo "";
                                                                          } ?></td>
            ...
            <tr>
              ...
              <td id="detalle1"><?php $medicaja = $row_ref_op['marca_cajas_egp'];
                                ...
                                if ($numCAJ >= '1') {
                                  $nombre_CAJ = mysql_result($resultCAJ, 0, 'descripcion_insumo');
                                  echo $nombre_CAJ;
                                }
                                ?>
              </td>
              <td id="detalle1"><?php if ($row_ref_op['B_troque'] == '1') {
                                  echo "SI";
                                } else {
                                  echo "NO";
                                }; ?></td>
            ...
            <tr>
              ...
              <td id="detalle1"><?php $id_ter = $row_orden_produccion['id_termica_op'];
                                ...
                                if ($numterm >= '1') {
                                  $nombre_term = mysql_result($resultterm, 0, 'descripcion_insumo');
                                  echo $nombre_term;
                                }
                                ?></td>
