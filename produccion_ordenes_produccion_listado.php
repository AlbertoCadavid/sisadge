                          ...
                          <td id="titulo1">
                            <div class="row">
                              ...
                              <select id='op' name='op' class="selectsMini">
                                <option value='0' <?php if (!(strcmp(0, $_GET['op']))) {
                              ...
                              <select id='id_ref' name='id_ref' class="selectsMini">
                                <option value='0' <?php if (!(strcmp(0, $_GET['id_ref']))) {
                                                    echo "selected=\"selected\"";
                                                  } ?>>- REF: -</option>
                              </select> <!-- lleno con Ajax -->
                              ...
                              <select id='cliente' name='cliente' class="selectsGrande">
                                <option value='0' <?php if (!(strcmp(0, $_GET['cliente']))) {
                                                    echo "selected=\"selected\"";
                                                  } ?>>- CLIENTE -</option>
                              </select> <!-- lleno con Ajax -->
                              ...
                              <select id='anyo' name='anyo' class="">
                                ...
                                <?php foreach ($row_anual as $row_anual) { ?>
                                  <option value="<?php echo $row_anual['anual']; ?>" <?php if (!(strcmp($row_anual['anual'], $Year))) {
                                                                                        echo "selected=\"selected\"";
                      ...
                      <table>
                        ...
                        <?php foreach ($row_orden_produccion as $row_orden_produccion) {  ?>
                          <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                            ...
                            <td id="dato2"><a class="editar" href="produccion_op_vista.php?id_op=<?php echo $row_orden_produccion['id_op']; ?>" target="_top" style="text-decoration:none; color:#000000"></a><a class="editar" href="produccion_op_vista.php?id_op=<?php echo $row_orden_produccion['id_op']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_orden_produccion['fecha_registro_op']; ?></a></td>
                            ...
                            <td id="dato2">
                              ...
                              if ($sqlImpresion == '') {
                                $title = "LE FALTO AGREGAR LAS CARACTERISTICA DE ESTA REFERENCIA EN IMPRESION";
                                $control = "cmezclasIm";
                              }
                              ?>
                              <?php if ($numExtruder == '') {
                                $title = "LE FALTO AGREGAR LAS CARACTERISTICA DE ESTA REFERENCIA EN EXTRUDER";
                                $control = "cmezclas"; ?>
