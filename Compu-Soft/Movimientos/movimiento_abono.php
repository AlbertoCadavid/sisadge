...
<center>
	<form method="POST" action="movimiento_abono2.php" id="formulario" >
	<!-- INICIO SECCION MOVIMIENTO DE CLIENTE!-->
<fieldset><legend><b>Movimientos Abonos</b></legend>
  
  <?php echo '<select name="criterio">'.$options_cliente2.'</select>'; ?>
