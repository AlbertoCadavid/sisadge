...
$query_movimiento = ("SELECT * FROM mov_servicios, equipos WHERE modelo = serv_modelo AND  serv_fecha > DATE_SUB( CURDATE( ) , INTERVAL DAYOFMONTH( CURDATE( ) )DAY ) ORDER BY serv_fecha DESC");//mov_fecha > DATE_SUB( CURDATE( ) , INTERVAL DAYOFMONTH( CURDATE( ) )DAY ) ORDER BY mov_fecha DESC");
