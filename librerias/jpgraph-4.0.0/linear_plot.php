...
//agrupar tipo de desperdicio por mes y sumar  el total
...
$graph->title->Set('Evolución de Desperdicios y Tiempos');
$graph->SetBox(false);
...
$graph->Add($p1);
$p1->SetColor("#6495ED");
$p1->SetLegend('Tiempos Muertos');

// Create the second line
$p2 = new LinePlot($datay2);
$graph->Add($p2);
$p2->SetColor("#B22222");
$p2->SetLegend('Tiempos Preparacion');

// Create the third line
$p3 = new LinePlot($datay3);
$graph->Add($p3);
$p3->SetColor("#FF1493");
$p3->SetLegend('Desperdicios');
