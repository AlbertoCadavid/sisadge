 ...
 * @since 			18/05/2008	=> Se comenzo el agregado de Formateo de Campos.
 * @version 		1.2	(05/09/2009) Pasaje de Conexion Mysqli para consultas a base de datos.
 * @version         1.3 (11/04/2010) Cambio de ereg por preg_match para compatibilidad con php 5.3
 *                                   Mejoras para que en algunos casos no de 1 dia de menos.  
 */
class Exportar
{	
    /**
	...
	*/
	 ...
	 */
  	...
  	{	$funcion = $this->datosPOST[$campo][3];
		...
		if(isset($this->datosPOST[$campo][1]) && $this->datosPOST[$campo][1]!=0  && $this->datosPOST[$campo][10]!="auto_increment")
