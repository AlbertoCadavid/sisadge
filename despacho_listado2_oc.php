...
/*$row_numero = $conexion->llenaSelect('tbl_remisiones',"WHERE b_borrado_r='0'",'ORDER BY int_remision DESC'); 
...
$fecha = $anual . '-' . $mes . '-' . $dia;
$vende = $_GET['vende'];
$facturanoSpaces = preg_replace('/\s+/', '', $_GET['nfactura']);
$nfactura = $facturanoSpaces;

//Filtra todos vacios
if ($str_numero == '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
...
if ($str_numero != '0' && $id_c != '0' && $cod_ref != '0' && $int_remision != '0' && $estado_oc > '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  ...
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.id_c_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'GROUP BY tbl_remisiones.int_remision ORDER BY tbl_remisiones.int_remision DESC', '', $maxRows_registros, $pageNum_registros, "WHERE Tbl_remisiones.int_remision='$int_remision' AND Tbl_remisiones.b_borrado_r='0' AND Tbl_remisiones.str_numero_oc_r='$str_numero' and Tbl_items_ordenc.int_cod_ref_io = '$cod_ref' AND tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido AND Tbl_orden_compra.id_c_oc='$id_c'
  AND Tbl_orden_compra.b_estado_oc='$estado_oc'");
}
//Filtra remision lleno
if ($str_numero == '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision != '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  $registros = $conexion->buscarListar('tbl_remisiones', '*', 'ORDER BY int_remision ASC', "", $maxRows_registros, $pageNum_registros, "WHERE int_remision='$int_remision' AND b_borrado_r='0'");
  //$registros = $conexion->buscarListar('tbl_remisiones','tbl_remisiones.comprobante_file, ciudad_pais,str_transportador_r,factura_r,int_remision,str_numero_oc_r,fecha_r,str_guia_r,b_borrado_r','ORDER BY int_remision ASC',"",$maxRows_registros,$pageNum_registros,"WHERE int_remision='$int_remision' AND b_borrado_r='0'");
...
if ($str_numero == '0' && $id_c != '0' && $cod_ref == '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  ...
  tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'GROUP BY tbl_orden_compra.str_numero_oc ORDER BY  tbl_remisiones.fecha_r DESC', '', $maxRows_registros, $pageNum_registros, "WHERE tbl_orden_compra.id_c_oc='$id_c' AND tbl_orden_compra.str_numero_oc=tbl_remisiones.str_numero_oc_r AND tbl_remisiones.b_borrado_r='0' AND b_borrado_r='0' ");
}
...
//Filtra , cliente y O.C llenos.
if ($str_numero != '0' && $id_c != '0'  && $cod_ref == '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_remisiones.fecha_r,
  tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'GROUP BY tbl_orden_compra.str_numero_oc ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE Tbl_remisiones.b_borrado_r='0' AND Tbl_remisiones.str_numero_oc_r='$str_numero' AND 
  tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido AND Tbl_orden_compra.id_c_oc='$id_c' ");
}
...
if ($str_numero == '0' && $id_c != '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc', 'tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_items_ordenc.int_cod_ref_io,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', '', $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and Tbl_orden_compra.str_numero_oc = Tbl_items_ordenc.str_numero_io and Tbl_items_ordenc.int_cod_ref_io = '$cod_ref' and Tbl_orden_compra.id_c_oc='$id_c' and Tbl_remisiones.b_borrado_r='0'");
}

//Filtra remision y estado lleno
if ($str_numero == '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision != '0' && $estado_oc > '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones', 'tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE Tbl_remisiones.int_remision='$int_remision' AND Tbl_remisiones.b_borrado_r='0' AND tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido AND
...
if ($str_numero != '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision == '0' && $estado_oc > '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  ...
  Tbl_remisiones.str_numero_oc_r='$str_numero' AND Tbl_remisiones.b_borrado_r='0' AND tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido AND 
  Tbl_orden_compra.b_estado_oc='$estado_oc'");
}
//Filtra remision y O.C. lleno
if ($str_numero != '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision != '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  $registros = $conexion->buscarListar('tbl_remisiones', 'tbl_remisiones.comprobante_file, ciudad_pais,str_transportador_r,factura_r,int_remision,b_borrado_r,str_numero_oc_r,fecha_r,str_guia_r', 'ORDER BY int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE int_remision='$int_remision' AND b_borrado_r='0' AND str_numero_oc_r='$str_numero'");
}
...
if ($str_numero != '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision != '0' && $estado_oc > '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  ...
  Tbl_remisiones.int_remision='$int_remision' AND Tbl_remisiones.b_borrado_r='0' AND  Tbl_remisiones.str_numero_oc_r='$str_numero' AND tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido AND Tbl_orden_compra.b_estado_oc='$estado_oc'");
}
...
if ($str_numero == '0' && $id_c != '0' && $cod_ref == '0' && $int_remision != '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  ...
  Tbl_remisiones.int_remision='$int_remision' AND Tbl_remisiones.b_borrado_r='0' AND tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido AND Tbl_orden_compra.id_c_oc='$id_c'");
}
...
if ($str_numero == '0' && $id_c != '0' && $cod_ref == '0' && $int_remision != '0' && $estado_oc > '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  ...
  tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido AND Tbl_orden_compra.b_estado_oc='$estado_oc' AND Tbl_orden_compra.id_c_oc='$id_c' ");
}

//Filtra estado llenos y vendedor
if ($str_numero == '0' && $id_c == '0' && $cod_ref == '0' && $int_remision == '0' && $estado_oc > '0' && $estado_rd != '' && $anual == '0' && $mes == '0' && $dia == '0' && $vende > '0' && $nfactura == '0') {
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref == '0' && $int_remision == '0' && $estado_oc != '0' && $estado_rd == '0' && $anual != '0' && $mes != '0' && $dia == '0' && $vende != '0' && $nfactura == '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_remisiones.fecha_r,
  tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.b_borrado_r='0' and year(tbl_remisiones.fecha_r) = '$anual' and month(tbl_remisiones.fecha_r) = '$mes' AND tbl_orden_compra.b_estado_oc='$estado_oc' AND tbl_orden_compra.str_elaboro_oc='$vendedor' AND  tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido");
}

//Filtra VENDEDOR Y ESTADO
if ($str_numero == '0' && $id_c == '0'   && $cod_ref == '0' && $int_remision == '0' && $estado_oc != '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende != '0' && $nfactura == '0') {
  if ($vende != '0') {
    $elvendedor = $conexion->llenarCampos("vendedor", "WHERE id_vendedor=$vende", "", "nombre_vendedor");
    $vendedor = $elvendedor['nombre_vendedor'];
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones', ' tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc, 
tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.b_borrado_r='0' and tbl_orden_compra.str_elaboro_oc='$vendedor' AND tbl_orden_compra.b_estado_oc='$estado_oc' and tbl_orden_compra.id_pedido=tbl_remisiones.id_pedido_oc");
}


//Filtra FECHA(año,mes,dia) y vendedor
if ($str_numero == '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0'  && $anual != '0' && $mes != '0' && $dia != '0' && $vende != '0' && $nfactura == '0') {
  if ($vende != '0') {
    $elvendedor = $conexion->llenarCampos("vendedor", "WHERE id_vendedor=$vende", "", "nombre_vendedor");
    $vendedor = $elvendedor['nombre_vendedor'];
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones ', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_remisiones.fecha_r,
  tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.b_borrado_r='0' and tbl_remisiones.fecha_r =  '$fecha'  and tbl_orden_compra.str_elaboro_oc='$vendedor' and tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido ");
}
//Filtra FECHA(año,mes) y vendedor
if ($str_numero == '0' && $id_c == '0'  && $cod_ref == '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0'  && $anual != '0' && $mes != '0' && $dia == '0' && $vende != '0' && $nfactura == '0') {
  if ($vende != '0') {
    $elvendedor = $conexion->llenarCampos("vendedor", "WHERE id_vendedor=$vende", "", "nombre_vendedor");
    $vendedor = $elvendedor['nombre_vendedor'];
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones ', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_remisiones.fecha_r,
  tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.b_borrado_r='0' and year(tbl_remisiones.fecha_r) = '$anual' and month(tbl_remisiones.fecha_r) = '$mes' and tbl_orden_compra.str_elaboro_oc='$vendedor' and tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido ");
}
...
{
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc','*','ORDER BY tbl_remisiones.int_remision DESC',"",$maxRows_registros,$pageNum_registros,"WHERE tbl_remisiones.b_borrado_r='0' and tbl_remisiones.fecha_r = '$fecha' and tbl_items_ordenc.int_vendedor_io = '$vende' and tbl_remisiones.str_numero_oc_r=tbl_orden_compra.str_numero_oc");  
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende != '0' && $nfactura == '0') {
  ...
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and tbl_orden_compra.str_numero_oc = tbl_items_ordenc.str_numero_io and tbl_items_ordenc.int_cod_ref_io = '$cod_ref' and tbl_orden_compra.str_elaboro_oc='$vendedor' and tbl_remisiones.b_borrado_r='0'");
}
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual != '0' && $mes != '0' && $dia != '0' && $vende != '0' && $nfactura == '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_items_ordenc.int_cod_ref_io,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.b_estado_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and tbl_orden_compra.str_numero_oc = tbl_items_ordenc.str_numero_io and tbl_remisiones.fecha_r = '$fecha' and tbl_items_ordenc.int_cod_ref_io = '$cod_ref' and tbl_orden_compra.str_elaboro_oc='$vendedor' and tbl_remisiones.b_borrado_r='0'");
}
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual != '0' && $mes == '0' && $dia == '0' && $vende != '0' && $nfactura == '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_items_ordenc.int_cod_ref_io,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and Tbl_orden_compra.str_numero_oc = Tbl_items_ordenc.str_numero_io  AND YEAR(Tbl_remisiones.fecha_r) = '$anual' AND  Tbl_items_ordenc.int_cod_ref_io = '$cod_ref' AND tbl_orden_compra.str_elaboro_oc='$vendedor' AND Tbl_remisiones.b_borrado_r='0'");
}
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes != '0' && $dia == '0' && $vende != '0' && $nfactura == '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_items_ordenc.int_cod_ref_io,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and Tbl_orden_compra.str_numero_oc = Tbl_items_ordenc.str_numero_io  AND MONTH(Tbl_remisiones.fecha_r) = '$mes' AND  Tbl_items_ordenc.int_cod_ref_io = '$cod_ref' and tbl_orden_compra.str_elaboro_oc='$vendedor' AND Tbl_remisiones.b_borrado_r='0'");
}
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual != '0' && $mes != '0' && $dia == '0' && $vende != '0' && $nfactura == '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_items_ordenc.int_cod_ref_io,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and Tbl_orden_compra.str_numero_oc = Tbl_items_ordenc.str_numero_io  AND YEAR(Tbl_remisiones.fecha_r) = '$anual' AND  MONTH(Tbl_remisiones.fecha_r) = '$mes' AND  Tbl_items_ordenc.int_cod_ref_io = '$cod_ref' AND tbl_orden_compra.str_elaboro_oc='$vendedor' AND Tbl_remisiones.b_borrado_r='0'");
}
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual != '0' && $mes != '0' && $dia != '0' && $vende == '0' && $nfactura == '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_items_ordenc.int_cod_ref_io,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and Tbl_orden_compra.str_numero_oc = Tbl_items_ordenc.str_numero_io  AND tbl_remisiones.fecha_r =  '$fecha' AND  Tbl_items_ordenc.int_cod_ref_io = '$cod_ref' AND tbl_items_ordenc.int_cod_ref_io = '$cod_ref' AND Tbl_remisiones.b_borrado_r='0'");
}
//Filtra ref y AÑO
if ($str_numero == '0' && $id_c == '0'   && $cod_ref != '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual != '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura == '0') {
  if ($vende != '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra,tbl_remisiones,tbl_items_ordenc', 'DISTINCT tbl_remisiones.comprobante_file, tbl_remisiones.ciudad_pais,tbl_remisiones.str_transportador_r,tbl_remisiones.factura_r,tbl_remisiones.int_remision,tbl_remisiones.b_borrado_r,tbl_remisiones.str_numero_oc_r,tbl_items_ordenc.int_cod_ref_io,
  tbl_remisiones.fecha_r,tbl_remisiones.str_guia_r,tbl_orden_compra.str_numero_oc,tbl_orden_compra.b_estado_oc,tbl_remisiones.id_pedido_oc,tbl_orden_compra.id_c_oc', 'ORDER BY tbl_remisiones.int_remision DESC', "", $maxRows_registros, $pageNum_registros, "WHERE tbl_remisiones.id_pedido_oc=tbl_orden_compra.id_pedido and Tbl_orden_compra.str_numero_oc = Tbl_items_ordenc.str_numero_io  AND YEAR(Tbl_remisiones.fecha_r) = '$anual' AND  Tbl_items_ordenc.int_cod_ref_io = '$cod_ref' AND tbl_items_ordenc.int_cod_ref_io = '$cod_ref' AND Tbl_remisiones.b_borrado_r='0'");
}
...
if ($str_numero == '0' && $id_c == '0'   && $cod_ref == '0' && $int_remision == '0' && $estado_oc == '0' && $estado_rd == '0' && $anual == '0' && $mes == '0' && $dia == '0' && $vende == '0' && $nfactura != '0') {
  ...
  $registros = $conexion->buscarListar('tbl_orden_compra as tc, tbl_remisiones as tr', 'tr.*, tc.*', '', '', $maxRows_registros, $pageNum_registros, "WHERE tr.b_borrado_r = '0' and tr.factura_r LIKE '$nfactura%' AND tc.pago_pendiente <> 'SI' AND tc.id_pedido = tr.id_pedido_oc");
}
                            ...
                            <div class="row">
                              ...
                              <div class="main">
                                <select id='int_remision' name='int_remision' style='width: 200px;'>
                                  <option value='0' <?php if (!(strcmp(0, $_GET['int_remision']))) {
                                                      echo "selected=\"selected\"";
                                                    } ?>>- Buscar Remision -</option>
                                </select>
                              </div>

                              <div class="main">
                                <select id='str_numero' name='str_numero' style='width: 200px;'>
                                  <option value='0' <?php if (!(strcmp(0, $_GET['str_numero']))) {
                                                      echo "selected=\"selected\"";
                                                    } ?>>- Buscar O.C. -</option>
                                </select>
                              </div>
                              ...
                              <div class="main">
                                <select id='cod_ref' name='cod_ref' style='width: 200px;'>
                                  <option value='0' <?php if (!(strcmp(0, $_GET['cod_ref']))) {
                                                      echo "selected=\"selected\"";
                                                    } ?>>- Buscar Ref. -</option>
                                </select>
                              </div>
                              ...
                              <div class="main">
                                <select id='id_c' name='id_c' style='width: 200px;'>
                                  <option value='0' <?php if (!(strcmp(0, $_GET['id_c']))) {
                                                      echo "selected=\"selected\"";
                                                    } ?>>- Buscar Cliente -</option>
                                </select>
                              </div>

                              <div class="main">
                                <select id='nfactura' name='nfactura' style="width:150px">
                                  <option value='0' <?php if (!(strcmp(0, $_GET['nfactura']))) {
                                                      echo "selected=\"selected\"";
                                                    } ?>>- # Factura -</option>
                                </select>
                              </div>
                        ...
                        <tr>
                          <td>
                            <select name="estado_oc" id="estado_oc" style="width:180px">
                              <option value="0" <?php if (!(strcmp(0, $_GET['estado_oc']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>Estado O.C</option>
                              <option value="3" <?php if (!(strcmp(3, $_GET['estado_oc']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>Remisionada</option>
                              <option value="4" <?php if (!(strcmp(4, $_GET['estado_oc']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>Fact. Parcial</option>
                              <option value="5" <?php if (!(strcmp(5, $_GET['estado_oc']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>Fact. Total</option>
                              <option value="6" <?php if (!(strcmp(6, $_GET['estado_oc']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>Muestras reposicion</option>

                              </option>
                            </select>
                            <select name="estado_rd" id="estado_rd" style="width:120px">
                              <option value="0" <?php if (!(strcmp(0, $row_remision_detalle['estado_rd']))) {
                                                  echo "selected=\"selected\"";
                                                } ?> selected>Despachado</option>
                              <option value="1" <?php if (!(strcmp(1, $row_remision_detalle['estado_rd']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>Pendiente</option>
                            </select>
                            <select name="fecha" id="fecha" style="width:120px">
                              <option value="0" <?php if (!(strcmp("", $_GET['fecha']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>ANUAL</option>
                              <?php foreach ($row_ano as $row_ano) { ?>
                                <option value="<?php echo $row_ano['anual'] ?>" <?php if (!(strcmp($row_ano['anual'], $_GET['fecha']))) {
                                                                                  echo "selected=\"selected\"";
                                                                                } ?>><?php echo $row_ano['anual'] ?></option>
                              <?php } ?>
                            </select>
                            <select name="mensual" id="mensual" style="width:120px">
                              <option value="0" <?php if (!(strcmp("", $_GET['mensual']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>MENSUAL</option>
                              <?php foreach ($row_mensual as $row_mensual) { ?>
                                <option value="<?php echo $row_mensual['id_mensual'] ?>" <?php if (!(strcmp($row_mensual['id_mensual'], $_GET['mensual']))) {
                                                                                          echo "selected=\"selected\"";
                                                                                        } ?>><?php echo $row_mensual['mensual'] ?></option>
                              <?php } ?>
                            </select>
                            <!--dias -->
                            ...
                            <select name="dia" id="dia" style="width:60px">
                              <option value="0" <?php if (!(strcmp("", $_GET['dia']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>DIA</option>
                              <?php foreach ($row_dia as $row_dia) { ?>
                                <option value="<?php echo $row_dia['dia'] ?>" <?php if (!(strcmp($row_dia['dia'], $_GET['dia']))) {
                                                                                echo "selected=\"selected\"";
                                                                              } ?>><?php echo $row_dia['dia'] ?></option>
                              <?php } ?>
                            </select>
                            <select name="vende" id="vende" style="width:90px">
                              <option value="0" <?php if (!(strcmp("0", $_GET['vende']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>Vendedor</option>
                              <?php foreach ($row_vendedores as $row_vendedores) { ?>
                                <option value="<?php echo $row_vendedores['id_vendedor'] ?>" <?php if (!(strcmp($row_vendedores['id_vendedor'], $_GET['vende']))) {
                                                                                              echo "selected=\"selected\"";
                                                                                            } ?>><?php echo $row_vendedores['nombre_vendedor'] ?></option>
                              <?php } ?>
                            </select>
                  </div>
                  <br>
  ...
  <form action="delete_listado.php" method="get" name="seleccion">
    <table id="tabla1">
      <tr>
        ...
        <td colspan="2"><?php if (isset($_GET['id'])) {
                          $id = $_GET['id'];
                        } else {
                          $id = '';
                        }
        ...
        <td colspan="2" id="dato3">
          ...
          <a href="despacho_oc.php"><img src="images/mas.gif" alt="ADD DESPACHO" title="ADD DESPACHO" border="0" style="cursor:hand;" /></a><a href="despacho_oc.php"><img src="images/o.gif" style="cursor:hand;" alt="INGRESAR DESPACHOS" title="INGRESAR DESPACHOS" border="0" /></a><a href="despacho_listado1_oc.php"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;" /></a>
        </td>
      </tr>
      <tr>
      ...
      <?php $row_remision['factura_r'] = 0;
      foreach ($registros as $row_remision) {  ?>
        <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
          ...
          <td nowrap id="dato1"><a href="despacho_items_oc_vista.php?int_remision=<?php echo $row_remision['int_remision']; ?>" target="_blank" style="text-decoration:none; color:#000000">
              ...
              //$sqln = $conexion->llenarCampos('cliente,tbl_orden_compra', "WHERE tbl_orden_compra.id_c_oc = cliente.id_c and tbl_orden_compra.str_numero_oc='$str_numero_oc_r' ", '','cliente.nombre_c,cliente.ciudad_c' ); diferencia con el anterior es el tbl_orden_compra.str_numero_oc=
              //$sqln = $conexion->llenarCampos('cliente', "WHERE cliente.id_c='$id_c_oc' ", '','cliente.nombre_c,cliente.ciudad_c' ); deshabilitado 30-07-2024 porque no aparecia el nombre del cliente en el listado

              $cliente_c = $sqln['nombre_c'];
              echo  htmlentities($cliente_c);
          ...
          <td id="dato2">
            <a href="despacho_items_oc_vista.php?int_remision=<?php echo $row_remision['int_remision']; ?>" target="_blank" style="text-decoration:none; color:#000000">
              <?php if ($b_estado_oc == '5') {
                echo "Facturado Total";
              } else if ($b_estado_oc == '4') {
                echo "Facturado Parcial";
              } else if ($b_estado_oc == '1') {
                echo "Ingresado";
              } else if ($b_estado_oc == '2') {
                echo "Programado";
              } else if ($b_estado_oc == '3') {
                echo "Remisionado";
              } else if ($b_estado_oc == '6') {
...
<script>
  ...
  function alertaDescarga(){
    swal({
      title: "Descarga en Curso!",
      type: "success",
      text: "La descarga iniciara en breve, Esto puede tomar algun tiempo",
      timer: 5000,
...
*/
  ...
  if (alerta) {
    ...
    window.location.assign(url + "despacho_listado1_oc.php")
  }
