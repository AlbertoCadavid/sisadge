function numeracionDesdeAdd(numDesde,caja,paquete,ref='',selladoadd='') { 
		  			    ...
		  			    type:  'post', 
		  			  	     ...
		  			  	     if(data) {
		  		                 ...
		  		                 $('.referenci').text(data[i].int_cod_ref_op); 
		  			  	         $('.paqhasta').text(data[i].int_undxcaja_op / data[i].int_undxpaq_op);
		  	                     $(".charfin").val(data[i].charfin); 
		  	                        consultaCajaPaqAddNew('cod_ref_n',data[i].int_cod_ref_op,data[i].int_hasta_tn);//se cambio cod_ref_n ref_tn
		  	                     //valida si desde o.p dice que no lleva faltantes  
			     ...
			     if(data) { 
			       ...
			       for (i = 0; i < data.length; i++) { 
                       ...
                       var sellado = 1;
     			       ...
     			       numeracionDesdeAdd(numeracionIni,data[i].int_caja_n,data[i].int_paquete_n,ref,sellado); 
                       ...
                       var numeracionIni = numeracionInicial==undefined ? "0" : numeracionInicial; 
     			       ...
     			       numeracionDesdeAdd(numeracionIni,caja,paquete,ref,sellado);//esto es porque la ref nunca se ha sellado  y no existe en tablas de sellado
