                          ...
                          <td>
                              ...
                              <select name="vende" id="vende" class="selectsMini">
                                ...
                                <?php foreach ($row_vendedores as $row_vendedores) { ?>
                                  <option value="<?php echo $row_vendedores['id_vendedor']; ?>" <?php if (!(strcmp($row_vendedores['nombre_vendedor'], $_GET['vende']))) {
                                                                                                  echo "selected=\"selected\"";
                                                                                                } ?>><?php echo htmlentities($row_vendedores['nombre_vendedor']); ?> </option>
                                <?php } ?>
                              </select>
