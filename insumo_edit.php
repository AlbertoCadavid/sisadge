...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  if($_POST['pantone'] != ""){
    $txtnoSpaces = preg_replace('/\s+/', '',$_POST['pantone'] );
    $upperCase = strtoupper($txtnoSpaces);
    $_POST['pantone'] = " PANTONE:".$upperCase;
  }
  if($_POST['indice_insumo'] != ""){
    $_POST['indice_insumo'] = $_POST['indice_insumo']." ";
  }
  $_POST['descripcion_insumo'] = $_POST['indice_insumo'].$_POST['descripcion_insumo'].$_POST['pantone'];

  $updateSQL = sprintf(
    "UPDATE insumo SET codigo_insumo=%s, descripcion_insumo=%s, clase_insumo=%s, medida_insumo=%s, tipo_insumo=%s, valor_unitario_insumo=%s, stok_insumo=%s, estado_insumo=%s,quimicos=%s WHERE id_insumo=%s",
...
mysql_select_db($database_conexion1, $conexion1);
$query_indices = "SELECT * FROM insumos_clases_indices as ci INNER JOIN clase as c ON ci.id_clase = c.id_clase INNER JOIN indices as i ON ci.id_indice = i.id_i WHERE ci.id_clase = $row_insumo_edit[clase_insumo] ORDER BY i.nombre ASC";
                  ...
                  <td colspan="2" align="center" id="linea1">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                      <table id="tabla2">
                        ...
                        <tr>
                          <td id="fuente1"><input type="number" min="1" step="1" style="width:120px" name="codigo_insumo" value="<?php echo $row_insumo_edit['codigo_insumo']; ?>" required></td>
                        </tr>
                        <tr>
                          <td id="fuente1">TIPO DE INSUMO </td>
                        </tr>
                        <tr>
                          <td id="fuente1"><select name="tipo_insumo" style="width:120px">
                              <option value="" <?php if (!(strcmp("", $row_insumo_edit['tipo_insumo']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>></option>
                              <?php
                              do {
                              ?>
                                <option value="<?php echo $row_tipo['id_tipo'] ?>" <?php if (!(strcmp($row_tipo['id_tipo'], $row_insumo_edit['tipo_insumo']))) {
                                                                                      echo "selected=\"selected\"";
                                                                                    } ?>><?php echo $row_tipo['nombre_tipo'] ?></option>
                              <?php
                        ...
                        <tr>
                          <td id="fuente1">
                            <select name="clase_insumo" style="width:120px;">
                              <option value="" <?php if (!(strcmp("", $row_insumo_edit['clase_insumo']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>></option>
                              <?php
                              do {
                              ?>
                                <option value="<?php echo $row_clases['id_clase'] ?>" <?php if (!(strcmp($row_clases['id_clase'], $row_insumo_edit['clase_insumo']))) {
                                                                                        echo "selected=\"selected\"";
                                                                                      } ?>><?php echo $row_clases['nombre_clase'] ?></option>
                              <?php
                        ...
                        <tr>
                          <td id="fuente3">INDICE</td>
                          <td id="fuente1">DESCRIPCION</td>
                          <td id="fuente1" class="pantone" style="display:none">PANTONE</td>
                        </tr>
                        <tr>
                        <td id="dato3">
                          <select name="indice_insumo" id="indice_insumo" style="width:50px;">
                            <option value="">Seleccionar</option>
                              <?php
                              do { 
                              ?>
                                <option value="<?php echo $row_indices['nombre'] ?>"><?php echo $row_indices['nombre'] ?></option>
                              <?php
                              } while ($row_indices = mysql_fetch_assoc($indices));
                              $rows = mysql_num_rows($indices);
                              if ($rows > 0) {
                                mysql_data_seek($indices, 0);
                                $row_indices = mysql_fetch_assoc($indices);
                              }
                              ?>
                            </select>
                            </td>
                          <td id="fuente1"><input type="text" name="descripcion_insumo" required value="<?php echo $row_insumo_edit['descripcion_insumo']; ?>" size="40" onChange="MayusculaSinEspacios(this)"></td>
                          <td id="dato1"><input name="pantone" class="pantone" style="display:none" type="text" value="" size="10" onChange="MayusculaSinEspacios(this)"></td>
                        </tr>
                        <tr>
                          <td id="fuente1"></td>
                        ...
                        <tr>
                          <td id="fuente1"></td>
                          <td id="fuente1">
                            <select name="medida_insumo" style="width:120px">
                              <option value="" <?php if (!(strcmp("", $row_insumo_edit['medida_insumo']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>></option>
                              <?php
                              do {
                              ?>
                                <option value="<?php echo $row_medidas['id_medida'] ?>" <?php if (!(strcmp($row_medidas['id_medida'], $row_insumo_edit['medida_insumo']))) {
                                                                                          echo "selected=\"selected\"";
                                                                                        } ?>><?php echo $row_medidas['nombre_medida'] ?></option>
                              <?php
                        ...
                        <tr>
                          <td id="fuente1"></td>
                          <td id="fuente1">
                            <input type="text" name="valor_unitario_insumo" required value="<?php echo $row_insumo_edit['valor_unitario_insumo']; ?>" style="width:120px">
                          </td>
                        ...
                        <tr>
                          <td id="fuente1"></td>
                          <td id="dato1">
                            <select name="quimicos" id="quimicos" style="width:120px">
                              <option value="0" <?php if (!(strcmp("0", $row_insumo_edit['quimicos']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>SELECCIONE...</option>
                              <option value="SUSTANCIAS QUIMICAS" <?php if (!(strcmp("SUSTANCIAS QUIMICAS", $row_insumo_edit['quimicos']))) {
                                                                    echo "selected=\"selected\"";
                                                                  } ?>>SUSTANCIAS QUIMICAS</option>
                        ...
                        <tr>
                          <td id="fuente1"></td>
                          <td><input type="number" name="stok_insumo" id="stok_insumo" min="0" step="any" required value="<?php echo $row_insumo_edit['stok_insumo']; ?>" style="width:120px" /></td>
                        </tr>
                        <tr>
                        <td id="fuente1"></td>
                        ...
                        <tr>
                        <td id="fuente1"></td>
                          <td><label for="estado_insumo"></label>
                            <select name="estado_insumo" id="estado_insumo">
                              <option value="0" <?php if (!(strcmp("0", $row_insumo_edit['estado_insumo']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>ACTIVO</option>
                              <option value="1" <?php if (!(strcmp("1", $row_insumo_edit['estado_insumo']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>INACTIVO</option>
                            </select>
                          </td>
                        ...
                        <td id="fuente1"></td>
                          <td id="fuente1" nowrap="nowrap">
                            <span onclick="consultaProveedor('','<?php echo $row_insumo_edit['id_insumo']; ?>')"><img src="images/mas.gif" style="cursor:hand;" alt="AGREGAR" title="AGREGAR PROVEEDOR" border="0"></span>
                          </td>
                        ...
                        <td id="fuente1"></td>
                          <td id="fuente1" nowrap="nowrap">
                            ...
                            ?>
                              ...
                              <span onclick="eliminaProv('id_pi','<?php echo $row_proveedores['id_pi']; ?>' )"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR" title="ELIMINAR PROVEEDOR" border="0"></span>
                              <span onclick="consultaProveedor('<?php echo $row_proveedores['id_pi']; ?>', '')"><img src="images/menos.gif" style="cursor:hand;" alt="EDITAR" title="CAMBIAR PROVEEDOR" border="0"></span>
                        ...
                        <tr>
                          ...
                          <td id="dato9"><input name="Fecha" id="Fecha" type="hidden" required min="2015-01-01" value="<?php echo date('Y-m-d'); ?>" style="width:150px" />
                            <input name="responsable" id="responsable" type="hidden" value="<?php echo $row_usuario['nombre_usuario']; ?>" />
                          </td>
                        </tr>
...
$(document).ready(function() {
  ...
  let clase = '<?php echo $row_insumo_edit['clase_insumo']?>';
  let descripcion = '<?php echo $row_insumo_edit['descripcion_insumo']?>';
  let pantone = /PANTONE:\s*([A-Za-z0-9_]\d+)/i;
  let txtpantone = descripcion.match(pantone)

  if(clase == 8 && txtpantone === null){ //Impresion(materia prima)
    $('.pantone').css('display', 'block')
    } else {
      $('.pantone').css('display', 'none')
    }
})
  ...
  function consultaProveedor(id_pi, id_in) {
    $.ajax({
      data: {
        traerProveedores: "SI",
      },
      ...
      success: function(data) {
        if (data != 0) {
          ...
          object.forEach((element) => {
            //provee[element.id_p] = element.proveedor_p;
            provee[element.proveedor_p] = element.proveedor_p;
          });
            ...
            inputValidator: (value) => {
              return new Promise((resolve) => {
                if (value) {
                  ...
                  resolve("Debes seleccionar un Proveedor");
                }
              });
            },
          }).then((result) => {
            if (result.isConfirmed) {
              let proveedor = result.value;
              let idSeleccionado;
              
              object.forEach((elemnt) => {
                if (elemnt.proveedor_p.trim() == proveedor) {
                  idSeleccionado = elemnt.id_p;
                }
              });
              ...
              if (id_pi != "" && id_in == "") {
                Swal.fire({
                  title: "Actualizar",
                  text: `Esta seguro de actualizar el Proveedor ${proveedor}`,
                  icon: "warning",
                  showCancelButton: true,
                  ...
                  if (result.isConfirmed) {
                    actualizarProveedor(id_pi, idSeleccionado, id_in, "update")
                  }
                });
              } else if (id_pi == "" && id_in != "") {
                Swal.fire({
                  title: "Agregar",
                  text: `Esta seguro de agregar el Proveedor ${proveedor}`,
                  icon: "warning",
                  showCancelButton: true,
                  confirmButtonColor: "#3085d6",
                  cancelButtonColor: "#d33",
                  ...
                  if (result.isConfirmed) {
                    actualizarProveedor(id_pi, idSeleccionado, id_in, "create")
                  }
                });
              }
          ...
          Swal.fire({
            icon: "error",
            title: "Oops...",
            text: "Proveedor no existe, Escribelo de nuevo",
          });
        }
      },
      error: function(xhr, status, error) {
        console.log(error);
        swal("Proveedor no existe", JSON.parse(data));
      },
    });
  }

  /* Actualiza o Agrega un proveedor */
  function actualizarProveedor(id_pi, id_p, id_in, accion) {

    $.ajax({
      type: "POST",
      url: "AjaxControllers/Actions/update.php",
      data: {
        actualizarProveedor: accion,
        id_pi: id_pi,
        id_p: id_p,
        id_in: id_in,
      },
