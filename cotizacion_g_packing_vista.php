...
//CODIGO PARA VISUALIZACION DE LA COTIZACION OBS
$colname_ver_nueva = "1";
if (isset($_GET['N_cotizacion'])) 
{
...
mysql_select_db($database_conexion1, $conexion1);
$query_ver_texto = sprintf("SELECT * FROM Tbl_cotiza_packing_obs WHERE Tbl_cotiza_packing_obs.N_cotizacion = %s", $colname_ver_nueva);
...
FROM Tbl_cotiza_packing,cliente 
WHERE
Tbl_cotiza_packing.N_cotizacion='%s' and
Tbl_cotiza_packing.Str_nit=cliente.nit_c and
Tbl_cotiza_packing.B_generica='0'", $colname_ver_nueva);//Tbl_cotiza_packing.B_estado<>'2'desaparece las rechazadas de la vista
...
mysql_select_db($database_conexion1, $conexion1);
$query_ver_existente = sprintf("SELECT * FROM Tbl_cotiza_packing,Tbl_referencia,cliente WHERE Tbl_cotiza_packing.N_cotizacion='%s' AND 
Tbl_cotiza_packing.N_referencia_c=Tbl_referencia.cod_ref and
Tbl_cotiza_packing.Str_nit=cliente.nit_c and
Tbl_cotiza_packing.B_generica='1'", $colname_ver_existente);
...
mysql_select_db($database_conexion1, $conexion1);
$query_ver_ref = sprintf("SELECT * FROM Tbl_cotiza_packing,Tbl_cotizaciones WHERE Tbl_cotizaciones.N_cotizacion=%s AND  Tbl_cotizaciones.N_cotizacion=Tbl_cotiza_packing.N_cotizacion", $colname_ver_ref);
...
{ ?>
      <table id="tablainterna" >
        ...
        <tr>
		  ...
		  echo $linc="<a href='cotizacion_general_packingList_edit.php?N_cotizacion=$var2&amp;cod_ref=$var&amp;Str_nit=$var3&amp;tipo=$_GET[tipo]'><strong>".$var."</strong></a>";?></td>
          <?php } ?>
        </tr>
        <tr>
		  ...
		  <?php $var=mysql_result($ver_nueva,$j,N_ancho); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">ALTO(cm)</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
		  <td id="fuente2">
		  <?php $var=mysql_result($ver_nueva,$j,N_alto); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">CALIBRE</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2">
            <?php $var=mysql_result($ver_nueva,$j,N_calibre); echo $var; ?>		  </td><?php }?>
        </tr> 
        <tr>
        ...
        <tr>
          ...
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_nueva,$j,B_impresion); if($var==0){echo "NO";}else{echo "SI";}?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">CYRELES</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_nueva,$j,B_cyreles); if($var=='0'){ echo "ACYCIA"; }else if($var=='1'){echo "SE LE FACTURA";}else if($var==''){echo "N.A";}  ?></td><?php }?>
        </tr>
          <td id="subppal4">BOCA ENTRADA</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_nueva,$j,Str_boca_entrada); echo $var; ?></td>
          <?php }?>
</tr>
        <tr>
          <td id="subppal4">UBIC. ENTRADA</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_nueva,$j,Str_ubica_entrada); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">LAMINA 1</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_nueva,$j,Str_lam1); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">LAMINA 2</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_nueva,$j,Str_lam2); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">CANTIDAD SOLICITADA</td>
          <?php  for ($j=0;$j<=$num1-1;$j++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_nueva,$j,N_cantidad); echo $var; ?></td>
          <?php }?>
        </tr>
        <tr>
...
{ ?>
      <table id="tablainterna" >
        ...
        <tr>
          ...
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
		  <td  width="530"id="fuente2">
		  <?php $var=mysql_result($ver_existente,$i,ancho_ref); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">ALTO(cm)</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
		  <td id="fuente2">
		  <?php $var=mysql_result($ver_existente,$i,largo_ref); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">CALIBRE</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2">
            <?php $var=mysql_result($ver_existente,$i,calibre_ref); echo $var; ?>		  </td><?php }?>
        </tr> 
        <tr>
          <td id="subppal4">INCOTERMS</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2">
		  <?php $var=mysql_result($ver_existente,$i,Str_incoterms);	echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">PRECIO UNIDAD + IMPUESTO</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2">
		  <?php $var=mysql_result($ver_existente,$i,Str_moneda); echo $var; ?>/<?php $var=mysql_result($ver_existente,$i,N_precio_old); echo $var; ?></td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">IMPRESION</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_existente,$i,B_impresion); if($var==0){echo "NO";}else{echo "SI";}?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">CYRELES</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_existente,$i,B_cyreles); if($var=='0'){ echo "ACYCIA"; }else if($var=='1'){echo "SE LE FACTURA";}else if($var==''){echo "N.A";}  ?></td><?php }?>
        </tr>
          <td id="subppal4">BOCA ENTRADA</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_existente,$i,Str_boca_entr_p); echo $var; ?></td>
          <?php }?>
</tr>
        <tr>
          <td id="subppal4">UBIC. ENTRADA</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_existente,$i,Str_entrada_p); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">LAMINA 1</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_existente,$i,Str_lamina1_p); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">LAMINA 2</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_existente,$i,Str_lamina2_p); echo $var; ?>		  </td><?php }?>
        </tr>
        <tr>
          <td id="subppal4">CANTIDAD SOLICITADA</td>
          <?php  for ($i=0;$i<=$num2-1;$i++) { ?>
          <td id="fuente2"><?php $var=mysql_result($ver_existente,$i,N_cantidad); echo $var; ?></td>
          <?php }?>
        </tr>
        <tr>
          <td id="subppal4">PLAZO DE PAGO</td>
...
<table id="tablainterna" align="center">
  <tr>
    <td id="noprint" align="center"><?php if($_GET['tipo']=='1' || $_GET['tipo']=='2') { ?><a href="cotizacion_general_packingList_edit.php?N_cotizacion=<?php echo $_GET['N_cotizacion']; ?>&Str_nit=<?php echo $row_cotizacion_cliente['Str_nit']; ?>&cod_ref=<?php echo $ver_existente2['N_referencia_c']; ?>"><img src="images/menos.gif" alt="EDICION"title="EDITAR" border="0" style="cursor:hand;"></a><a href="cotizacion_general_packingList_generica.php?N_cotizacion=<?php echo $_GET['N_cotizacion']; ?>&Str_nit=<?php echo $row_cotizacion_cliente['Str_nit']; ?>"><img src="images/mas.gif" alt="ADD A LA COTIZACION"title="ADD A LA COTIZACION" border="0" style="cursor:hand;"/></a><?php } ?><img src="images/impresor.gif" onclick="window.print();" style="cursor:hand;" alt="IMPRIMIR"title="IMPRIMIR" /><?php if($_GET['tipo']=='1' || $_GET['tipo']=='2') { ?>
