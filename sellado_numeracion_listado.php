                        ...
                        <tr>
                          <td id="fuente2">
                            ...
                            <select id='cliente' name='cliente' class="selectsGrande">
                              <option value="" <?php if (!(strcmp("", $_GET['cliente']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>- CLIENTE -</option>
                              <?php foreach ($row_proveedores as $row_proveedores) { ?>
                                <option value="<?php echo $row_proveedores['id_c']; ?>" <?php if (!(strcmp($row_proveedores['id_c'], $_GET['cliente']))) {
                                                                                          echo "selected=\"selected\"";
                                                                                        } ?>><?php echo htmlentities($row_proveedores['nombre_c']); ?>
                                </option>
                              <?php } ?>
                            </select>
                          </td>
                      ...
                      <table class="table table-bordered table-sm">
                        ...
                        <?php do { ?>
                          ...
                          <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                            ...
                            <!-- <a href="sellado_control_numeracion_edit.php?id_op=<?php //echo $row_numeracion['int_op_n'];
                                                                                    ?>&int_caja_tn=<?php echo $row_numeracion['int_caja_n']; ?>&imprimirt=<?php //echo $imprimirt['imprimiop']; 
                                                                                                                                                          ?>" target="_self" style="text-decoration:none; color:#000000"> -->
                            ...
                            <td nowrap="nowrap" id="dato2"><a href="view_index.php?c=csellado&a=Numeracion&mi_var_array=<?php echo $compactada; ?>&int_op_tn=<?php echo $row_url['int_op_n'] == '' ? $row_numeracion['int_op_n'] : $row_url['int_op_n']; ?>&int_caja_tn=<?php echo $row_url['int_caja_n'] == '' ? $row_numeracion['int_caja_n'] : $row_url['int_caja_n']; ?>" target="new" style="text-decoration:none; color:#000000">
                                ...
                                if ($numn >= '1') {
                                  ...
                                  $ca = htmlentities($nombre_cliente_c);
                                  echo $ca;
                                } else {
                                  echo "";
                                } ?>
