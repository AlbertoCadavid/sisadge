...
<!--    <?php if($id_ref!='0'&&$id_c=='0' ) { ?> 
    ...
    <?php }?>-->
                        ...
                        <td id="dato2"><a href="control_tablas.php?cod_ref= <?php echo $row_cotizacion['cod_ref']; ?>&n_cotiz= <?php echo $row_cotizacion['n_cotiz_ref']; ?>&id_ref= <?php echo $row_cotizacion['id_ref']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "5"; ?>" target="new" style="text-decoration:none; color:#000000"><?php $row_formula = $conexion->buscar('tbl_formulacion','nombre',$row_cotizacion['tipo_bolsa_ref']);  
                                     echo $row_formula['formulacion'];?></a></td>
                        ...
                        <td id="dato2"><a href="control_tablas.php?cod_ref= <?php echo $row_cotizacion['cod_ref']; ?>&amp;n_cotiz= <?php echo $row_cotizacion['n_cotiz_ref']; ?>&amp;id_ref= <?php echo $row_cotizacion['id_ref']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>&amp;case=<?php echo "5"; ?>" target="new" style="text-decoration:none; color:#000000"><?php echo $row_cotizacion['peso_millar_ref']+$row_cotizacion['peso_millar_bols']; ?></a></td>
                        </tr>
