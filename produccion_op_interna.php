...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL2 = sprintf(
    "INSERT INTO Tbl_op_proceso (id_op,id_proceso) VALUES (%s, %s)",
    GetSQLValueString($_POST['id_op'], "int"),
  ...
  $insertSQL3 = sprintf(
    "INSERT INTO Tbl_orden_compra_interna (numero_ocI) VALUES (%s)",
    GetSQLValueString($_POST['str_numero_oc_op'], "text")
  );
                ...
                <div class="span8 offset2"> <!--span8 offset2   esto da el tamaño pequeño -->
                  <div class="panel panel-primary">
                    <div class="panel-heading">
                      <h2>ORDEN DE PRODUCCI&Oacute;N INTERNA</h2>
                    </div>
                    ...
                    <div class="panel-body">
                      <table align="center" id="tabla_borde" style="padding-top: 2%;">
                        ...
                        <tr>
                              ...
                              <table id="tabla2">
                                ...
                                <tr>
                                  ...
                                  <td colspan="9" id="dato3"><a href="referencias.php" target="new"><img src="images/a.gif" style="cursor:hand;" alt="ADD MEZCLAS" title="ADD MEZCLAS" border="0" /></a>
                                    ...
                                    <a href="menu.php"><img src="images/identico.gif" style="cursor:hand;" alt="MENU PRINCIPAL" border="0" /></a>
                                  </td>
                                </tr>
                                <tr id="tr1">
                                  ...
                                  <td colspan="6" id="dato3">
                                    Ingresado por
                                    <input name="str_responsable_op" type="text" value="<?php echo $_SESSION['Usuario']; ?>" size="27" readonly="readonly" />
                                  </td>
                                </tr>
                                <tr id="tr3">
                                ...
                                <tr id="tr3">
                                  <td colspan="2" nowrap="nowrap" id="numero2"><?php $op_numero = $row_orden_produccion['id'] + 1; ?>
                                    <input name="id_op" type="number" style="width:100px" value="<?php echo $op_numero; ?>" readonly="readonly" />
                                  </td>
                                  <td colspan="2" nowrap="nowrap" id="fuente2"></td>
                                ...
                                <tr>
                                  <td colspan="4" id="dato3">
                                    <?php $cod = $_GET['int_cod_ref_op'];
                                    $idr = $row_datos_oc['id_ref'];
                                    if ($_GET['int_cod_ref_op'] != '') {
                                      $cod_ref = $cod;
                                ...
                                <tr>
                                  ...
                                  <td nowrap="nowrap" id="fuente1">
                                    ...
                                    -
                                    <input name="version_ref_op" type="number" id="version_ref_op" min="0" max="9" size="2" value="<?php echo $row_datos_oc['version_ref']; ?>" readonly="readonly" required="required" />
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="2" id="talla1"><?php if (!(strcmp("LAMINA", $row_datos_oc['tipo_bolsa_ref']))) {
                                ...
                                <tr>
                                  ...
                                  <td colspan="2" id="fuente1"><select name="str_tipo_bolsa_op" id="str_tipo_bolsa_op" onchange="if(form1.str_tipo_bolsa_op.value=='PACKING LIST') { swal('PUEDE EDITAR EL METRO LINEAL YA QUE ES UN PACKING LIST')}else if(form1.str_tipo_bolsa_op.value=='BOLSA TROQUELADA'){anchoRolloRefOp();}else{calcular_op()}">
                                      ...
                                      <option value="SEGURIDAD" <?php if (!(strcmp("SEGURIDAD", $row_datos_oc['tipo_bolsa_ref']))) {
                                                                  echo "selected=\"selected\"";
                                                                } ?>>SEGURIDAD</option>
                                      <option value="CURRIER" <?php if (!(strcmp("CURRIER", $row_datos_oc['tipo_bolsa_ref']))) {
                                                                echo "selected=\"selected\"";
                                                              } ?>>CURRIER</option>
                                      <option value="BOLSA PLASTICA" <?php if (!(strcmp("BOLSA PLASTICA", $row_datos_oc['tipo_bolsa_ref']))) {
                                                                        echo "selected=\"selected\"";
                                                                      } ?>>BOLSA PLASTICA</option>
                                      <option value="BOLSA MONEDA" <?php if (!(strcmp("BOLSA MONEDA", $row_datos_oc['tipo_bolsa_ref']))) {
                                                                      echo "selected=\"selected\"";
                                                                    } ?>>BOLSA MONEDA</option>
                                      <option value="PACKING LIST" <?php if (!(strcmp("PACKING LIST", $row_datos_oc['tipo_bolsa_ref']))) {
                                                                      echo "selected=\"selected\"";
                                                                    } ?>>PACKING LIST</option>
                                              ...
                                              <?php if ($totalRows_unidad_ocho != '0') { ?>
                                                <table>
                                                  ...
                                                  <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                                                      ...
                                                      <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_ocho, $y, str_nombre_m);
                                                                              echo $id_m; ?></td>
                                                      <td id="talla1"><?php $var = mysql_result($unidad_ocho, $y, descripcion_insumo);
                                                                      echo $var; ?></td>
                                                      <td id="talla3"><?php $var = mysql_result($unidad_ocho, $y, str_valor_pmi);
                                                                      echo $var; ?></td>
                                                    </tr>
                                                  <?php  } ?>
                                                </table>
                                    ...
                                    <table>
                                      <tr>
                                        ...
                                        <td id="talla1" nowrap="nowrap"><strong>SOLAPA
                                            (<?php if ($row_datos_oc['b_solapa_caract_ref'] == 2) {
                                                echo "Sencilla";
                                      ...
                                      <tr>
                                        ...
                                        <td id="talla1"><?php echo $row_datos_oc['N_fuelle']; ?>
                                          <input type="hidden" name="fuelle" id="fuelle" value="<?php echo $row_datos_oc['N_fuelle']; ?>" />
                                        </td>
                                        <td id="talla1">&nbsp; </td>
                                      ...
                                      <tr>
                                        ...
                                        <td id="talla1">
                                          <select name="marca_cajas_egp" id="opciones" style="width:100px" onchange="return primeraletra(this),alerta()">
                                            <option value="0" <?php if (!(strcmp(0, $row_datos_oc['marca_cajas_egp']))) {
                                                                echo "selected=\"selected\"";
                                                              } ?>>SELECCIONE</option>
                         ...
                         <option value="1343"<?php if ($id_insumo == "1343") {
                                                echo "selected=\"selected\"";
                                              } ?> >CINTA DE SEGURIDAD AZUL 28MM</option>
                         <option value="1701" <?php if ($id_insumo == "1701") {
                                                echo "selected=\"selected\"";
                                              } ?>>CINTA DE SEGURIDAD AZUL 38MM</option>
                       </select>-->
