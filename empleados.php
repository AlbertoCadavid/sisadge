...
<tr>
  ...
  <td width="25%" id="fuente3"><a href="empleado_add.php"><img src="images/mas.gif" alt="ADD EMPLEADO" border="0" style="cursor:hand;"></a><a href="empleado_tipo.php"><img src="images/opciones.gif" alt="TIPOS DE EMPLEADO" title="TIPO DE EMPLEADOS" border="0" style="cursor:hand;"></a><a href="factor_prestacional_add.php"><img src="images/f.gif" alt="FACTORES" title="FACTORES" border="0" style="cursor:hand;"></a><a href="turnos.php"><img src="images/t.gif" style="cursor:hand;" alt="TURNOS" title="TURNOS" border="0"/></a><a href="empleado_tipo.php"><img src="images/p.gif" title="CARGO" alt="CARGO" border="0" style="cursor:hand;"></a><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR"title="RESTAURAR" border="0" style="cursor:hand;"/></a></td></tr>
<tr id="tr1">
