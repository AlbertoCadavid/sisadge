                        ...
                        <tr>
                          ...
                          <td colspan="4" id="titulo1">
                            ...
                            <select name="operario" id="operario" class="busqueda selectsMedio">
                              <option value="0" <?php if (!(strcmp("0", $_GET['operario']))) {
                                                  echo "selected=\"selected\"";
                                                } ?>>TODOS</option>
                              <?php foreach ($row_codigo_empleado as $row_codigo_empleado) { ?>
                                <option value="<?php echo $row_codigo_empleado['codigo_empleado'] ?>" <?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $_GET['operario']))) {
                                                                                                        echo "selected=\"selected\"";
