...
function porcentaje2($total, $parte) {
 ...
 function porcentaje3($total, $parte) {
    $porcemes = ($parte / $total * 100 ); 
	return number_format($porcemes, 2, ",", ".");
}
...
$dia = strftime("%b", strtotime($fecha));
 return $dia;	
}
...
$nuevaHora=date("H:i",$segundos_horaInicial+$segundos_minutoAnadir);
 return $nuevaHora;*/
  ...
  //primer mes dia del año sin parametros
  ...
  //primer mes dia del año con parametros
  function first_year_month2($fecha) { 
      $year = $fecha;
	  return date('Y-m-d', mktime(0,0,0, 1, 1, $year));
  }
  function last_year_month2($fecha) { 
      $year = $fecha;
	  return date('Y-m-d', mktime(0,0,0, 12, 1, $year));
  } 
  //primer dia del mes sin parametros 
  ...
  //primer dia del mes con parametros 
