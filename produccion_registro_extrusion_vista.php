    ...
    <table id="tablainterna">
      ...
      <tr>
        <td colspan="7" id="fuente3">
          ...
          <a href="menu.php"><img src="images/impresor.gif" onClick="window.print();" style="cursor:hand;" alt="IMPRIMIR" title="IMPRIMIR" /></a>
        </td>
      </tr>
      <tr>
      ...
      ?>
        <tr>
          ...
          <td nowrap id="fuente1"><?php
                                  ...
                                  $trollos += $rollos;
                                  $empleado = $row['cod_empleado_r']; //datos del campo tel�fono
                                  $id_emp = $empleado;
            ...
            <?php if ($row_tiempoMuerto['id_rpt_rt'] != '') { ?>
              ...
              <?php for ($k = 0; $k <= $totalRows_tiempoMuerto - 1; $k++) { ?>
                <tr>
                  ...
                  <td colspan="3" id="detalle2"><?php echo $var1 = mysql_result($tiempoMuerto, $k, muertos);
                                                $tiempoM += $var1; ?></td>
                </tr>
              <?php } ?>
              <tr>
            ...
            <?php if ($row_tiempoPreparacion['id_rpt_rtp'] != '') { ?>
              ...
              <?php for ($x = 0; $x <= $totalRows_tiempoPreparacion - 1; $x++) { ?>
                <tr>
                  ...
                  <td colspan="3" id="detalle2"><?php echo $var2 = mysql_result($tiempoPreparacion, $x, preparacion);
                                                $tiempoP += $var2; ?></td>
                </tr>
              <?php } ?>
              <tr>
            ...
            <?php if ($row_desperdicio['id_rpd_rd'] != '') { ?>
              ...
              <?php for ($i = 0; $i <= $totalRows_desperdicio - 1; $i++) { ?>
                <tr>
                  ...
                  <td colspan="3" id="detalle2"><?php echo $var3 = mysql_result($desperdicio, $i, desperdicio);
                                                $desperdicios += $var3; ?></td>
                </tr>
              <?php } ?>
              <tr>
                <td id="detalle3"><strong>TOTAL</strong></td>
            ...
            <?php if ($row_producido['id_rpp_rp'] != '') { ?>
              ...
              <?php for ($j = 0; $j <= $totalRows_producido - 1; $j++) { ?>
                <tr>
                  ...
                  <td id="detalle2"><?php echo $var4 = mysql_result($producido, $j, producido);
                                    $polietileno += $var4; ?></td>
                  <td id="detalle2"><?php
                                    echo $var5 = mysql_result($producido, $j, costo_mp);
                                    $costo_mp += $var5; ?></td>
                  <td id="detalle2"><?php
        ...
        <table border="0">
          ...
          <tr>
            <td colspan="9" id="fuente1"><strong>Nota:</strong> Informacion suministrada segun la liquidacion de la o.p hecha por el operario..<?php
                                                                                                                                                ...
                                                                                                                                                if ($numrrollos >= '1') {
                                                                                                                                                  $rollosLiquidado = mysql_result($resultrrollos, 0, 'ROLLOS');
                                                                                                                                                } ?></td>
          </tr>
          <tr>
          ...
          <?php do { ?>
            <tr>
              ...
              <td id="fuente2"><?php echo horadecimalUna($row_extrusion_vista['total_horas_rp']);
