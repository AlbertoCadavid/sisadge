          ...
          <table align="center" id="tabla">
            <tr align="center">
              ...
              <td nowrap="nowrap" style="text-align:left; ">
                <h4> N. <?php echo $row_evaluacion_proveedor['n_ev']; ?></h4>
              </td>
            </tr>
          </table>
          ...
          <table class="table table-bordered" style="width:80%">
            ...
            <tbody>
								<tr>
									...
									<td id="dato2">10%</td>
									<td id="dato2"><?php echo $row_evaluacion_proveedor['porcentaje_fpago_ev']; ?> % </td>
								</tr>
								<tr>
									...
									<td id="dato2">10%</td>
									<td id="dato2"><?php echo $row_evaluacion_proveedor['porcentaje_trespuesta_ev']; ?> % </td>
								</tr>
								<tr>
									...
									<td id="dato2">20%</td>
									<td id="dato2"> <?php echo $row_evaluacion_proveedor['porcentaje_alegal_ev']; ?> % </td>
								</tr>
								...
								<tr>
									<td><strong>ENTREGA/CUMPLIMIENTO</strong> <br>
										(<=0 dias) </td>
									<td id="dato2">20%</td>
									<td id="dato2"><?php echo $row_evaluacion_proveedor['porcentaje_entrega_ev']; ?> % </td>
								</tr>

								<tr>
									<td><strong>GARANTIA/CALIDAD DEL BIEN Y/O SERVICIO</strong></td>
									<td id="dato2">20%</td>
									<td id="dato2"><?php echo $row_evaluacion_proveedor['porcentaje_garantias_ev']; ?> % </td>
								</tr>
								...
								<tr>
									...
									<td id="dato2">20%</td>
									<td id="dato2"><?php echo $row_evaluacion_proveedor['porcentaje_respuesta_ev']; ?> % </td>
								</tr>
