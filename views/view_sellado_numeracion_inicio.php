...
<!-- <?php foreach ($this->row_op_carga as $row_op_carga) {
        $row_op_carga;
      } ?>
              ...
              <div class="span8 offset2"> <!--span8 offset2   esto da el tamaño pequeño -->
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    <h2>SELLADO NUMERACION INICIO</h2>
                  </div>
                  <div id="cabezamenu">
                        ...
                        <table align="center" id="tabla35">
                          <tr>
                            <td colspan="6" id="dato3">
                              <a href="sellado_numeracion_listado.php"><img src="images/identico.gif" style="cursor:hand;" alt="LISTADO O.P" border="0" title="LISTADO O.P" /> </a><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;" /></a>
                            </td>
                          </tr>
                          <tr>
                            <td><strong>ROLLO N:</strong> </td> <!-- manejo de banderas -->
                            <td colspan="6" id="titulo2">REGISTRO DE PAQUETES <strong>
                                ...
                                <input name="contador_tn" id="contador_tn" type="hidden" value="1">

                                <input name="ref_tn" type="hidden" id="ref_tn" value="">
                              </strong></td>
                          </tr>
                          <tr> <!-- manejo de banderas -->
                            <td>
                          ...
                          <tr>
                            ...
                            <td colspan="3">
                              ...
                              <input name="tienefaltantesOP" id="tienefaltantesOP" type="hidden" value="<?php echo $row_paquete['imprimiop']; ?>">
...
<script>
  ...
  $("#int_desde_tn").on('change', function() {
    numeracionDesdeAdd($("#int_desde_tn").val(), $("#int_caja_tn").val(), $("#int_paquete_tn").val(), $("#ref_tn").val(), 1, $("#contador_tn").val());
  });
