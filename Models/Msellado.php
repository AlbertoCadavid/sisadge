...
class oMsellado
{
    ...
    public function RegistrarAdd($tabla, $columna, $data)
    {
        ...
        try {
            ...
            $array_deco = UtilHelper::arrayDecode($array_codificado);
            $arrayPHP =  ($array_deco);
            $stmt = $this->conexion->query("INSERT INTO $tabla ($columna) VALUES ('" . $arrayPHP['id_tn_n'] . "','" . $arrayPHP['fecha_ingreso_tn'] . "','" . $arrayPHP['int_op_tn'] . "','" . $arrayPHP['cod_ref_n'] . "','" . $arrayPHP['int_bolsas_tn'] . "','" . $arrayPHP['int_undxpaq_tn'] . "','" . $arrayPHP['int_undxcaja_tn'] . "','" . $arrayPHP['int_desde_tn'] . "','" . $arrayPHP['int_hasta_tn'] . "','" . $arrayPHP['int_cod_empleado_tn'] . "','" . $arrayPHP['int_cod_rev_tn'] . "','" . $arrayPHP['contador_tn'] . "','" . $arrayPHP['int_paquete_tn'] . "','" . $arrayPHP['int_caja_tn'] . "','" . $arrayPHP['b_borrado_n'] . "','" . $arrayPHP['existeTiq_n'] . "','" . $arrayPHP['rollo_r'] . "' );");
        } catch (Exception $e) {
            die($e->getMessage());
        }
    }
    ...
    public function RegistrarInfoRollo($tabla, $columna, $data)
    {
    ...
    public function consultaReferencia($tabla, $columna, $id, $columna2)
    {
        //echo "SELECT * FROM $tabla WHERE  $columna = $id $columna2 " ; die;
    ...
    public function consultaRollos2tablas($mostrar1, $mostrar2, $tabla1, $tabla2, $where1, $where2)
    {
        ...
        if (sizeof($data) == 0) {
            $result = $this->conexion->query("SELECT $mostrar2 FROM $tabla2 WHERE $where2");
            $data = self::getResultados($result);
        }
