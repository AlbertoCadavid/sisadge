...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  if (isset($_POST['int_remision']) && !$existeremision) {
    $insertSQL = sprintf(
      "INSERT INTO Tbl_remisiones(int_remision,str_numero_oc_r,fecha_r,str_encargado_r,str_transportador_r,str_guia_r,str_elaboro_r,str_aprobo_r,str_observacion_r,factura_r,b_borrado_r,ciudad_pais, comprobante_file,id_pedido_oc) VALUES (%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
          ...
          <table class="table">
            ...
            <tr>
              <td colspan="2" id="dato1">ORDEN DE COMPRA N&deg : <b> <?php echo $row_orden_compra['str_numero_oc']; ?></b>
                <br><?php if ($numeroRemision) : ?> <em style="color: red;">Ya Tiene la remision: <?php echo $numeroRemision; ?> creada</em><?php endif; ?>
              </td>
            </tr>
            <tr>
                ...
                <table class="table"><!--se cambio tabla2 x tabla1-->
                  <tr>
                    <td colspan="2" id="dato1"><strong>CLIENTE: </strong>
                      <?php $cad4 = utf8_encode($row_orden_compra['nombre_c']);
                      echo $cad4; ?></td>
                    <td width="50%" colspan="2" id="dato1"><strong>PAIS / CIUDAD : </strong>
                      <?php $cad = utf8_encode($row_orden_compra['pais_c']);
                      $cad2 = utf8_encode($row_orden_compra['ciudad_c']); ?>
                  ...
                  <tr>
                    <td colspan="4" id="dato1"><strong>DIRECCCION COMERCIAL :</strong>
                      <?php $cade =  utf8_encode($row_orden_compra['str_dir_entrega_oc']);
                      echo $cade; ?>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="4" id="dato1"><strong>DIRECCCION ENVIO FACTURA :</strong>
                      <?php $cade2 =  utf8_encode($row_orden_compra['direccion_envio_factura_c']);
                      echo $cade2; ?>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td width="36%" id="dato1"><input name="str_encargado_r" type="text" id="str_encargado_r" onKeyUp="conMayusculas(this)" value="<?php $nom = strtoupper($row_usuario['nombre_usuario']);
                                                                                                                                                    echo $nom; ?>"></td>
                  ...
                  <tr>
                    ...
                    <td id="dato1"><strong>
                        <input name="str_elaboro_r" type="text" onKeyUp="conMayusculas(this)" id="str_elaboro_r" value="<?php $nom = strtoupper($row_usuario['nombre_usuario']);
                                                                                                                        echo $nom; ?>" size="15">
                      </strong></td>
                  </tr>
                  <tr>
                    ...
                    <?php do { ?>
                      <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                        ...
                        <?php if ($row_items['int_cantidad_rest_io'] == '' || $row_items['int_cantidad_rest_io'] == '0.00' || $row_items['int_cantidad_rest_io'] == 0 || $row_items['int_cantidad_rest_io'] <= 0) { ?>
                          ...
                          <td id="talla2"><a onclick="mensaje()"><?php if ($row_items['int_cantidad_rest_io'] == '') {
                                                                    echo '0';
                                                                  } else {
                          ...
                          <td id="talla2"><a onclick="mensaje()"><?php echo $row_items['int_total_item_io'];
                                                                  $total = $subtotal + $row_items['int_total_item_io']; ?></a></td>
                          <td id="talla2"><a onclick="mensaje()"><?php echo $row_items['str_moneda_io']; ?></a></td>
                          <td id="talla2"><a onclick="mensaje()"><?php $dd = htmlentities($row_items['str_direccion_desp_io']);
                                                                  echo $dd; ?></a></td>
                          <td nowrap="nowrap" id="talla2"><a onclick="mensaje()"><?php if ($row_items['b_estado_io'] == '5') {
                        ...
                        <?php } else { ?>
                          ...
                          <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision'] + 1; ?>','900','400')" onclick="mostrarId();" target="_top" style="text-decoration:none; color:#000000"><?php if ($row_items['int_cantidad_rest_io'] == '') {
                                                                                                                                                                                                                                                                                                                  echo '0';
                                                                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                                                                  echo $row_items['int_cantidad_rest_io'];
                                                                                                                                                                                                                                                                                                                } ?></a></td>
                          ...
                          <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision'] + 1; ?>','900','400')" onclick="mostrarId();" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_total_item_io'];
                                                                                                                                                                                                                                                                                                                $total = $subtotal + $row_items['int_total_item_io']; ?></a></td>
                          ...
                          <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision'] + 1; ?>','900','400')" onclick="mostrarId();" target="_top" style="text-decoration:none; color:#000000"><?php $dd = htmlentities($row_items['str_direccion_desp_io']);
                                                                                                                                                                                                                                                                                                                echo $dd; ?></a></td>
                          <td nowrap="nowrap" id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision'] + 1; ?>','900','400')" onclick="mostrarId();" target="_top" style="text-decoration:none; color:#000000"><?php if ($row_items['b_estado_io'] == '5') {
                                                                                                                                                                                                                                                                                                                                  echo "Facturado Total";
                                                                                                                                                                                                                                                                                                                                } else if ($row_items['b_estado_io'] == '4') {
                                                                                                                                                                                                                                                                                                                                  echo "Facturado Parcial";
                                                                                                                                                                                                                                                                                                                                } else if ($row_items['b_estado_io'] == '1') {
