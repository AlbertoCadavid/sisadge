...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL2 = sprintf(
    "UPDATE Tbl_produccion_mezclas SET int_ref1_rpm_pm=%s,int_ref1_tol5_porc1_pm=%s,int_ref2_rpm_pm=%s,int_ref2_tol5_porc2_pm=%s,int_ref3_rpm_pm=%s,int_ref3_tol5_porc3_pm=%s WHERE id_pm=%s",
  ...
  /*	$name=array($_POST['n1'],$_POST['n3'],$_POST['n4'],$_POST['n5'],$_POST['n6'],$_POST['n7'],$_POST['n8'],$_POST['n9'],$_POST['n10'],$_POST['n11'],$_POST['n12'],$_POST['n13'],$_POST['n14'],$_POST['n15'],$_POST['n16'],$_POST['n17'],$_POST['n18'],$_POST['n19'],$_POST['n20'],$_POST['n21'],$_POST['n22'],$_POST['n23'],$_POST['n24'],$_POST['n25'],$_POST['n26'],$_POST['n27'],$_POST['n28'],$_POST['n29'],$_POST['n30'],$_POST['n31'],$_POST['n32'],$_POST['n33'],$_POST['n34'],$_POST['n35'],$_POST['n36'],$_POST['n37'],$_POST['n38'],$_POST['n39'],$_POST['n40'],$_POST['n41'],$_POST['n42'],$_POST['n43'],$_POST['n44'],$_POST['n45'],$_POST['n46'],$_POST['n47'],$_POST['n48'],$_POST['n49'],$_POST['n50']);	
	...
	for($xx=0; $xx<count($d); $xx++) 
    {		
  $updateSQL3 = sprintf("UPDATE Tbl_caracteristicas_valor SET  id_c_cv=%s, str_valor_cv=%s WHERE id_c_cv=%s AND id_ref_cv=%s",
					   GetSQLValueString($d[$xx], "int"),
					   GetSQLValueString($e[$xx], "text"),
					   GetSQLValueString($d[$xx], "int"),
  ...
  $updateSQL4 = sprintf(
    "UPDATE Tbl_orden_produccion SET b_estado_op='1', b_visual_op='0' WHERE id_op=%s",
    GetSQLValueString($_POST['id_op_rp'], "int")
  );
  ...
  $updateGoTo = "produccion_registro_extrusion_vistap.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$mezclas = mysql_query($query_mezcla, $conexion1) or die(mysql_error());
$row_mezcla = mysql_fetch_assoc($mezclas);
$totalRows_mezcla = mysql_num_rows($mezclas);
...
$query_producido = sprintf("SELECT * FROM Tbl_reg_kilo_producido WHERE op_rp='%s' AND id_proceso_rkp='1' AND id_rp = %s  ORDER BY id_rpp_rp ASC", $colname_tiempoMuerto, $_GET['id_rp']);
...
if( !$row_producido ){
  $query_producido = sprintf("SELECT * FROM Tbl_reg_kilo_producido WHERE op_rp='%s' AND id_proceso_rkp='1' AND fecha_rkp AND id_rp = 0  ORDER BY id_rpp_rp ASC", $colname_tiempoMuerto);
  $producido = mysql_query($query_producido, $conexion1) or die(mysql_error());
  $row_producido = mysql_fetch_assoc($producido);
  $totalRows_producido = mysql_num_rows($producido);
}
...
$colname_ref = "-1";
if (isset($_GET['id_op_rp'])) {
  $colname_ref = (get_magic_quotes_gpc()) ? $_GET['id_op_rp'] : addslashes($_GET['id_op_rp']);
}
mysql_select_db($database_conexion1, $conexion1);
...
$colname_op = "-1";
if (isset($_GET['id_op_rp'])) {
  $colname_op = (get_magic_quotes_gpc()) ? $_GET['id_op_rp'] : addslashes($_GET['id_op_rp']);
}
mysql_select_db($database_conexion1, $conexion1);
...
//DESPERDICIO 
/*   mysql_select_db($database_conexion1, $conexion1);
       $query_sql_D = "SELECT SUM(valor_desp_rd) AS desperdicio FROM Tbl_reg_desperdicio WHERE op_rd='$id_op' AND id_proceso_rd='1' AND fecha_rd='$fechaR'";
...
$desperdicio_parcial = $conexion->llenarCampos("Tbl_reg_desperdicio", "JOIN tblextruderrollo ON Tbl_reg_desperdicio.id_rollo = tblextruderrollo.id_r AND tblextruderrollo.id_rp = $_GET[id_rp] AND tblextruderrollo.id_op_r = $_GET[id_op_rp] AND Tbl_reg_desperdicio.id_proceso_rd = 1", " ", "SUM(valor_desp_rd) AS desperdicio ");
                      ...
                      <div align="center">
                        <form action="view_index.php?c=cextruder&a=Guardar" method="POST" enctype="multipart/form-data" name="form1" id="form1"><!-- onSubmit="return(validaCampos())" onSubmit="enviodeForms(validaTodo())"-->
                          <table class="table table-bordered table-sm">
                            <tr id="tr1">
                              <td colspan="10" id="titulo2">REGISTRO DE EXTRUSION PARCIAL # <?php echo $_GET['parcial']; ?></td>
                            </tr>
                            <tr>
                              <td width="137" colspan="2" rowspan="6" id="dato2"><img src="images/logoacyc.jpg" /></td>
                              <td colspan="8" id="dato3">
                                <?php
                                $op_c = $row_rp_edit['id_op_rp'];
                                $rollo_c = $row_rp_edit['rollo_rp'];
                                ...
                                <?php if (($tienekilosconsumo['totalconsumo'] != '') && ($tienekilosconsumo['totalconsumo'] == $kilosDRollos + $kilosDesper)) :  ?>
                                  ...
                                  <a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;" />
                                  </a>

                                <?php else : ?>

                                  <img onClick="eliminacionYactualizacion(<?php echo $_GET['id_op_rp'] ?>,'id_salirExt','<?php echo $row_rp_edit['id_rp']; ?>','produccion_registro_extrusion_listado.php','','Si se sale sin guardar el consumo, se perdera toda la información ! Id: ',eliminacionAlSalirPopUp, actualizacion, <?php echo json_encode($array_rollos) ?>)" src="images/por.gif" alt="NO HA GUARDADO CONSUMO" title="NO HA GUARDADO CONSUMO" border="0" style="cursor:hand;" />
                            ...
                            <tr id="tr1">
                              ...
                              <td colspan="6" id="dato3">
                                ...
                                <input name="str_responsable_rp2" type="text" id="str_responsable_rp2" value="<?php echo $row_rp_edit['str_responsable_rp']; ?>" size="27" readonly="readonly" />
                              </td>
                            </tr>
                            <tr id="tr3">
                            ...
                            <tr>
                              ...
                              <td id="fuente1">
                                ...
                                <input type="number" step="0.01" name="int_kilos_desp_rp" id="int_kilos_desp_rp" min="0" size="12" required="required" style="width:80px" value="<?php echo $kilosDesper; ?>" readonly="readonly" /><!--onclick="getSumD();"-->
                              </td>
                              <td nowrap="nowrap" colspan="2" id="fuente1"><em>Kilos de Rollos</em>:</td>
                              <td colspan="3" id="fuente1"><input name="int_total_kilos_rp" type="number" id="int_total_kilos_rp" style="width:80px" min="0" step="any" onclick="getSumT();" value="<?php  //echo $kilosDRollos; 
      ...
      <input type="button" value="Ocultar" onclick="ocultardiv1()" /> -->
                            ...
                            <tr>
                              <td colspan="10" id="fuente1">
                                <fieldset>
                                  <legend>Registro de Tiempos y Desperdicios</legend>
                                  <table width="100%" border="0" id="flotante">
                                      ...
                                      <?php for ($z = 0; $z <= $totalRows_producido - 1; $z++) { ?>
                                        <tr>
                                          <td id="fuente1">
                                            ...
                                            $id_materia_prima = mysql_result($producido, $z, id_rkp);
                                            $id_mp = $id4;
                                            ...
                                            ?>
                                            <strong>
                                              <input name="id_prod_rp[]" id="id_prod_rp[]" type="hidden" value="<?php echo $id_materia_prima; ?>" />
                                            </strong>
                                          </td>
                                          <td id="fuente1">
                                            <?php
                                          ...
                                          <td id="fuente1">
                                            <?php if ($_SESSION['superacceso']) : ?>
                                              <a href="javascript:eliminar_rte_parcial('id_ipe',<?php $delip = mysql_result($producido, $z, id_rkp);
                                                                                                echo $delip; ?>,<?php echo $_GET['parcial'] ?>,<?php echo  $_GET['id_rp'] ?>,'produccion_registro_extrusionp_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0"></a>
                                            <?php else : ?>
                                    ...
                                    <tr>
                                      <td>
                                        <input name="materiaPrima" id="materiaPrima" type="hidden" value="<?php echo $TMP = $TMP == '' ? '0' : $TMP; ?>" />
                                      </td>
                                    </tr>
                                  </table>
                                </fieldset>
                            ...
                            <tr id="tr1">
                              ...
                              <td colspan="2" id="fuente1">
                                <select name="str_maquina_rp" id="str_maquina_rp">
                                  ...
                                  do {
                                  ?>
                                    <option value="<?php echo $row_maquinas['id_maquina'] ?>" <?php if (!(strcmp($row_maquinas['id_maquina'], $row_rp_edit['str_maquina_rp']))) {
                                ...
                                <strong>
                                  <input name="valor_tiem_rt" id="horasmuertas" type="hidden" size="6" value="<?php if ($TM == '') {
                                                                                                                echo 0;
                                                                                                              } else {
                                                                                                                echo $TM;
                                                                                                              } ?>" />
                                  <input name="valor_prep_rtp" id="horasprep" type="hidden" size="6" value="<?php if ($TP == '') {
                                                                                                              echo 0;
                                                                                                            } else {
                                                                                                              echo $TP;
                                                                                                            } ?>" />
                              ...
                              <td colspan="6" id="fuente1"><select name="int_cod_empleado_rp" id="montaje" style="width:120px">
                                  <option value="" <?php if (!(strcmp("", $row_rp_edit['int_cod_empleado_rp']))) {
                                                      echo "selected=\"selected\"";
                                                    } ?>>Montaje</option>
                                  <?php
                                  do {
                                  ?>
                                    <option value="<?php echo $row_codigo_empleado['codigo_empleado'] ?>" <?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $row_rp_edit['int_cod_empleado_rp']))) {
                                                                                                            echo "selected=\"selected\"";
                                ...
                                <select name="int_cod_liquida_rp" id="liquida" style="width:120px">
                                  <option value="" <?php if (!(strcmp("", $row_rp_edit['int_cod_liquida_rp']))) {
                                                      echo "selected=\"selected\"";
                                                    } ?>>Liquida</option>
                                  <?php
                                  do {
                                  ?>
                                    <option value="<?php echo $row_codigo_empleado['codigo_empleado'] ?>" <?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $row_rp_edit['int_cod_liquida_rp']))) {
                                                                                                            echo "selected=\"selected\"";
                                                                                                          } ?>><?php echo $row_codigo_empleado['codigo_empleado'] . " - " . $row_codigo_empleado['nombre_empleado'] . " " . $row_codigo_empleado['apellido_empleado'] ?></option>
                                  <?php
                                  } while ($row_codigo_empleado = mysql_fetch_assoc($codigo_empleado));
                            ...
                            <tr>
                              ...
                              <td colspan="6" id="fuente1"><input name="int_metro_lineal_rp" type="number" id="metro_r" placeholder="Metro Lineal" style="width:116px" min="0" step="any" onclick="" value="<?php echo $row_rp_edit['int_metro_lineal_rp']; ?>" />
                                ...
                                Metro lineal de O.P:<?php echo $row_orden_produccion['metroLineal_op']; ?>
                              </td>
                            </tr>
                            <tr id="tr1">
                            ...
                            <tr>
                              ...
                              <td colspan="2" id="fuente1">
                                <input name="total_horas_rp" type="text" id="horas_real" value="<?php echo $row_rp_edit['total_horas_rp']; ?>" size="19" required="required" onBlur="kilosxHora2();" />
                              </td>
...
WHERE a.tipo_empleado IN(4) AND b.fecha BETWEEN DATE_FORMAT('$FECHA_NOVEDAD_EXT', '%Y-%m-01') AND DATE_FORMAT('$FECHA_NOVEDAD_EXT', '%Y-%m-31')"; //IN(4)novedad extrusion 
                            ...
                            <tr>
                              ...
                              <td id="fuente1"><input name="int_ref3_tol5_porc3_pm" type="text" id="int_ref3_tol5_porc3_pm" placeholder="%" size="2" required="required" value="<?php echo $row_mezcla['int_ref3_tol5_porc3_pm'] ?>" />
                                <input name="id_pm" type="hidden" id="id_pm" value="<?php echo $row_mezcla['id_pm']; ?>" />
                              </td>
                              <td id="fuente1">&nbsp;</td>
                              <td id="fuente1">&nbsp;</td>
                              <td colspan="2" id="fuente1">&nbsp;</td>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    var consumos = $("#materiaPrima").val(); //'<?php echo $TMP; ?>';
    var kprod = $("#int_kilos_prod_rp").val();

    if ((consumos == '' || consumos == '0') && kprod != consumos) {

      $("#idGuardar").addClass("botonGeneralGris");
      $('#idGuardar').prop('disabled', true);

      return false;
    } else if ((consumos > 0) && kprod != consumos) {
      $("#idGuardar").addClass("botonGeneralGris");
      return false;
    }
