...
<head>
  ...
  <style type="text/css">
    ...
    .text {
      font-family: "Impact", Garamond, 'Comic Sans';
    }
  </style>
</head>
    ...
    <div style="text-align: center;" id="seleccion" onClick="cerrar('seleccion');"><!--onClick="javascript:imprSelec('seleccion')"-->
        ...
        <table style="width:9cm; height:9cm; text-align: center;" border="2">
          ...
          <tr>
            ...
            <td colspan="4">
              ...
              <samp id="codigoqrs_cod<?php echo $i; ?>"> <canvas id="qr<?php echo $i; ?>" class="qrcode"></canvas> </samp> <!-- style="display: none; font-size:7cm;"  -->
      ...
      <div id="oculto">
        <table width="200" border="0" align="center">
          <tr>
            <td>
              <input name="cerrar" type="button" autofocus value="cerrar" onClick="cerrar('seleccion');return false">
            </td>
          </tr>
        </table>
      </div>
