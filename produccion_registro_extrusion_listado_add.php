                  ...
                  <table class="table table-bordered table-sm">
                    ...
                    <?php do { ?>
                      <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                        ...
                        <td nowrap="nowrap"id="dato2"><?php echo $row_orden_produccion['int_kilosxhora_rp']; if($row_orden_produccion['int_kilosxhora_rp']==''){echo "0";}?></td>       
                        ...
                        <td id="dato2">
                          ...
                          if($numnI > '0') 
                            { $fechaI_r=mysql_result($resultnI,0,'fechaI_r');}else{ echo '0';} 
                          if($kilosE < $kilosOP)
                          {		
                           ?>
