...
<td id="titulo">EVALUACION DE <?php echo  utf8_encode(DESEMPEÑO); ?> DEL PROVEEDOR DE <?php echo $row_proveedor_ver['tipo_servicio_p'];?></td>
</tr>
<tr>
<td id="dato2">
                        ...
                        <td nowrap id="fuente3">No conforme
                          ...
                          <tr>
                            <td nowrap id="fuente3">% Oportunos
                              <?php $porc=(($oportunos/$suma_vr)*20); $porcentaje=round($porc*100)/100; if($porcentaje=='') { $porcentaje=0; } ?>
                              ...
                              <td nowrap id="fuente3">% Cumple
                                ...
                                <td nowrap id="fuente3">% Conforme
                                  ...
                                  <td nowrap id="fuente3">% Atencion
                                    <?php $porc_atencion1=($serviciosi/$suma_vr)*15;
