...
<body>
      ...
      <td id="dato2">
        ...
        <form name="form2" method="get" action="<?php echo $tiposervicio; ?>">
          <table id="tabla3">
            ...
            <tr>
              <td id="dato2"><input name="numero" type="text" id="numero" value="<?php if ($_GET['numero'] != '') {
                                                                                    echo $_GET['numero'];
                                                                                  } else {
                                                                                    $numero = $row_ultimo_numero['n_ev'] + 1;
                                                                                    echo $numero;
                                                                                  } ?>" size="2"></td>
              <td id="dato2"><strong><?php echo $row_proveedor['proveedor_p']; ?></strong></td>
              <td id="dato2"><input name="desde" type="date" id="desde" value="<?php if ($_GET['desde'] == '') {
                                                                                  echo date("Y-m-d");
                                                                                } else {
                                                                                  echo $_GET['desde'];
                                                                                } ?>" size="10"></td>
              <td id="dato2"><input name="hasta" type="date" id="hasta" value="<?php if ($_GET['hasta'] == '') {
                                                                                  echo date("Y-m-d");
                                                                                } else {
                                                                                  echo $_GET['hasta'];
                                                                                } ?>" size="10"></td>
  ...
  if ($desde != '' && $hasta != '') {
    ...
    if ($vi != '' || $vr != '' || $vb != '') { ?>
          ...
          <?php do { ?>
            <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF" bordercolor="#ACCFE8">
              ...
              <td nowrap id="abajo1">
                ...
                if ($num2 >= '1') {
                  $descripcion_insumo = mysql_result($result2, 0, 'descripcion_insumo');
                }
              ...
              <td nowrap id="abajo3">
                ...
                if ($cump_servicio != '') {
                  ...
                  $porc_servicio = round($porc_servicio * 100) / 100;
                } else {
                  $porc_servicio = 0;
                }
              ...
              <td id="abajo2">
                <?php if ($porc_servicio >= '75') {
                  echo "Si";
                  $serviciosi = $serviciosi + 1;
                }
                if ($porc_servicio < '75') {
                  echo "No";
                  $serviciono = $serviciono + 1;
                } //SERVICIO CUMPLE
                ?>
              </td>
            </tr>
            ...
            if ($row_rollo_verificacion['n_vr'] != '') { ?>
              <tr>
                ...
                <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF" bordercolor="#ACCFE8">
                  ...
                  <td id="abajo2"><?php if ($row_rollo_verificacion['entrega_vr'] == '0') {
                                    echo "PARCIAL";
                                  }
                                  if ($row_rollo_verificacion['entrega_vr'] == '1') {
                                    echo "TOTAL";
                                  } ?></td>
                  <td nowrap id="abajo2"><?php echo $row_rollo_verificacion['fecha_recibo_vr']; ?></td>
                  ...
                  <td id="abajo2"><?php if ($porcentaje_conf >= '95') {
                                    echo "Si";
                                    $abuena = $abuena + 1;
                                  }
                                  if ($porcentaje_conf < '95') {
                  ...
                  <td id="abajo3"><?php echo $row_rollo_verificacion['servicio_vr'];
                                  $cump_servicio = $row_rollo_verificacion['servicio_vr']; ?></td>
              ...
              <?php do { ?>
                <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF" bordercolor="#ACCFE8">
                  ...
                  <td nowrap id="abajo1"><?php $id_bolsa = $row_bolsa_verificacion['id_bolsa_vb'];
                                          ...
                                          if ($numbolsa >= '1') {
                                            $nombre_bolsa = mysql_result($resultbolsa, 0, 'nombre_bolsa');
                                          }
                  ...
                  <td id="abajo2"><?php if ($row_bolsa_verificacion['entrega_vb'] == '0') {
                                    echo "PARCIAL";
                                  }
                                  if ($row_bolsa_verificacion['entrega_vb'] == '1') {
                                    echo "TOTAL";
                                  } ?></td>
                  <td nowrap id="abajo2"><?php echo $row_bolsa_verificacion['fecha_recibido_vb']; ?></td>
                  ...
                  <td id="abajo3"><?php $conformidad = 0;
                                  ...
                                  if ($resistencia != '2') {
                                    $conformidad = $resistencia + $conformidad;
                                    $cont = $cont + 1;
                                  }
                                  $tratamiento = $row_bolsa_verificacion['tratamiento_cumple_vb'];
                                  if ($tratamiento != '2') {
                                    $conformidad = $tratamiento + $conformidad;
                                    $cont = $cont + 1;
                                  }
                                  echo $conformidad; ?></td>
                  <td nowrap id="abajo3"><?php if ($conformidad != '') {
                  ...
                  <td id="abajo3"><?php echo $row_bolsa_verificacion['servicio_vb'];
                                  $cump_servicio = $row_bolsa_verificacion['servicio_vb']; ?></td>
                  <td nowrap id="abajo3"><?php if ($cump_servicio != '') {
                                            $porc_servicio = ($cump_servicio / 10) * 100;
                                            $porc_servicio = floor($porc_servicio);
                                          } else {
                      ...
                      <table id="tabla3">
                        <tr>
                          <td colspan="2" id="fuente1">Verificaciones
                            ...
                            <input name="id_ev" type="hidden" value="<?php $numero = $row_ultimo['id_ev'] + 1;
                                                                      echo $numero; ?>">
                            ...
                            <input name="total_oc_ev" style="color:red" type="text" id="total_oc_ev" value="<?php echo $suma_oc; ?>" size="5">
                          </td>
                        ...
                        <tr>
                          ...
                          <td nowrap id="fuente3">No cumple
                            <input name="total_no_cumple_ev" type="text" id="total_no_cumple_ev" value="<?php echo $nocumple; ?>" size="5">
                          </td>
                          <td nowrap id="fuente3">No conforme
                            <input name="total_no_conforme_ev" type="text" id="total_no_conforme_ev" value="<?php echo $amala; ?>" size="5">
                          </td>
                        ...
                        <tr>
                          <td nowrap id="fuente3">% Oportunos <?php $porc = (($oportunos / $suma_vr) * 25);
                            ...
                            <input name="porcentaje_oportunos_ev" type="text" id="porcentaje_oportunos_ev" value="<?php echo $porcentaje; ?>" size="5">
                          </td>
                          <td nowrap id="fuente3">% Cumple <?php $porc2 = ($cumple / $suma_vr) * 25;
                                                            $porcentaje2 = round($porc2 * 100) / 100;
                                                            if ($porcentaje2 == '') {
                                                              $porcentaje2 = 0;
                                                            } ?>
                        ...
                        <tr>
                          <td colspan="6" id="numero1"><strong>PORCENTAJE FINAL (%)</strong>
                            <?php $total = 0;
                            $total = $porcentaje + $porcentaje2 + $porc_conforme + $porc_atencion; ?>
                            <input name="porcentaje_final_ev" type="text" id="porcentaje_final_ev" size="5" value="<?php echo $total; ?>"><?php if ($total >= '0' && $total <= '50') {
                                                                                                                                            $calif = 1;
                                                                                                                                          }
                            ...
                            <input name="calificacion_ev" type="hidden" id="calificacion_ev" value="<?php echo $calif; ?>">
                          </td>
                        </tr>
                        <tr id="tr1">
                        ...
                        <tr>
                          <td colspan="6" id="fuente1">
                            <textarea name="calificacion_texto_ev" cols="80" rows="2" id="calificacion_texto_ev"><?php
                                                                                                                  if ($calif == '1') {
                                                                                                                    echo "Esta entre 0%-50%: El proveedor no debe continuar a menos que sea el �nico o se defina un plan riguroso.";
                                                                                                                  }
                                                                                                                  if ($calif == '2') {
                                                                                                                    echo "Esta entre 51% - 80%: Se debe establecer un plan de acci�n.";
                                                                                                                  }
                                                                                                                  if ($calif == '3') {
                                                                                                                    echo "Esta entre 81% - 100%: Se considera que cumple para la organizacion.";
                                                                                                                  }
                                                                                                                  ?>
                            </textarea>
                          </td>
                        ...
                        <tr>
                          ...
                          <td id="dato2">
                            ...
                            <input type="text" name="fecha_registro_ev" value="<?php echo date("Y-m-d"); ?>" size="10">
                          </td>
      ...
      </table><?php } else { ?><br><br>
      <div id="fuente2">No hay datos correspondientes a este periodo, favor verificar la fecha.</div><?php }
                                                                                                  } ?>
</body>
