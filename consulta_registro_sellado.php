...
if (isset($_GET['getClientId']) && $_GET['getClientId'] != '') {
	...
	if ($inf[0][0] > '1') {
		...
		$desperdicios = $conexion->llenaSelect("tbl_reg_desperdicio", "inner join Tbl_reg_tipo_desperdicio on tbl_reg_desperdicio.id_rpd_rd = Tbl_reg_tipo_desperdicio.id_rtp WHERE op_rd= '$id_op' AND int_rollo_rd = '$_GET[rollo_r]' AND id_proceso_rd='4'", "ORDER BY id_rpd_rd ASC" );
		...
		$inf[0]["desperdicios"] = $desperdicios;
