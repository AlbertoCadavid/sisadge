...
WHERE a.tipo_empleado IN(7,9) AND b.fecha BETWEEN DATE_FORMAT('$FECHA_NOVEDAD_SELL', '%Y-%m-01') AND DATE_FORMAT('$FECHA_NOVEDAD_SELL', '%Y-%m-31')"; //IN(5,10)novedad impresion 
  ...
  $updateSQL4 = sprintf(
    "UPDATE TblSelladoRollo SET rolloParcial_r=%s WHERE id_r=%s",
    ...
    <td id="fuente1"><select name="int_cod_liquida_rp" style="width:120px" id="auxiliar" >
      ...
      <tr>
        ...
        <td colspan="2" id="fuente1"><?php
                                      ...
                                      ?>
          <input name="fecha_ini_rp" id="fecha_ini_rp" type="datetime-local" min="2000-01-02" value="<?php echo $fechahoraofinal; ?>" <?php /*if($fechahoraofinal !=''){ echo "readonly"; }else{echo $fechahoraofinal;} */ echo $fechahoraofinal; ?> size="15" required="required" onchange="restakilosT()" />
        </td>
      ...
      <tr>
        ...
        <td colspan="2" id="fuente1">
          ...
          <input type="number" name="kiloSistema" id="kiloSistema" style="width:55px" required="required" min="0.00" step="any" placeholder="Sistema" value="" readonly="readonly" />
        </td>
