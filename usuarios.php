...
<body>
  ...
  <table class="table table-bordered table-sm">
    <tr>
      <td id="subtitulo2"> Usuario</td>
      <td id="subtitulo2"> Nombre del Usuario</td>
      <td id="subtitulo2"> Tipo de Usuario</td>
      <td id="subtitulo2"> Codigo Usuario</td>
    </tr>
    <?php do { ?>
      <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF" bordercolor="#ACCFE8">
        ...
        <td class="Estilo4">
          ...
          ?>
          <a href="usuario_editar.php?id_usuario=<?php echo $row_ver['id_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"> <?php echo $tipo3; ?> </a>
        </td>
        <td class="Estilo4">
          ...
          ?>
          <a href="usuario_editar.php?id_usuario=<?php echo $row_ver['id_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"> <?php echo $codigo2; ?> </a>
        </td>
      </tr>
