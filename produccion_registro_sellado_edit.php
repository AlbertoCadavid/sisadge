 ...
 <tr>
  ...
  <tr id="tr1">
   ...
   <!--   <input name="standby" id="standby" type="hidden" value="<?php echo $row_rollo_sellado_edit['standby'];?>" size="5"/>
    ...
    <option value=""<?php if (!(strcmp("", $row_rollo_sellado_edit['str_maquina_rp']))) {echo "selected=\"selected\"";} ?>>Maquina</option>
      <?php
do {  
?>
      <option value="<?php echo $row_maquinas['id_maquina']?>"<?php if (!(strcmp($row_maquinas['id_maquina'], $row_rollo_sellado_edit['str_maquina_rp']))) {echo "selected=\"selected\"";} ?>><?php echo $row_maquinas['nombre_maquina']?></option>
      <?php
...
?>
    ...
    <td id="fuente1"> 
    	     <select name="int_cod_empleado_rp" id="operario"  style="width:120px"  >
               <option value=""<?php if (!(strcmp("", $row_rollo_sellado_edit['int_cod_empleado_rp']))) {echo "selected=\"selected\"";} ?>>Operario</option>
    	       <?php  foreach($row_codigo_empleado as $row_codigo_empleado ) { ?>
    	         <option value="<?php echo $row_codigo_empleado['codigo_empleado']?>"<?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $row_rollo_sellado_edit['int_cod_empleado_rp']))) {echo "selected=\"selected\"";} ?>><?php echo $row_codigo_empleado['codigo_empleado']." - ".$row_codigo_empleado['nombre_empleado']." ".$row_codigo_empleado['apellido_empleado']?></option>
    	       <?php } ?>
    	     </select>
    	</td>
    	   <td id="fuente1">
    	     ...
    	     <select name="int_cod_liquida_rp" style="width:120px" id="auxiliar" >
               <option value=""<?php if (!(strcmp("", $row_rollo_sellado_edit['int_cod_liquida_rp']))) {echo "selected=\"selected\"";} ?>>Revisor</option>
    	       <?php  foreach($row_revisor as $row_revisor ) { ?>
    	         <option value="<?php echo $row_revisor['codigo_empleado']?>"<?php if (!(strcmp($row_revisor['codigo_empleado'], $row_rollo_sellado_edit['int_cod_liquida_rp']))) {echo "selected=\"selected\"";} ?>><?php echo $row_revisor['codigo_empleado']." - ".$row_revisor['nombre_empleado']." ".$row_revisor['apellido_empleado']?></option>
    	       <?php } ?>
    	     </select>
        </td>
...
?>
    ...
    <td id="fuente1"> 
      <select name="int_cod_liquida_rp" style="width:120px" id="auxiliar" >
        <option value=""<?php if (!(strcmp("", $rew_operarios['cod_auxiliar_r']))) {echo "selected=\"selected\"";} ?>>Revisor</option>
        <?php
do {  
?>
        <option value="<?php echo $row_codigo_empleado['codigo_empleado']?>"<?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $rew_operarios['cod_auxiliar_r']))) {echo "selected=\"selected\"";} ?>><?php echo $row_codigo_empleado['codigo_empleado']." - ".$row_codigo_empleado['nombre_empleado']." ".$row_codigo_empleado['apellido_empleado']?></option>
        <?php
} while ($row_codigo_empleado = mysql_fetch_assoc($codigo_empleado));
  $rows = mysql_num_rows($codigo_empleado);
  if($rows > 0) {
...
?>
  ...
  <tr>
    ...
    <td colspan="2" id="fuente1"><input name="fecha_ini_rp" id="fecha_ini_rp" type="datetime-local" min="2000-01-02" value="<?php echo muestradatelocal($row_rollo_sellado_edit['fechaI_r']);?>" size="15" required onclick="restakilosT();" onChange="alerta_sell();" /><div id="resultado_generador"></div>
    </td>
    <td id="fuente1">
  ...
  <tr id="tr1">
    ...
    <td colspan="2" id="fuente1"><input name="fecha_fin_rp" id="fecha_fin_rp" type="datetime-local" min="2000-01-02" size="15" required  onblur="restakilosT()"  value="<?php echo muestradatelocal($row_rollo_sellado_edit['fechaF_r']); //muestradatelocal?>"/></td>
 ...
 <tr>
  ...
  <tr>
    ...
    <td colspan="2" id="fuente1"> 
      ...
      <input type="number" name="kiloSistema" id="kiloSistema" style="width:55px" required="required" min="0.00" step="any" placeholder="Sistema" value="<?php echo $row_rollo_sellado_edit['kiloFaltante_rp'];?>" readonly="readonly"/><?php } ?></td>
  ...
  <tr>
    ...
    <td id="fuente1"><input type="checkbox" name="rolloParcial_r" id="rolloParcial_r" <?php if (!(strcmp($row_rollo_sellado_edit['rolloParcial_r'],1))) {echo "checked=\"checked\"";} ?> value="0" class="largerCheckbox"/> 
      </td>
    <td id="fuente1">&nbsp;      </td>
    <td id="dato4">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <?php } ?>  
	  ...
	  $nombre2 = mysql_result($resultrtp, 0, 'nombre_rtp');echo $nombre2; }?> </td>
        ...
        <td id="fuente1"><a href="javascript:eliminar_varias('id_rps',<?php $delrp=mysql_result($tiempoPreparacion,$x,id_rt); echo $delrp; ?>,'id_rs',<?php echo $row_rollo_sellado_edit['id_r']; ?>,'produccion_registro_sellado_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a>
         </td>
      </tr>
      <?php } ?>
      <tr>
	  ...
	  if($numrtd >='1')
	  { 
	  $nombre3 = mysql_result($resultrtd, 0, 'nombre_rtp'); echo $nombre3; }?>
          <strong>
        ...
        <td id="fuente1"><a href="javascript:eliminar_varias('id_rds',<?php $delrd=mysql_result($desperdicio,$i,id_rd); echo $delrd; ?>,'id_rs',<?php echo $row_rollo_sellado_edit['id_r']; ?>,'produccion_registro_sellado_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a></td>
      </tr>
      <?php } ?>
      <tr>
