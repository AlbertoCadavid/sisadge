        ...
        <tr>
         <td align="center">
          ...
          <form id="envio" name="envio" action="envio.php" method="get">
            <div class="row">
              <div class="span3"> 
                ...
                <option value=""<?php if (!(strcmp("", $_GET['valor']))) {echo "selected=\"selected\"";} ?>>Seleccione Cliente</option>
                <?php  foreach($proveedores as $row_proveedores ) { ?>
                <option value="<?php echo $row_proveedores['id_p']; ?>"<?php if (!(strcmp($row_proveedores['id_p'], $_GET['valor']))) {echo "selected=\"selected\"";} ?>><?php echo htmlentities($row_proveedores['proveedor_p']); ?> </option>
                <?php } ?>
                </select>  
            </div>
            <div class="span3"> <strong >Entrada - Salida</strong>
               <select id="entrada" name="entrada" class="selectsMini buscar">
                   <option value=""<?php if (!(strcmp("", $_GET['valor']))) {echo "selected=\"selected\"";} ?>>Seleccione</option>
                   <option value="Entrada"<?php if (!(strcmp("Entrada", $_GET['valor']))) {echo "selected=\"selected\"";} ?>>Entrada</option>
                   <option value="Salida"<?php if (!(strcmp("Salida", $_GET['valor']))) {echo "selected=\"selected\"";} ?>>Salida</option>
              </select>
            </div>
             <div class="span3"> <strong >FECHAS: </strong>
          ...
          <div class="container-fluid"> 
             ...
             <div style="text-align: right;" > <a href="insumos_interno_entrada_salida.php"><img src="images/masazul.PNG" alt="ADD REMISION INTERNA" title="ADD REMISION INTERNA" border="0" style="cursor:hand;"/></a></div>
             <hr>
