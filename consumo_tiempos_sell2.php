...
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op >= $proceso AND DATE(f_sellada) BETWEEN '$fecha1' AND '$fecha2' ORDER BY id_op DESC";	
}
//Filtra fecha lleno
if($fecha1 != '' && $fecha2 != '' && $id_op == '')
{
...
if($fecha1 != '' && $fecha2 != '' && $id_op != '')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op >= $proceso AND DATE(f_sellada) BETWEEN '$fecha1' AND '$fecha2' AND int_cod_ref_op='$id_op' ORDER BY id_op DESC";	
}
...
<form action="consumo_tiempos_sell2.php" method="get" name="form1">
<table id="tabla1">
<tr>
<td colspan="3" nowrap="nowrap" id="codigo" >CODIGO : R1 - F03</td>
<td colspan="3" nowrap="nowrap" id="titulo2" >TIEMPOS DE SELLADO</td>
<td nowrap="nowrap" id="codigo" >VERSION : 2</td>
</tr>
<tr>
  <td colspan="3" nowrap="nowrap" id="codigo3">&nbsp;</td>
  <td colspan="3" nowrap="nowrap" id="titulo2">&nbsp;</td>
  <td nowrap="nowrap" id="codigo3">&nbsp;</td>
</tr>
<tr>
  <td colspan="7" id="fuente2">FECHA INICIO:
...
<input type="submit" name="submit" value="FILTRO"/></td>
  ...
  <tr>
    <td colspan="4" id="dato1">Nota: las o.p deben estar en estado finalizadas.estado  &gt; 4 </td> 
    <td colspan="2" id="dato3"><a href="produccion_registro_extrusion_listado.php"><img src="images/e.gif" alt="LISTADO EXTRUSION"title="LISTADO EXTRUSION" border="0" style="cursor:hand;" /></a><a href="produccion_registro_impresion_listado.php"><img src="images/i.gif" alt="LISTADO IMPRESION"title="LISTADO IMPRESION" border="0" style="cursor:hand;" /></a><a href="produccion_registro_sellado_listado.php"><img src="images/s.gif" alt="LISTADO SELLADO"title="LISTADO SELLADO" border="0" style="cursor:hand;" /></a><a href="costos_listado_ref_xproceso.php"></a><a href="consumo_materias_primas_sell.php"><img src="images/mp.gif" alt="LISTADO DE MATERIAS PRIMAS"title="LISTADO DE MATERIAS PRIMAS" border="0" style="cursor:hand;" /></a><a href="costos_listado_ref_xproceso.php"><img src="images/rp.gif" alt="LISTADO REF KILOS X PROCESO"title="LISTADO REF KILOS X PROCESO" border="0" style="cursor:hand;" /></a><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;"/></a></td> 
    <td id="dato3"><input type="button" value="Descarga Excel" onClick="window.location = 'consumo_tiempos_sell_excel.php?fecha_ini=<?php echo $_GET['fecha_ini'] ?>&fecha_fin=<?php echo $_GET['fecha_fin'] ?>&id_op=<?php echo $_GET['id_op']?>'" /></td>
    </tr>
 </table>
<table id="tabla1" >    
    <tr id="tr1">
