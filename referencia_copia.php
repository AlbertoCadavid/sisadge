...
$query_cotizacion = "SELECT * FROM Tbl_referencia WHERE estado_ref='1' GROUP BY Tbl_referencia.cod_ref  ORDER by id_ref desc";
                ...
                <tr align="center">
                  <td> 
                        <td colspan="2" align="center" id="linea1">
                          <form action="referencia_copia2.php" method="get" name="consulta">
                            <table id="tabla1">
                                ...
                                <td colspan="2" id="fuente2">
                                  <select class="busqueda selectsMini" name="id_ref" id="id_ref">
                                   ...
                                   <?php  foreach($row_numero as $row_numero ) { ?>
                                    <option value="<?php echo $row_numero['id_ref']?>"><?php echo $row_numero['cod_ref']?></option>
                                  <?php } ?>
                                </select>
                              ...
                              <input type="submit" class="botonGMini" name="Submit" value="FILTRO" onclick="if(consulta.id_ref.value=='0' && consulta.id_c.value=='0') { alert('DEBE SELECCIONAR UNA OPCION'); }"/></td>
                              <td id="fuente1"><input class="botonDel" type="button" value="Excel_Ref" onclick="window.location = 'referencia_excel.php?id_ref=<?php echo '0'; ?>&amp;id_c=<?php echo '0'; ?>'" /></td>
                              <td id="fuente1"> <input class="botonDel" type="button" value="Excel_RefCliente" onclick="window.location = 'referencia_excel_cliente.php?id_ref=<?php echo '0'; ?>&amp;id_c=<?php echo '0'; ?>&amp;ref_clientes=<?php echo '1'; ?>'" /></td>
                            </tr>
                          </table>
                        </form>
                        <form action="delete_listado.php" method="get" name="seleccion">
                          <table class="table table-bordered table-sm">
                            <tr>
                              <td colspan="2"><input name="borrado" type="hidden" id="borrado" value="50" />
                                <input class="botonDel" name="Input" type="submit" value="Delete"/></td>
                                <td colspan="3"><?php $id=$_GET['id']; $mensaje=$_GET['mensaje']; 
                                ...
                                <?php do { ?>
                                  <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                                    ...
                                    <td id="dato2"><a href="control_tablas.php?cod_ref= <?php echo $row_cotizacion['cod_ref']; ?>&n_cotiz= <?php echo $row_cotizacion['n_cotiz_ref']; ?>&id_ref= <?php echo $row_cotizacion['id_ref']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "5"; ?>" target="new" style="text-decoration:none; color:#000000"><?php 
                                     $row_formula = $conexion->buscar('tbl_formulacion','nombre',$row_cotizacion['tipo_bolsa_ref']);  
                                     echo $row_formula['formulacion'];
                                    ; ?></a></td>
