...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $updateSQL4 = sprintf(
    "UPDATE Tbl_orden_produccion SET b_estado_op='1', b_visual_op='0',f_coextruccion=DATE(%s) WHERE id_op=%s",
    GetSQLValueString($_POST['fecha_fin_rp'], "date"),
    GetSQLValueString($_POST['id_op_rp'], "int")
  );
    ...
    <table class="table table-bordered table-sm">
      ...
      <tr>
        ...
        <td colspan="10" id="dato3">
          <a href="produccion_extrusion_listado_rollos.php?id_op_r=<?php echo $_GET['id_op']; ?>"><img src="images/opciones.gif" style="cursor:hand;" alt="LISTADO O.P" title="LISTADO O.P" border="0" /></a><a href="menu.php"><img src="images/identico.gif" style="cursor:hand;" alt="MENU PRINCIPAL" border="0" /></a>
        </td>
      </tr>
      <tr id="tr1">
        <td width="182" colspan="5" nowrap="nowrap" id="dato2">ORDEN DE PRODUCCION</td>
        <td colspan="5" id="dato3"> Ingresado por
          <input name="str_responsable_rp" type="text" id="str_responsable_rp" value="<?php echo $row_usuario['nombre_usuario']; ?>" size="27" readonly="readonly" />
        </td>
      </tr>
      <tr id="tr3">
      ...
      <tr>
        ...
        <td colspan="10" id="fuente1"><input type="text" name="int_kilos_prod_rp" id="int_kilos_prod_rp" min="0" step="any" style="width:80px" autofocus="autofocus" readonly="readonly" />
          ...
          <input type="hidden" name="parcial" id="parcial" value="<?php echo $ult_parcial; ?>" />
        </td>
      </tr>
      <tr>
        ...
        <td colspan="5" id="fuente1">
          <select name="int_cod_empleado_rp" id="montaje" style="width:120px">
            ...
            <?php foreach ($row_codigo_empleado as $row_codigo_empleado) { ?>
              <option value="<?php echo $row_codigo_empleado['codigo_empleado'] ?>" <?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $rew_operarios['cod_empleado_r']))) {
          ...
          <select name="int_cod_liquida_rp" id="liquida" style="width:120px">
            ...
            <?php foreach ($row_revisor as $row_revisor) { ?>
              <option value="<?php echo $row_revisor['codigo_empleado'] ?>" <?php if (!(strcmp($row_revisor['codigo_empleado'], $rew_operarios['cod_auxiliar_r']))) {
                                                                              echo "selected=\"selected\"";
      ...
      <tr>
        ...
        <td colspan="5" id="fuente1"><input type="hidden" name="horas_rp" id="horas_rp" readonly="readonly" size="7" />
          ...
          <input type="number" name="int_metro_lineal_rp" id="metro_r" min="0" step="any" required="required" placeholder="Metro Lineal" style="width:116px" value="<?php if ($max_metros == 0) {
                                                                                                                                                                      echo "";
                                                                                                                                                                    } else {
                                                                                                                                                                      echo $max_metros;
                                                                                                                                                                    } ?>" />
          <input name="metro_op" type="hidden" id="metro_op" value="<?php echo $row_orden_produccion['metroLineal_op']; ?>" />
          Metro lineal de <?php echo $row_orden_produccion['metroLineal_op']; ?>
        </td>
      </tr>
      <tr id="tr1">
        ...
        <td colspan="5" id="fuente1"><input type="number" name="rollo_rp" id="rollo_rp" step="any" required="required" readonly="readonly" value="<?php echo $rollo_liqu; ?>" style="width:55px" />
          <input type="number" name="int_total_rollos_rp" id="int_total_rollos_rp" step="any" required="required" readonly="readonly" placeholder="Total Rollos" value="<?php if ($max_rollo == 0) {
                                                                                                                                                                          echo "";
                                                                                                                                                                        } else {
                                                                                                                                                                          echo $max_rollo;
                                                                                                                                                                        } ?>" style="width:55px" />
      ...
      <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
        ...
        <?php else : ?>
          <td colspan="3" nowrap="nowrap" id="fuente1">
            <?php echo $row_totalKilos['fechaF_r'];
              $liquidado = 'Liquidado'; ?> <em><?php echo  $liquidado; ?></em>
          <?php endif; ?>
          </td>
    ...
    <tr id="tr1">
      <td colspan="12" id="dato2">
        ...
        for ($TK = 0; $TK <= $totalRows_totalKilos - 1; $TK++) { ?>
          <input name="kilos_extruido[]" type="hidden" id="kilos_extruido[]" value="<?php $tK = mysql_result($totalKilos, $TK, int_total_kilos_rp);
                                                                                    echo $tK; ?>" />
        <?php } ?>
