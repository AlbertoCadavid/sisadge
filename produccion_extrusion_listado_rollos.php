        ...
        <table id="tabla1">
          ...
          <?php do { ?>
            <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
              ...
              <td id="dato3"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['kilos_r'];
                                                                                                                                                                                              $TKILOS += $row_rollo_estrusion['kilos_r']; ?></a></td>
              <td id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['metro_r'];
                                                                                                                                                                                              $TMETROS += $row_rollo_estrusion['metro_r']; ?></a></td>
