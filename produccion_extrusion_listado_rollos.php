          ...
          <tr>
            ...
            <?php do { ?>
              ...
              <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                <td style="width:72px" id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&p=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['rollo_r']; ?></a></td>
