...
<table id="tabla1">  
  ...
  <?php do { ?>
    ...
    <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
      ...
      <td id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['fechaV_r']; ?></a></td> 
      <td id="dato1"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['cod_empleado_r']; ?> <?php if($row_parcial['rollo_rp']==$row_rollo_estrusion['rollo_r']){ $textos = $row_parcial['parcial']==1 ? 'Unico' : 'Parcial'; echo "<em style='color: red;' >  $textos <em>".$row_parcial['parcial']; }  ?> </a></td>
    </tr>
