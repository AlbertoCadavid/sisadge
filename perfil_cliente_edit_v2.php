         ...
         <tr>
           ...
           <tr>
             <td colspan="3" id="dato_1">
              <input name="nit_c" type="hidden" onChange="desapareceClick(this)"  value="<?php echo $row_cliente['nit_c']; ?>" size="30" readonly onClick="reasignarnit()"><a href="perfil_cliente_reasignacion.php?nit=<?php echo $row_cliente['nit_c'];?>" title="Reasignacion del nit" target="new"><em>Reasignar nit</em></a>
           ...
           <tr>
             ...
             <tr>
               <td id="dato_1"><input name="direccion_c"  id="dirC" type="text" onBlur="copiadirC()" value="<?php echo ($row_cliente['direccion_c']); ?>" size="50" maxlength="150" required></td>
               <td id="dato_4"></td>
...
<tr>
 ...
 <td id="detalle_1"><input name="indicativo11" type="text" id="indicativo11" onClick="this.value = ''" onKeyUp="return ValNumero(this)" value= "<?php $tel= $row_cliente['fax_c'];list($ind,$tele,$ext)=explode("/",$tel);echo $ind?>" style="width:40px">
   ...
   <tr>
     <td id="dato_1"><input name="direccion_envio_factura_c" id="dirF" type="text"  value="<?php echo $row_cliente['direccion_envio_factura_c']; ?>" size="50" maxlength="100" required></td>
...
<tr>
  ...
  <tr>
     ...
     <td id="dato_1">Registrado Por </td>
     <td id="dato_1"><?php echo $row_cliente['registrado_c']; ?>
        <input name="registrado_c" type="hidden" value="<?php echo $row_cliente['registrado_c']; ?>"></td>
     <td id="dato_1">&nbsp;</td>
  </tr>
  <tr>
