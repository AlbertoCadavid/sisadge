...
// *** Restrict Access To Page: Grant or deny access to this page
  ...
  $query_ordenes_deudoras = "SELECT * FROM Tbl_orden_compra WHERE $soloinventario  b_borrado_oc='0' AND  pago_pendiente = 'SI' AND  especialweb <> '1'  ORDER BY  $listar,   str_numero_oc DESC"; 
  ...
  $query_ordenes_notas = "SELECT * FROM Tbl_orden_compra WHERE $soloinventario  b_borrado_oc='0' AND  especialweb = '1' ORDER BY  $listar,   str_numero_oc DESC"; 
