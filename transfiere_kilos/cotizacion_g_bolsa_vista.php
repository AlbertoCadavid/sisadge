...
{ ?>
      <table id="tablainterna" >
        <tr>
          <td width="139" colspan="<?php echo $num2+1; ?>" nowrap  id="subppal2"><strong>REFERENCIAS EXISTENTES<img id="Boton" src="images/mas.gif" alt="Mostrar Datos" title="Mostrar Datos" border="0" style="cursor:hand;" Onclick="Columnas();"/></strong></td>
        </tr>
        <tr>
          <td id="subppal4">REFERENCIA N</td>
...
<table id="tablainterna" align="center">
  <tr>
    <td id="noprint" align="center"><?php if($_SESSION['acceso']) { ?>
      <a href="cotizacion_general_bolsas_edit.php?N_cotizacion=<?php echo $_GET['N_cotizacion']; ?>&Str_nit=<?php echo $row_cotizacion_cliente['Str_nit']; ?>&cod_ref=<?php echo $row_cotizacion_fc['N_referencia_c']; ?>"><img src="images/menos.gif" alt="EDITAR" title="EDITAR"border="0" /></a><a href="cotizacion_general_bolsa_generica.php?N_cotizacion=<?php echo $_GET['N_cotizacion']; ?>&Str_nit=<?php echo $row_cotizacion_cliente['Str_nit']; ?>"><img src="images/mas.gif" alt="ADD A LA COTIZACION"title="ADD A LA COTIZACION" border="0" style="cursor:hand;"/></a>
      <?php } ?>
