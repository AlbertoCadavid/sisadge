      ...
      //$nuevosMetros = regladetres($kilosR,$metrosE,$kilosT);//metros nuevos para impresion    
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td id="fuente1"><select name="cod_empleado_r"  style="width:120px" id="operario" onFocus="">
                    ...
                    <td colspan="2" id="fuente1"><select name="cod_auxiliar_r" style="width:120px" id="auxiliar">
                      <option value=""<?php if (!(strcmp("", $row_rollo_impresion_edit['cod_auxiliar_r']))) {echo "selected=\"selected\"";} ?>>Seleccione</option>
                      <?php
                      do {  
                        ?>
                        <option value="<?php echo $row_codigo_empleado['codigo_empleado']?>"<?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $row_rollo_impresion_edit['cod_auxiliar_r']))) {echo "selected=\"selected\"";} ?>><?php echo $row_codigo_empleado['codigo_empleado']." - ".$row_codigo_empleado['nombre_empleado']." ".$row_codigo_empleado['apellido_empleado']?></option>
                        <?php
                      } while ($row_codigo_empleado = mysql_fetch_assoc($codigo_empleado));
                      $rows = mysql_num_rows($codigo_empleado);
                      if($rows > 0) {
