...
$sqlp="UPDATE proveedor_seleccion SET ultima_calificacion_p='$calificacion_final', registro_ultima_calificacion='$responsable_calificacion', fecha_ultima_calificacion_p='$fecha_calificacion' WHERE id_p_seleccion='$id_p'";
  ...
  $updateGoTo = "evaluacion_proveedor_servicio_vista.php?id_ev=" . $_POST['id_ev'] . "&id_p=" . $_POST['id_p_ev'] . "&evaluacion=" . $_POST['evaluacion'] . "&desde=" . $_POST['periodo_desde_ev'] . "&hasta=" . $_POST['periodo_hasta_ev'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<td id="titulo">EVALUACION DE DESEMPEÑO DEL PROVEEDOR DE <?php echo $row_proveedor_ver['tipo_servicio_p'];?></td>
</tr>
<tr>
<td id="dato2">
<form name="form2" method="get" action="evaluacion_proveedor_edit.php">
	...
	<td id="fuente3"><a href="javascript:eliminar1('id_ev',<?php echo $row_evaluacion_edit['id_ev']; ?>,'evaluacion_proveedor_servicio_edit.php')"><img src="images/por.gif" alt="ELIMINAR" border="0" style="cursor:hand;"/></a><a href="evaluacion_proveedor_carta_servicio.php?id_ev=<?php echo $row_evaluacion_edit['id_ev']; ?>&tipo_evaluacion=<?php echo $row_proveedor_ver['tipo_servicio_p']; ?>"><img src="images/carta.gif" target="_blank" alt="CARTA" title="PRODUCTO-SERVICIO" border="0" style="cursor:hand;" ></a><a href="evaluacion_proveedor_servicio_vista.php?id_p=<?php echo $row_evaluacion_edit['id_p_ev']; ?>&evaluacion=<?php echo $_GET['evaluacion']; ?>&id_ev=<?php echo $_GET['id_ev']; ?>&desde=<?php echo $_GET['desde']; ?>&hasta=<?php echo $_GET['hasta']; ?>"><img src="images/hoja.gif" alt="VISTA IMPRESION" border="0" /></a><a href="evaluacion_proveedor.php?id_p=<?php echo $row_evaluacion_edit['id_p_ev']; ?>&evaluacion=<?php echo $_GET['evaluacion']; ?>"><img src="images/cat.gif" alt="EVALUACIONES" border="0" style="cursor:hand;" /></a><a href="evaluacion_proveedor.php"><img src="images/e.gif" alt="CAMBIAR PROVEEDOR" border="0" style="cursor:hand;" /></a><a href="proveedores.php"><img src="images/p.gif" alt="PROVEEDORES" border="0" /></a><a href="insumos.php"><img src="images/i.gif" style="cursor:hand;" alt="INSUMOS" border="0" /></a><a href="orden_compra.php"><img src="images/o.gif" style="cursor:hand;" alt="ORDENES DE COMPRA" border="0" /></a><a href="verificaciones_criticos.php"><img src="images/v.gif" style="cursor:hand;" alt="VERIFICACIONES (INSUMOS CRITICOS)" border="0" /></a></td>
	</tr>
	<tr>
	  <td id="dato2">
...
<!--  <td id="abajo3"><?php echo $row_verificaciones_insumos['cantidad_recibida_vi']; ?></td>
 <td nowrap id="abajo3">
    <?php	
	  ...
	  if($cant3>'100') { $cant3=100; } } else { $cant3=0; } echo $cant3; ?>%
  </td>
  <td id="abajo2"><?php	if($cant3=='90') { echo "Si"; $cumple=$cumple+1; }
	  if($cant3>'90') { echo "Si"; $cumple=$cumple+1; }
	  if($cant3<'90') { echo "No"; $nocumple=$nocumple+1; } ?> 
  </td> -->
 <td id="abajo3">
  <?php $apariencia=$row_verificaciones_insumos['apariencia_vi'];
                            ...
                            <td nowrap id="fuente3">% Oportunos
                              ...
                              <!-- <td nowrap id="fuente3">% Cumple
                                ...
                                <td nowrap id="fuente3">% Conforme
                                  <?php $porc_conforme1=($abuena/$suma_vr)*40;	
                                  ...
                                  <td nowrap id="fuente3">% Atencion
                                    <?php $porc_atencion1=($serviciosi/$suma_vr)*35;
                                  ...
                                  <tr>
                                    <td colspan="6" id="numero1"><strong>PORCENTAJE FINAL (%)</strong>
                                      <?php $total=0; $total=$porcentaje+$porc_conforme+$porc_atencion; ?>
                                ...
                                <tr>
                                  <input name="evaluacion" type="hidden" id="evaluacion" value="<?php echo $_GET['evaluacion'] =='' ? $row_evaluacion_edit['evaluacion'] : $_GET['evaluacion']; ?>">
