...
function runSQL($rsql) {
	$hostname = "localhost";
	$username = "acycia_root";
	$password = "ac2006";
	$dbname   = "acycia_intranet";
...
$sql = "SELECT id,iso,name,printable_name,iso3,numcode,fecha_reg FROM country $where $sort $limit";
$result = runSQL($sql);
