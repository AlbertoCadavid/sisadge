...
?>
  <?php 
   if($row_evaluacion_proveedor['tipo_servicio_p']=='SERVICIOS') { 

         header("location:evaluacion_proveedor_carta_servicio.php?id_ev=".$row_evaluacion_proveedor['id_ev']."&tipo_evaluacion=".$row_evaluacion_proveedor['tipo_servicio_p']);
     } else if($row_evaluacion_proveedor['tipo_servicio_p']=='PRODUCTO-SERVICIOS') {

         header("location:evaluacion_proveedor_carta_producto_servicio.php?id_ev=".$row_evaluacion_proveedor['id_ev']."&tipo_evaluacion=".$row_evaluacion_proveedor['tipo_servicio_p']);
	...
	<div align="center" >
      	...
      	<tbody>
      		<tr>
      			...
      			<td><strong>OPORTUNIDAD</strong> <br>
      				(Tiempo de entrega) (<=0 días)
      			</td>
      			<td id="dato2">20%</td>
      			<td id="dato2"><?php echo $row_evaluacion_proveedor['porcentaje_oportunos_ev']; ?> % </td>
      		</tr>
      		<tr> 
      			<td><strong>CUMPLIMIENTO  EN CANTIDAD</strong><br>
      				(Total entregado) (>=90%)
      			</td>
      			<td id="dato2">25%</td>
      			<td id="dato2"><?php echo $row_evaluacion_proveedor['porcentaje_cumple_ev']; ?> % </td>
      		</tr>
      		<tr>
      ...
      <?php 
         switch ($row_evaluacion_proveedor['porcentaje_final_ev']) {
         	case $row_evaluacion_proveedor['porcentaje_final_ev'] > 94 && $row_evaluacion_proveedor['porcentaje_final_ev'] < 101:
         		   $resultado_eval = "Excelente,";
         		break;
         	case $row_evaluacion_proveedor['porcentaje_final_ev'] > 79 && $row_evaluacion_proveedor['porcentaje_final_ev'] < 95:
         		   $resultado_eval = "Bueno,";
         		break;
         	case $row_evaluacion_proveedor['porcentaje_final_ev'] > 69 && $row_evaluacion_proveedor['porcentaje_final_ev'] < 80:
      ...
      <table style="width:80%">
      	<tr>
      		<td id="justificar">
      			...
      			<br>
            TIPO PRODUCTO O SERVICIO: <strong> <?php echo $row_evaluacion_proveedor['tipo_servicio_p']; ?></strong>
           </td>
         </tr>
         <tr align="center">
         	<td> 
