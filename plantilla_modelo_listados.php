...
if ( isset($_GET["valor"]) ) {
  ...
  $registros=$conexion->buscarListar("verificacion_insumos","*","ORDER BY n_vi DESC","",$maxRows_registros,$pageNum_registros,"where $busqueda ='$colname_busqueda'" );
}else{ 
          ...
          <div class="container-fluid"> 
             ...
             <div class="span3"> <strong >FECHAS RECIBIDO: </strong>
              ...
              <div class="span3"> <strong >OP: </strong>
               <select name="id_op" id="id_op"  class="busqueda selectsMedio">
                   <option value="0">O.P</option>
                      <?php  foreach($row_lista as $row_lista ) { ?>
                   <option value="<?php echo $row_lista['id_op']; ?>"><?php echo htmlentities($row_lista['id_op']); ?> 
                 </option>
               <?php } ?>
               </select>
               </div>
