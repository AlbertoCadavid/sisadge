...
WHERE a.tipo_empleado IN(7,9) AND b.fecha BETWEEN DATE_FORMAT('$FECHA_NOVEDAD_SELL', '%Y-%m-01') AND DATE_FORMAT('$FECHA_NOVEDAD_SELL', '%Y-%m-31')"; //IN(5,10)novedad impresion 
  ...
  $nuevovalor = [
    "id_proceso_rp" => $_POST['id_proceso_rp'], "id_op_rp" => $_POST['id_op_rp'], "id_ref_rp" => $_POST['id_ref_rp'], "int_cod_ref_rp" => $_POST['int_cod_ref_rp'], "version_ref_rp" => $_POST['version_ref_rp'], "placa_rp" => $_POST['placa_rp'], "bolsa_rp" => $_POST['bolsa_rp'], "lam1_rp" => $_POST['lam1_rp'], "lam2_rp" => $_POST['lam2_rp'], "turno_rp" => $_POST['turno_rp'], "rollo_rp" => $_POST['rollo_rp'], "n_ini_rp" => $_POST['n_ini_rp'], "n_fin_rp" => $_POST['n_fin_rp'], "int_kilos_prod_rp" => $_POST['int_kilos_prod_rp'], "int_kilos_desp_rp" => $_POST['int_kilos_desp_rp'], "int_total_kilos_rp" => $_POST['int_total_kilos_rp'], "porcentaje" => $_POST['porcentaje'], "metro_r2" => $_POST['metro_r2'], "int_total_rollos_rp" => $_POST['int_total_rollos_rp'], "total_horas_rp" => $_POST['total_horas_rp'], "rodamiento_rp" => $_POST['rodamiento_rp'], "horas_muertas_rp" => $_POST['horas_muertas_rp'], "horas_prep_rp" => $_POST['horas_prep_rp'], "str_maquina_rp" => $_POST['str_maquina_rp'], "str_responsable_rp" => $_POST['str_responsable_rp'], "fecha_ini_rp" => $_POST['fecha_ini_rp'], "fecha_fin_rp" => $_POST['fecha_fin_rp'], "int_kilosxhora_rp" => $_POST['int_kilosxhora_rp'], "int_metroxmin_rp" => $_POST['int_metroxmin_rp'], "int_cod_empleado_rp" => $_POST['int_cod_empleado_rp'], "int_cod_liquida_rp" => $_POST['int_cod_liquida_rp'], "kiloSistema" => $_POST['kiloSistema'], "costo" => $COSTOHORAKILOSELL
  ];

  $columnas = [
    "id_proceso_rp" => "id_proceso_rp", "id_op_rp" => "id_op_rp", "id_ref_rp" => "id_ref_rp", "int_cod_ref_rp" => "int_cod_ref_rp", "version_ref_rp" => "version_ref_rp", "placa_rp" => "placa_rp", "bolsa_rp" => "bolsa_rp", "lam1_rp" => "lam1_rp", "lam2_rp" => "lam2_rp", "turno_rp" => "turno_rp", "rollo_rp" => "rollo_rp", "n_ini_rp" => "n_ini_rp", "n_fin_rp" => "n_fin_rp", "int_kilos_prod_rp" => "int_kilos_prod_rp", "int_kilos_desp_rp" => "int_kilos_desp_rp", "int_total_kilos_rp" => "int_total_kilos_rp", "porcentaje_op_rp" => "porcentaje_op_rp", "int_metro_lineal_rp" => "int_metro_lineal_rp", "int_total_rollos_rp" => "int_total_rollos_rp", "total_horas_rp" => "total_horas_rp", "rodamiento_rp" => "rodamiento_rp", "horas_muertas_rp" => "horas_muertas_rp", "horas_prep_rp" => "horas_prep_rp", "str_maquina_rp" => "str_maquina_rp", "str_responsable_rp" => "str_responsable_rp", "fecha_ini_rp" => "fecha_ini_rp", "fecha_fin_rp" => "fecha_fin_rp", "int_kilosxhora_rp" => "int_kilosxhora_rp", "int_metroxmin_rp" => "int_metroxmin_rp", "int_cod_empleado_rp" => "int_cod_empleado_rp", "int_cod_liquida_rp" => "int_cod_liquida_rp", "kiloFaltante_rp" => "kiloFaltante_rp", "costo" => "costo"
  ];



  if (isset($_POST['id_op_rp']) && $nuevovalor) {
    $myObject->RegistrarGen("tbl_reg_produccion", $columnas, $nuevovalor);
  } //FIN  
  ...
  if (isset($_POST['id_op_rp']) && $nuevovalorRollo) {
    ...
    if ($_POST['rolloParcial_r'] == 0) {
      $objRollo->actualizarRegistro("tbl_numeracion", "rollo = null", "WHERE int_op_n = $_POST[id_op_rp]"); //actualiza el campo de rollo a null para que en la pantala de tiquetes vuelva a pedir que escojan el nuevo rollo
    }
  } //FIN  
  ...
  for ($t = 0; $t < count($cinta); $t++) {
    if (!empty($cinta[$t])) {
      $updateINV = sprintf(
        "UPDATE TblInventarioListado SET Salida=Salida + %s WHERE Codigo = %s",
      ...
      $insertSQLkp = sprintf(
        "INSERT INTO Tbl_reg_kilo_producido (id_rpp_rp,valor_prod_rp,op_rp,int_rollo_rkp,id_proceso_rkp,fecha_rkp,costo_mp) VALUES (%s, %s, %s, %s, %s, %s, %s)",
        GetSQLValueString($cinta[$t], "int"),
        GetSQLValueString($_POST['metro_r2'], "text"),
        GetSQLValueString($_POST['id_op_rp'], "int"),
        GetSQLValueString($_POST['rollo_rp'], "int"),
  ...
  $updateINV2 = sprintf(
    "UPDATE TblInventarioListado SET Entrada=Entrada + %s WHERE Codigo = %s",
    GetSQLValueString($_POST['bolsa_rp'], "int"),
  ...
  $updateSQL3 = sprintf(
    "UPDATE Tbl_orden_produccion SET  b_estado_op=%s,f_sellada=DATE(%s) WHERE id_op=%s",
    ...
    <table class="table table-bordered table-sm">
      ...
      <tr>
        ...
        <td colspan="3" id="dato2">
          ...
          </select> <a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;" /></a>
        </td>
      </tr>
      <tr id="tr1">
      ...
      <tr id="tr3">
        ...
        <td nowrap="nowrap" id="fuente2"><?php $ultipo_reg = $row_ultimo['id_r'] + 1 ?>
          <input type="hidden" name="id_r" id="id_r" value="<?php echo $ultipo_reg; ?>" />
        </td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        ...
        <td id="fuente1">Bolsas x Rollo
          <input type="number" name="bolsa_rp" min="1" id="bolsa_rp" readonly="readonly" style="width:80px" required="required" onchange="kiloComparativoSell();kiloDisponible();restakilosT();" />
        </td>
        <td id="fuente1">
          <p>Reproceso</p>
          <p>
      ...
      <tr id="tr1">
        ...
        <td id="fuente1"><?php
          ...
          <select name="str_maquina_rp" id="maquina" style="width:155px" required><!--maquina();-->
            <option value="" <?php if (!(strcmp("", $maquinacero))) {
                                echo "selected=\"selected\"";
                              } ?>>Maquina</option>
            <?php
            do {
            ?>
              <option value="<?php echo $row_maquinas['id_maquina'] ?>" <?php if (!(strcmp($row_maquinas['id_maquina'], $maquinacero))) {
                                                                          echo "selected=\"selected\"";
        ...
        <td id="fuente1">
          <select name="int_cod_empleado_rp" style="width:120px" id="operario" required>
            <option value="" <?php if (!(strcmp("", $empleadocero))) {
                                echo "selected=\"selected\"";
                              } ?>>Operario</option>
        ...
        <td id="fuente1">
          ...
          <select name="int_cod_liquida_rp" style="width:120px" id="auxiliar">
            <option value="" <?php if (!(strcmp("", $auxiliarcero))) {
                                echo "selected=\"selected\"";
                              } ?>>Revisor</option>
            <?php foreach ($row_revisor as $row_revisor) { ?>
              <option value="<?php echo $row_revisor['codigo_empleado'] ?>" <?php if (!(strcmp($row_revisor['codigo_empleado'], $auxiliarcero))) {
                                                                              echo "selected=\"selected\"";
    ...
    <td colspan="2" id="fuente1"> 
      ...
      <tr>
        ...
        <td colspan="3" id="fuente1">
          ...
          Tiempo Optimo
          <input name="rodamiento_rp" id="tiempoOptimo_rp" type="text" size="5" onclick="restakilosT();" required="required" placeholder="rodamientos" value="" readonly="readonly" />
        </td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        ...
        <td colspan="2" id="fuente1">
          ...
          <input type="number" name="kiloSistema" id="kiloSistema" style="width:55px" required="required" placeholder="Sistema" min="0.00" step="any" value="0" readonly="readonly" onclick="kiloComparativoSell();kiloDisponible();restakilosT();" />
        </td>
      ...
      <input name="kilos_sellado[]" type="hidden" id="kilos_sellado[]" value="<?php $tK = mysql_result($Rollos, $r, int_total_kilos_rp);
                                                                              echo $tK; ?>" />
      <?php } ?> --><strong>
