...
if($var2 != '')
{
$query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE int_cod_ref_op='$var2' ORDER BY id_op DESC";
}
//FILTRA MES LLENO
if($var3 !='')
{
...
if($estado != '')
{
$query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE tbl_orden_produccion.b_estado_op='$estado' ORDER BY tbl_orden_produccion.id_op DESC";
...
{
$query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 AND b_borrado_op='0'  ORDER BY b_visual_op,id_op DESC";
}
//FILTRA OP LLENO
if($var1 != '0' && $var2 == '0' && $var3 == '0' &&  $anyo=='0' && $estado =='0')
{
...
if($var1 == '0' && $var2 == '0' && $var3 == '0' &&  $anyo!='0' && $estado =='0')
{
  $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE YEAR(fecha_registro_op)='$anyo' AND b_borrado_op='0' ORDER BY id_op DESC";
}
//FILTRA AÑO MES
if($var1 == '0' && $var2 == '0' && $var3 != '0' &&  $anyo!='0' && $estado =='0')
{
...
//FILTRA ESTADO AÑO MES
if($var1 == '0' && $var2 == '0' && $var3 != '0' && $anyo!='0' && $estado =='0')
{
  $query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE b_borrado_op='0' AND YEAR(fecha_registro_op)='$anyo' AND MONTH(fecha_registro_op)='$var3' ORDER BY b_visual_op,id_op DESC";
}
...
if($var1 == '0' && $var2 == '0' && $var3 == '0' && $anyo=='0' && $estado !='0')
{
$query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC";
}
//FILTRA OP LLENO
if($var1 != '0' && $var2 == '0' && $var3 == '0' &&  $anyo=='0' && $estado !='0')
{
   $query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE tbl_orden_produccion.id_op='$var1' AND tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC";
}
//FILTRA OP AÑO LLENO
if($var1 != '0' && $var2 == '0' && $var3 == '0' &&  $anyo!='0' && $estado !='0')
{
  $query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE tbl_orden_produccion.id_op='$var1' AND YEAR(tbl_orden_produccion.fecha_registro_op)='$anyo' AND tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC"; 
}
//FILTRA REF LLENOS
if($var1 == '0' && $var2 != '0' && $var3 == '0' &&  $anyo=='0' && $estado !='0')
{
  $query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE tbl_orden_produccion.int_cod_ref_op='$var2' AND tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC";
}
//FILTRA REF AÑO LLENO
if($var1 == '0' && $var2 != '0' && $var3 == '0' &&  $anyo!='0' && $estado !='0')
{
  $query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE tbl_orden_produccion.int_cod_ref_op='$var2' AND YEAR(tbl_orden_produccion.fecha_registro_op)='$anyo' AND tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC";
}
//FILTRA MES LLENO
if($var1 == '0' && $var2 == '0' && $var3 != '0' &&  $anyo=='0' && $estado !='0')
{
   $query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE MONTH(tbl_orden_produccion.fecha_registro_op)='$var3' AND tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC";
}
//FILTRA MES AÑO LLENO
if($var1 == '0' && $var2 == '0' && $var3 != '0' &&  $anyo!='0' && $estado !='0')
{
  $query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE YEAR(tbl_orden_produccion.fecha_registro_op)='$anyo' AND MONTH(tbl_orden_produccion.fecha_registro_op)='$var3' AND tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC"; 
}
//FILTRA AÑO LLENO
if($var1 == '0' && $var2 == '0' && $var3 == '0' &&  $anyo!='0' && $estado !='0')
{
  $query_orden_produccion = "SELECT * FROM tbl_orden_produccion left join tbl_reg_produccion ON tbl_orden_produccion.id_op=tbl_reg_produccion.id_op_rp  WHERE YEAR(tbl_orden_produccion.fecha_registro_op)='$anyo' AND tbl_reg_produccion.id_proceso_rp='$estado' GROUP BY tbl_reg_produccion.id_op_rp ORDER BY tbl_reg_produccion.id_op_rp DESC"; 
}
//FILTRA AÑO MES
if($var1 == '0' && $var2 == '0' && $var3 != '0' &&  $anyo!='0' && $estado !='0')
{
        ...
        <tr>
         <td align="center">
           <div class="row-fluid">
             ...
             <form action="produccion_registro_sellado_listado2.php" method="get" name="form1" id="form1"/><!--onSubmit="if(form1.retorno_mensaje.value=='1'){return false;}else if(form1.retorno_mensaje.value=='0'){return true;}"-->
