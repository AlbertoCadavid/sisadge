...
$row_cliente = $conexion->llenaSelect('cliente',"","ORDER BY nombre_c ASC LIMIT 10");  
 ...
 <?php echo $conexion->header('listas'); ?>
                ...
                <tr>
                  <td colspan="12" id="dato2">
                    <select class="busqueda selectsMini" name="cod_ref" id="cod_ref">
                     <option value="0"<?php if (!(strcmp(0, $_GET['cod_ref']))) {echo "selected=\"selected\"";} ?>>Referencia</option>
                  ...
                  <select class="busqueda " style="width:180px" name="bolsa" id="bolsa">
                    <option value="0"<?php if (!(strcmp(0, $_GET['bolsa']))) {echo "selected=\"selected\"";} ?>>Tipo Bolsa</option>
                    <?php  foreach($row_tipobolsa as $row_tipobolsa ) { ?>
                      <option value="<?php echo $row_tipobolsa['tipo_bolsa_ref']?>"<?php if (!(strcmp($row_tipobolsa['tipo_bolsa_ref'], $_GET['bolsa']))) {echo "selected=\"selected\"";} ?>><?php echo $row_tipobolsa['tipo_bolsa_ref']?></option>
                    <?php } ?>
                  </select>
                  
                  <select id='id_c' name='id_c' class="selectsMedio">
                    <option value=""<?php if (!(strcmp("", $_GET['id_c']))) {echo "selected=\"selected\"";} ?>>Seleccione el Cliente</option>
                    <?php  foreach($row_cliente as $row_cliente ) { ?>
                     <option value="<?php echo $row_cliente['nit_c']?>"<?php if (!(strcmp($row_cliente['nit_c'], $_GET['id_c']))) {echo "selected=\"selected\"";} ?>>
                      <?php $cad = ($row_cliente['nombre_c']);echo $cad;?>
                    </option>
                  <?php } ?>
                  </select>
            ...
            <tr>
              <td colspan="12" id="dato2">
                ...
                Solapa
                <input class="selectsMini"type="number" name="solapa" id="solapa" min="0.00" step="0.01" value="<?php echo $_GET['solapa']; ?>"/>
                Ancho
                <input class="selectsMini"type="number" name="ancho" id="ancho" min="0.00" step="0.01" value="<?php echo $_GET['ancho']; ?>"/>
                Largo
                <input class="selectsMini"type="number" name="largo" id="largo" min="0.00" step="0.01" value="<?php echo $_GET['largo']; ?>"/>
                Calibre
                <input class="selectsMini"type="number" name="calibre" id="calibre" min="0.00" step="0.01" value="<?php echo $_GET['calibre']; ?>"/>    

              </td> 
            </tr>
            <tr>
              <td colspan="6" id="dato2">
                <!-- <a href="cotizacion_bolsa.php"></a> -->
                <input class="botonFinalizar" type="button" value="Excel RefCliente" onclick="envioListados()"  /><!-- onclick="window.location = 'referencia_precio_excel.php?id_ref=<?php echo '0'; ?>&amp;id_c=<?php echo '0'; ?>&amp;ref_clientes=<?php echo '1'; ?>'" -->
              </td>
              <td colspan="6" id="dato2"> 
          ...
          <table class="table table-bordered table-sm">
            <tr>
              ...
              <tr id="tr1">
                <td nowrap="nowrap" id="titulo4"><a href="referencia_precio2.php?orden=<?php echo "N_referencia_c";?>&cod_ref=<?php echo $_GET['cod_ref'] ?>&bolsa=<?php echo $_GET['bolsa'] ?>&id_c=<?php echo $_GET['id_c'] ?>&tipo_ref=<?php echo $_GET['tipo_ref'] ?>&solapa=<?php echo $_GET['solapa'] ?>&ancho=<?php echo $_GET['ancho'] ?>&largo=<?php echo $_GET['largo'] ?>&calibre=<?php echo $_GET['calibre'] ?>">N&deg; REF</a></td>
                <td nowrap="nowrap" id="titulo4">TIPO REF</td>
                <td nowrap="nowrap" id="titulo4"><a href="referencia_precio2.php?orden=<?php echo "N_cotizacion";?>&cod_ref=<?php echo $_GET['cod_ref'] ?>&bolsa=<?php echo $_GET['bolsa'] ?>&id_c=<?php echo $_GET['id_c'] ?>&tipo_ref=<?php echo $_GET['tipo_ref'] ?>&solapa=<?php echo $_GET['solapa'] ?>&ancho=<?php echo $_GET['ancho'] ?>&largo=<?php echo $_GET['largo'] ?>&calibre=<?php echo $_GET['calibre'] ?>">COTIZ</a></td>
                <td nowrap="nowrap" id="titulo4"><a href="referencia_precio2.php?orden=<?php echo "Str_nit";?>&cod_ref=<?php echo $_GET['cod_ref'] ?>&bolsa=<?php echo $_GET['bolsa'] ?>&id_c=<?php echo $_GET['id_c'] ?>&tipo_ref=<?php echo $_GET['tipo_ref'] ?>&solapa=<?php echo $_GET['solapa'] ?>&ancho=<?php echo $_GET['ancho'] ?>&largo=<?php echo $_GET['largo'] ?>&calibre=<?php echo $_GET['calibre'] ?>">Cliente</a></td>
                <td nowrap="nowrap" id="titulo4">TIPO</td>
                <td nowrap="nowrap" id="titulo4">BOLSA</td>
                <td nowrap="nowrap" id="titulo4"><a href="referencia_precio2.php?orden=<?php echo "N_ancho";?>&cod_ref=<?php echo $_GET['cod_ref'] ?>&bolsa=<?php echo $_GET['bolsa'] ?>&id_c=<?php echo $_GET['id_c'] ?>&tipo_ref=<?php echo $_GET['tipo_ref'] ?>&solapa=<?php echo $_GET['solapa'] ?>&ancho=<?php echo $_GET['ancho'] ?>&largo=<?php echo $_GET['largo'] ?>&calibre=<?php echo $_GET['calibre'] ?>">Ancho</a></td>
                <td nowrap="nowrap" id="titulo4"><a href="referencia_precio2.php?orden=<?php echo "N_alto";?>&cod_ref=<?php echo $_GET['cod_ref'] ?>&bolsa=<?php echo $_GET['bolsa'] ?>&id_c=<?php echo $_GET['id_c'] ?>&tipo_ref=<?php echo $_GET['tipo_ref'] ?>&solapa=<?php echo $_GET['solapa'] ?>&ancho=<?php echo $_GET['ancho'] ?>&largo=<?php echo $_GET['largo'] ?>&calibre=<?php echo $_GET['calibre'] ?>">Largo</a></td>
                <td nowrap="nowrap" id="titulo4"><a href="referencia_precio2.php?orden=<?php echo "N_solapa";?>&cod_ref=<?php echo $_GET['cod_ref'] ?>&bolsa=<?php echo $_GET['bolsa'] ?>&id_c=<?php echo $_GET['id_c'] ?>&tipo_ref=<?php echo $_GET['tipo_ref'] ?>&solapa=<?php echo $_GET['solapa'] ?>&ancho=<?php echo $_GET['ancho'] ?>&largo=<?php echo $_GET['largo'] ?>&calibre=<?php echo $_GET['calibre'] ?>">Solapa</a></td>
                <td nowrap="nowrap" id="titulo4">Bolsillo</td>
                <td nowrap="nowrap" id="titulo4"><a href="referencia_precio2.php?orden=<?php echo "N_calibre";?>&cod_ref=<?php echo $_GET['cod_ref'] ?>&bolsa=<?php echo $_GET['bolsa'] ?>&id_c=<?php echo $_GET['id_c'] ?>&tipo_ref=<?php echo $_GET['tipo_ref'] ?>&solapa=<?php echo $_GET['solapa'] ?>&ancho=<?php echo $_GET['ancho'] ?>&largo=<?php echo $_GET['largo'] ?>&calibre=<?php echo $_GET['calibre'] ?>">Calibre</a></td>
...
<td id="talla1">
  <a href="control_tablas.php?n_cotiz=<?php echo $row_cotizacion['N_cotizacion']; ?>&amp;cod_ref=<?php echo $row_cotizacion['N_referencia_c']; ?>&Str_nit=<?php echo $row_cotizacion['Str_nit']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "7"; ?>" target="new" style="text-decoration:none; color:#000000">
 <?php 
...
$sqltipob="SELECT tipo_bolsa_ref FROM Tbl_referencia WHERE CONVERT(cod_ref, SIGNED INTEGER) ='$ref'"; 
...
*/
   echo $tipo_bolsa=$row_cotizacion['tipo_bolsa'];
?></td>
