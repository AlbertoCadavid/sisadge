...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO TblCertificacion (idcc, idc, op, idref, codref, versref, oc, refCliente, factura, anchvaloptenido, largvaloptenido, solvaloptenido, fuellvaloptenido, calvaloptenido, tenstdvaloptenido, tensmdvaloptenido, elongtdvaloptenido, elongmdvaloptenido, factortdvaloptenido, factormdvaloptenido, coefdimccval, coefdimddval, coefestccval, coefestddval, impatdval, tensionsval, tempeselleval, referencia, lotenum, ensayonum, aparcump, evidfriocump, evidcalorcump, evidsolvcumple, evidtambcumple, pigmcump, colortoncump, textcump, codigbarcump, observ, estado, fecha, fechamodifico, instrumentista, modifico, jefeplanta) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "certificacion_vista.php?idcc=" . $_POST['idcc'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion1, $conexion1);
$query_ultimo = "SELECT idcc FROM TblCertificacion ORDER BY idcc DESC";
...
$colname_opref = "-1";
if (isset($_GET['id_ref'])) {
  $colname_opref = (get_magic_quotes_gpc()) ? $_GET['id_ref'] : addslashes($_GET['id_ref']);
}
$colname_idc = "-1";
if (isset($_GET['idc'])) {
...
<tr><td id="nombreusuario"><?php echo $row_usuario['nombre_usuario']; ?></td>
  ...
  <tr>
    <td colspan="2" align="center" id="linea1">
      <form method="POST" name="form1" action="<?php echo $editFormAction; ?>" onSubmit="return validacion_select_oc()">
        <table id="tabla2">
        <tr id="tr1">
              <td colspan="2" id="codigo">CODIGO: R4-F15</td>
              <td colspan="3" id="titulo2">CERTIFICADO DE CALIDAD
                <input name="idcc" type="hidden" value="<?php $num=$row_ultimo['idcc']+1; echo $num; ?>"></td>
              <td colspan="2" id="codigo">VERSION: 2 </td>
            </tr>
            <tr>
              <td colspan="1" rowspan="4" id="dato2"><img src="images/logoacyc.jpg" /></td>
              <td colspan="3" id="subtitulo">
                <input name="idref" type="hidden" value="<?php echo $row_referencia['id_ref']; ?>">
                CERT N° <input name="codref" type="text" value="<?php echo $row_referencia['cod_ref']; ?>" size="6" readonly></td>
              <td colspan="3" id="dato2"><img src="images/ciclo1.gif" style="cursor:hand;" alt="RESTAURAR" title="RESTAURAR" onClick="window.history.go()"><a href="ficha_tecnica.php"><img src="images/f.gif" alt="FICHAS TECNICAS" title="FICHAS TECNICAS" border="0" style="cursor:hand;"/></a><a href="referencias.php"><img src="images/a.gif" alt="REF'S ACTIVAS" title="REF'S ACTIVAS" border="0" style="cursor:hand;"/></a><a href="referencias_inactivas.php"><img src="images/i.gif" alt="REF'S INACTIVAS" title="REF'S INACTIVAS" border="0" style="cursor:hand;"/></a></td>
            </tr>
            <tr>
            ...
            <tr>
              <td id="dato1"><input type="date" name="fecha" value="<?php echo date("Y-m-d"); ?>" size="10"></td>
              <td colspan="5" id="dato1"><input name="instrumentista" type="text" id="instrumentista" value="<?php echo $row_usuario['nombre_usuario']; ?>" size="30" readonly></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="6" id="fuente1"><select  name="idc" id="cliente" style="width:200px" onChange="if(form1.idc.value) { consulta_certificacion_cl(); } else{ alert('Debe Seleccionar una CLIENTE'); }">
                <option value=""<?php if (!(strcmp("", $_GET['idc']))) {echo "selected=\"selected\"";} ?>></option>
                <?php
do {  
?>
                <option value="<?php echo $row_clientes['id_c']?>"<?php if (!(strcmp($row_clientes['id_c'], $_GET['idc']))) {echo "selected=\"selected\"";} ?>><?php echo $row_clientes['nombre_c'];?> </option>
                <?php
...
?>
            ...
            <tr>
              ...
              <td id="fuente1"><select name="op" id="op" onChange="if(form1.op.value) { consulta_certificacion_op(); } else{ alert('Debe Seleccionar una O.P'); }">
                <option value=""<?php if (!(strcmp("", $_GET['op']))) {echo "selected=\"selected\"";} ?>></option>
                <?php
do {  
?>
                <option value="<?php echo $row_opref['id_op']?>"<?php if (!(strcmp($row_opref['id_op'], $_GET['op']))) {echo "selected=\"selected\"";} ?>><?php echo $row_opref['id_op']?></option>
                <?php
...
?>
              ...
              <td id="fuente1"><strong><?php echo $row_referencia['cod_ref'];?>-<?php echo $row_referencia['version_ref']; ?>
                  <input type="hidden" name="versref" value="<?php echo $row_referencia['version_ref']; ?>" size="32">
              </strong></td>
              <td id="fuente1">REF-CLIENTE</td>
              <td id="fuente1"><input name="refCliente" type="text" id="refCliente" placeholder="Ref-Cliente" style="width:60px" onBlur="conMayusculas(this)"></td>
              </tr>
            <tr>
              <td id="fuente1">ORDEN DE COMPRA</td>
              <td id="fuente1"><input type="hidden" name="oc" size="50" value="<?php echo $row_ordencompra['str_numero_oc_op']; ?>"><?php echo $row_ordencompra['str_numero_oc_op']; ?></td>
              ...
              <td id="fuente1"><input name="factura" type="number" id="factura" placeholder="0" style="width:60px" min="0" step="1"></td>
            </tr>
            <tr id="tr1">
            ...
            <tr>
              ...
              <td id="fuente1"><?php echo $ancho-10; ?></td>
              <td id="fuente2"><input name="anchvaloptenido" type="number" id="anchvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            ...
            <tr>
              ...
              <td id="fuente1"><?php echo $largo-10; ?></td>
              <td id="fuente2"><input name="largvaloptenido" type="number" id="largvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
              <td id="fuente1">Interno</td>
              <td id="fuente1">mm</td>
            </tr>
            ...
            <tr>
              ...
              <td id="fuente1"><?php echo $solapa-10; ?></td>
              <td id="fuente2"><input name="solvaloptenido" type="number" id="solvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
              <td id="fuente1">Interno</td>
              <td id="fuente1">mm</td>
            </tr>
            <tr>
              ...
              <td id="fuente1">&nbsp;</td>
              <td id="fuente1">&nbsp;</td>
              <td id="fuente2"><input name="fuellvaloptenido" type="number" id="fuellvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
              <td id="fuente1">Interno</td>
              <td id="fuente1">mm</td>
            </tr>
            <?php }?>
            <tr>
              ...
              <td id="fuente2"><input name="calvaloptenido" type="number" id="calvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
          ...
          <tr>
            ...
            <td colspan="2" id="detalle2">&ge;
              <?php echo $row_ficha_tecnica['PtensionTd_ft']; ?></td>
            <td colspan="2" id="detalle2"><input name="tenstdvaloptenido" type="number" id="tenstdvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
          ...
          <tr>
            ...
            <td colspan="2" id="detalle2">&ge;
             <?php echo $row_ficha_tecnica['PtensionMd_ft'];?></td>
            <td colspan="2" id="detalle2"><input name="tensmdvaloptenido" type="number" id="tensmdvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            <td id="detalle1">ASTM D-882-02</td>
            <td id="detalle2">Newton</td>
          </tr>
          <tr>
            ...
            <td colspan="2" id="detalle2">&ge;
             <?php echo $row_ficha_tecnica['elongTd_ft'];?></td>
            <td colspan="2" id="detalle2"><input name="elongtdvaloptenido" type="number" id="elongtdvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            <td id="detalle1">ASTM D-882-02</td>
            <td id="detalle2">%</td>
          </tr>
          <tr>
            ...
            <td colspan="2" id="detalle2">&ge;
              <?php echo $row_ficha_tecnica['elongMd_ft'];?></td>
            <td colspan="2" id="detalle2"><input name="elongmdvaloptenido" type="number" id="elongmdvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            <td id="detalle1">ASTM D-882-02</td>
            <td id="detalle2">%</td>
          </tr>
          <tr>
            ...
            <td colspan="2" id="detalle2">&ge;
              <?php echo $row_ficha_tecnica['FrompTd_ft'];?></td>
            <td colspan="2" id="detalle2"><input name="factortdvaloptenido" type="number" id="factortdvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            <td id="detalle1">ASTM D-882-02</td>
          ...
          <tr>
            ...
            <td colspan="2" id="detalle2">&ge;
              <?php echo $row_ficha_tecnica['FrompMd_ft'];?></td>
            <td colspan="2" id="detalle2"><input name="factormdvaloptenido" type="number" id="factormdvaloptenido" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            <td id="detalle1">ASTM D-882-02</td>
            <td id="detalle2">Mpa</td>
          </tr>
          <tr>
            ...
            <td colspan="2" id="detalle2"><input name="coefdimccval" type="number" id="coefdimccval" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
           ...
           <tr>
             ...
             <td colspan="2" id="detalle2"><input name="coefdimddval" type="number" id="coefdimddval" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
             <td id="detalle1">ASTM 1894</td>
             <td id="detalle2">N.A.</td>
           </tr>
          <tr>
            ...
            <td colspan="2" id="detalle2"><input name="coefestccval" type="number" id="coefestccval" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            <td id="detalle1">ASTM 1894</td>
            <td id="detalle2">N.A.</td>
          </tr>
          <tr>
            ...
            <td colspan="2" id="detalle2"><input name="coefestddval" type="number" id="coefestddval" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            <td id="detalle1">ASTM 1894</td>
            <td id="detalle2">N.A.</td>
          </tr>
          <tr>
            ...
            <td colspan="2" id="detalle2">&ge;
              <?php echo $row_ficha_tecnica['ImpacDardo_ft'];?></td>
            <td colspan="2" id="detalle2"><input name="impatdval" type="number" id="impatdval" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            ...
            <td colspan="2" id="detalle2"><input name="tensionsval" type="number" id="tensionsval" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
           ...
           <?php if($row_referencia['tipo_bolsa_ref']=='LAMINA'){ ?><tr>
            ...
            <td colspan="2" id="detalle2"><input name="tempeselleval" type="number" id="tempeselleval" placeholder="0,00" style="width:60px" min="0.00" step="0.01"></td>
            ...
            <!-- <tr>
              ...
              <td id="detalle1"><input type="text" name="referencia" value="" size="5" onBlur="conMayusculas(this)" ></td>
              <td id="detalle1">LOTE N&deg;</td>
              <td colspan="2" id="detalle1"><input type="text" name="lotenum" value="" size="5" onBlur="conMayusculas(this)"></td>
              <td id="detalle1">ENSAYO N&deg;</td>
              <td id="detalle1"><input type="text" name="ensayonum" value="" size="5" onBlur="conMayusculas(this)"></td>
            </tr> -->
            <tr id="tr1">
            ...
            <tr>
              ...
              <td id="detalle1"><input type="radio" name="aparcump" value="1" id="aparcump_1"></td>
              <td colspan="2" id="detalle1"><input type="radio" name="aparcump" value="0" id="aparcump_0">
            ...
            <tr>
              ...
              <td id="detalle1">
                <input type="radio" name="evidfriocump" value="1" id="evidfriocump_1">
                 </td>
              <td colspan="2" id="detalle1"><input type="radio" name="evidfriocump" value="0" id="evidfriocump_0">
            ...
            <tr>
              ...
              <td id="detalle1">
                <input type="radio" name="evidcalorcump" value="1" id="evidcalorcump_1">
               </td>
              <td colspan="2" id="detalle1"><input type="radio" name="evidcalorcump" value="0" id="evidcalorcump_0">
            ...
            <tr>
              ...
              <td id="detalle1">
                <input type="radio" name="evidsolvcumple" value="1" id="evidsolvcumple_1">
                </td>
              <td colspan="2" id="detalle1"><input type="radio" name="evidsolvcumple" value="0" id="evidsolvcumple_0">
            ...
            <tr>
              ...
              <td id="detalle1">
                <input type="radio" name="evidtambcumple" value="1" id="evidtambcumple_1">
               </td>
              <td colspan="2" id="detalle1"><input type="radio" name="evidtambcumple" value="0" id="evidtambcumple_0">
           ...
           <tr id="tr1">
             ...
             <tr id="tr1">
              <td colspan="2" id="detalle2">PARAMETROS</td>
              <td id="detalle2">CUMPLE    <!--<input type="reset" value="Limpiar">--></td>
              <td colspan="2" id="detalle2">NO CUMPLE</td>
              <td id="detalle2">METODO DE ENSAYO</td>
              <td id="detalle2">UNIDADES</td>
            </tr>
            <tr>
              ...
              <td id="detalle1">
                  <input type="radio" name="pigmcump" value="1" id="pigmcump_1">
                  </td>
              <td colspan="2" id="detalle1"><input type="radio" name="pigmcump" value="0" id="pigmcump_0"> <a href="javascript:limpiar('pigmcump',0)">limpiar</a></td>
              <td id="detalle1">Interno</td>
              <td id="detalle1">N.A.</td>
            </tr>
            <tr>
              ...
              <td id="detalle1">
                  <input type="radio" name="colortoncump" value="1" id="colortoncump_1"></td>
              <td colspan="2" id="detalle1"><input type="radio" name="colortoncump" value="0" id="colortoncump_0">
            ...
            <tr>
              ...
              <td id="detalle1">
                  <input type="radio" name="textcump" value="1" id="textcump_1">
                  </td>
              <td colspan="2" id="detalle1"><input type="radio" name="textcump" value="0" id="textcump_0">
            ...
            <tr>
              ...
              <td id="detalle1">
                  <input type="radio" name="codigbarcump" value="1" id="codigbarcump_1">
                </td>
              <td colspan="2" id="detalle1"><input type="radio" name="codigbarcump" value="0" id="codigbarcump_0">
            ...
            <tr>
              ...
              <table border="0" id="tabla1" >
                ...
                <tr>
                  ...
                  <td><input name="jefeplanta" type="text" id="jefeplanta" value="Alvaro Cadavid" size="30"></td>
                </tr>
              </table></td>
            </tr>
            <tr id="tr1">
