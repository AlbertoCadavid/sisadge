          ...
          <table class="table table-bordered table-sm">
            ...
            <tr>
              <td colspan="3" id="justificacion">Segun <strong>ANEXO 4. METODOLOGIA DE EVALUACION DE DESEMPENO DE PROVEEDORES</strong><br>
                ...
                El proveedor de insumos criticos como tintas, aditivos, teflen, entre otros se verifica en el momento de recepcien la cantidad (contenido) y apariencia del material dejando evidencia (visto bueno) en el documento del proveedor y/o en la orden de compra interna. Los resultados de las verificaciones realizadas se registran en el formato A3-F05 Evaluacion de DesempeNo del Proveedor teniendo en cuenta las variables de control establecidas para ponderar anualmente su desempeNo. Para los insumos se han definido cuatro variables de control y su aceptacion como son:<br><br><strong>1. Oportunidad (20%)</strong>: Donde se valida el cumplimiento en la entrega, donde debe ser antes o igual a la fecha de compromiso.<br><strong>2. Cumplimiento en Cantidad (25%)</strong>: Donde se valida que la cantidad recibida sea por lo menos el 90% de los solicitado.<br><strong>3. Calidad (40%)</strong>: Se valida el cumplimiento de la verificacion realizada en el formato A3-F08 Verificacion (INSUMOS CRITICOS) recibidos de acuerdo a los parametros cualitativos y cuantitativos establecidos.<br><strong>4. Servicio (15%)</strong>: Se califica de a 1 a 10 validando la atencion durante la prestacion del servicio desde el momento en que se pacta la compra hasta la recepcion, como son la atencion a inquietudes, quejas, reclamos, sugerencias y amabilidad.<br><br><strong>B. EVALUACION DE DESEMPENO DEL PROVEEDOR DE SERVICIOS CRITICOS</strong>. <br><br>Cuando se solicita la prestacion del servicio, despues de su ejecucion se validan estas variables:<br><br><strong>1. Oportunidad (25%)</strong>: Verificando el cumplimiento en tiempo de la prestacion del servicio, el cual debe ser igual a la fecha de compromiso.<br><strong>2. Calidad (40%)</strong>: Se valida el cumplimiento de la prestacion del servicio en cuanto al correcto desempeNo para lo cual fue contratado, Ej: Eficacia del trabajo realizado en proveedores de mantenimiento, recepcion y transporte de productos en proveedores de transporte y Cias, etc.<br><strong>3. Servicio (35%)</strong>: Se califica de 1 a 10, validando la atencion durante la prestacion del servicio hasta la verificacion del cumplimiento del trabajo realizado. Tambien se tiene en cuenta la atencion a inquietudes, quejas, reclamos, sugerencias y amabilidad en la prestacion del servicio.<br><br>Para la evaluacion de la calidad en la prestacion del servicio de transporte se tiene en cuenta la disponibilidad y amabilidad del personal que recoge la mercancia (estado en que llegue la mercancia al destino final en caso que sea reportado).
              </td>
            </tr>
          </table>
        <?php } ?>
