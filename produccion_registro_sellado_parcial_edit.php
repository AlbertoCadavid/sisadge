...
WHERE a.tipo_empleado IN(7,9) AND b.fecha BETWEEN DATE_FORMAT('$FECHA_NOVEDAD_SELL', '%Y-%m-01') AND DATE_FORMAT('$FECHA_NOVEDAD_SELL', '%Y-%m-31')"; //IN(5,10)novedad impresion 
  ...
  if ((isset($_POST['rolloParcial_r'])) && ($_POST['rolloParcial_r'] == "2")) {
    $updateSQL3 = sprintf(
      "UPDATE TblSelladoRollo SET rolloParcial_r='0' WHERE id_op_r=%s",
      GetSQLValueString($_POST['id_op_rp'], "int")
    );
    mysql_select_db($database_conexion1, $conexion1);
      ...
      <input name="valor_prep_rt" id="valor_prep_rt" type="hidden" size="5" value="0"/>-->
              ...
              <td id="fuente1">
                <select name="str_maquina_rp" id="maquina" style="width:155px">
                  <option value="" <?php if (!(strcmp("", $row_rollo_sellado_edit['maquina_r']))) {
                                      echo "selected=\"selected\"";
                                    } ?>>Maquina</option>
                  <?php
                  do {
                  ?>
                    <option value="<?php echo $row_maquinas['id_maquina'] ?>" <?php if (!(strcmp($row_maquinas['id_maquina'], $row_rollo_sellado_edit['maquina_r']))) {
                                                                                echo "selected=\"selected\"";
              ...
              <td id="fuente1">
                <select class="form-control" name="int_cod_empleado_rp" id="operario" style="width:145px">
                  <option value="" <?php if (!(strcmp("", $row_rollo_sellado_edit['cod_empleado_r']))) {
                                      echo "selected=\"selected\"";
                                    } ?>>Operario</option>
                  <?php foreach ($row_codigo_empleado as $row_codigo_empleado) { ?>
                    <option value="<?php echo $row_codigo_empleado['codigo_empleado'] ?>" <?php if (!(strcmp($row_codigo_empleado['codigo_empleado'], $row_rollo_sellado_edit['cod_empleado_r']))) {
                                                                                            echo "selected=\"selected\"";
              ...
              <td id="fuente1">
                ...
                <select class="form-control" name="int_cod_liquida_rp" id="auxiliar" style="width:145px">
                  <option value="" <?php if (!(strcmp("", $row_rollo_sellado_edit['cod_auxiliar_r']))) {
                                      echo "selected=\"selected\"";
                                    } ?>>Revisor</option>
                  <?php foreach ($row_revisor as $row_revisor) { ?>
                    <option value="<?php echo $row_revisor['codigo_empleado'] ?>" <?php if (!(strcmp($row_revisor['codigo_empleado'], $row_rollo_sellado_edit['cod_auxiliar_r']))) {
                                                                                    echo "selected=\"selected\"";
            ...
            <tr>
              ...
              <td colspan="2" id="fuente1">
                <input name="fecha_ini_rp" id="fecha_ini_rp" onkeydown="restakilosT();" onchange="restakilosT();alerta_sell();" type="datetime-local" min="2000-01-02" value="<?php echo muestradatelocal($row_rollo_sellado_edit['fechaI_r']); ?>" size="15" required onclick="restakilosT();" />
            ...
            <tr id="tr1">
              ...
              <td colspan="2" id="fuente1"><input name="fecha_fin_rp" id="fecha_fin_rp" type="datetime-local" min="2000-01-02" size="15" required onKeydown="restakilosT();" onChange="restakilosT()" value="<?php echo muestradatelocal($row_rollo_sellado_edit['fechaF_r']); //muestradatelocal
                                                                                                                                                                                                              ?>" /></td>
              <td id="fuente1">
                <p>Metro Restante</p>
                <p>
            ...
            <tr>
              ...
              <td colspan="3" id="fuente1">
                ...
                Tiempo Optimo
                <input name="rodamiento_rp" id="tiempoOptimo_rp" type="text" size="5" onclick="restakilosT();" required="required" placeholder="rodamientos" value="" readonly="readonly" /><!--kilosxHora2()-->
              </td>
            </tr>
            <tr id="tr1">
              <td id="fuente1">Numeracion Inicial</td>
              <td colspan="2" id="fuente1">
                <input type="hidden" name="numInicioControl" id="numInicioControl" value="<?php $numIni = $row_rollo_sellado_edit['numIni_r'] == '' ? $row_rollo_sellado_edit['n_fin_rp'] : $row_rollo_sellado_edit['numIni_r'];
                                                                                          echo $numIni; ?>" />
            ...
            <tr>
              ...
              <td colspan="2" id="fuente1">
                <input name="acumulado" id="acumulado" type="hidden" value="<?php if ($row_despacumula['despacumula'] == '') {
                                                                              echo $acuml = "0";
                                                                            } else {
                                                                              echo $acuml = $row_despacumula['despacumula'];
                                                                            } ?>" />

                <input type="text" name="int_kilos_desp_rp" id="int_kilos_desp_rp" min="0" step="any" required="required" size="7" placeholder="Desp.oper" value="<?php if ($row_total_desperdicio['desperdicio'] == '') {
                                                                                                                                                                    echo "0";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $row_total_desperdicio['desperdicio'];
                                                                                                                                                                  } ?>" readonly="readonly" />
            ...
            <tr>
              ...
              <td id="dato3"><!-- <input type="button" name="ENVIAR" id="ENVIAR" value="EDITAR PARCIAL" onclick="parcial();" /> -->
                <input type="button" class="botonGeneral" name="ENVIAR" value="EDITAR PARCIAL" onclick="parcial();validaTodoSell()" />
              </td>
            </tr>
            <tr>
              <td colspan="7">
              ...
              <?php for ($s = 0; $s <= $totalRows_standBy - 1; $s++) { ?>
                <tr>
                  ...
                  <td id="fuente1"><!--ELIMINAR ESTA FUNCION eliminar_rts-->
                    <a href="javascript:eliminar_rts('id_rtsp',<?php $delrt = mysql_result($standBy, $k, id_rt);
                                                                echo $delrt; ?>,'id_rsp',<?php echo $row_rollo_sellado_edit['id_r']; ?>,'produccion_registro_sellado_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a>
                  </td>
                </tr>
              <?php } ?>
              <tr>
            ...
            <?php if ($row_tiempoMuerto['id_rpt_rt'] != '') { ?>
              ...
              <?php for ($k = 0; $k <= $totalRows_tiempoMuerto - 1; $k++) { ?>
                <tr>
                  ...
                  <td id="fuente1"><a href="javascript:eliminar_varias('id_rtsp',<?php $delrt = mysql_result($tiempoMuerto, $k, id_rt);
                                                                                  echo $delrt; ?>,'id_rsp',<?php echo $row_rollo_sellado_edit['id_r']; ?>,'produccion_registro_sellado_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a></td>
                </tr>
              <?php } ?>
              <tr>
              ...
              <?php for ($x = 0; $x <= $totalRows_tiempoPreparacion - 1; $x++) { ?>
                <tr>
                  ...
                  <td id="fuente1" colspan="2"><?php $id2 = mysql_result($tiempoPreparacion, $x, id_rpt_rtp);
                    ...
                    <!--<input name="id_rtp[]" type="hidden" id="id_rtp[]" value="<?php echo $id2; ?>" size="6"/>-->
                  </td>
                  <td id="fuente1"><?php $var2 = mysql_result($tiempoPreparacion, $x, preparacion);
                                    echo $var2;
                                    $totalTP += $var2; ?></td>
                  <td id="fuente1"><a href="javascript:eliminar_varias('id_rpsp',<?php $delrp = mysql_result($tiempoPreparacion, $x, id_rt);
                                                                                  echo $delrp; ?>,'id_rsp',<?php echo $row_rollo_sellado_edit['id_r']; ?>,'produccion_registro_sellado_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a>
                  </td>
                </tr>
              <?php } ?>
              <tr>
              ...
              <?php for ($i = 0; $i <= $totalRows_desperdicio - 1; $i++) { ?>
                <tr>
                  ...
                  <td id="fuente1"><?php $var3 = mysql_result($desperdicio, $i, desperdicio);
                                    echo $var3;
                                    $totalTD += $var3; ?></td>
                  <td id="fuente1"><a href="javascript:eliminar_varias('id_rdsp',<?php $delrd = mysql_result($desperdicio, $i, id_rd);
                                                                                  echo $delrd; ?>,'id_rsp',<?php echo $row_rollo_sellado_edit['id_r']; ?>,'produccion_registro_sellado_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a></td>
                </tr>
              <?php } ?>
              <tr>
              ...
              <?php for ($y = 0; $y <= $totalRows_producido - 1; $y++) { ?>
                <tr>
                  ...
                  <td id="fuente1"><?php $var4 = mysql_result($producido, $y, producido);
                                    echo $var4;
                                    $totalMM += $var4; ?></td>
                  <td id="fuente1"><a href="javascript:eliminar_rts('id_ipsp',<?php $delip = mysql_result($producido, $y, id_rkp);
                                                                              echo $delip; ?>,'id_rsp',<?php echo $row_rollo_sellado_edit['id_r']; ?>,'produccion_registro_sellado_edit.php')"><img src="images/por.gif" style="cursor:hand;" alt="ELIMINAR " title="ELIMINAR" border="0" /></a></td>
                </tr>
              <?php } ?>
              <tr>
