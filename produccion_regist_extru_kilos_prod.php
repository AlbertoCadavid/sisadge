...
<body>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1">
    <table class="table table-bordered table-sm">
      ...
      <tr>
        <td nowrap="nowrap" colspan="10" id="dato1" style="color:red;">Al guardar las materias primas asegurese de haber seleccionado el ultimo rollo en la liquidación, de lo contrario las materias primas quedaran divididas con distintas fechas, a menos que sea un Rollo Parcial</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="fuente1"><?php
                          ...
                          if ($numm >= '1') {
                            $nombreMezcla = mysql_result($resultm, 0, 'descripcion_insumo');
                            echo $nombreMezcla;
                          } else {
                            echo "";
                          }
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref1_tol1_porc1_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref2_tol1_porc2_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref3_tol1_porc3_pm']);
                          echo $kilosaprox; ?></td>
      </tr>
      <tr id="tr1">
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref1_tol2_porc1_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref2_tol2_porc2_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref3_tol2_porc3_pm']);
                          echo $kilosaprox; ?></td>
      </tr>
      <tr>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref1_tol3_porc1_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref2_tol3_porc2_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref3_tol3_porc3_pm']);
                          echo $kilosaprox; ?></td>
      </tr>
      <tr id="tr1">
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref1_tol4_porc1_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref2_tol4_porc2_pm']);
                          echo $kilosaprox; ?></td>
        ...
        <td id="fuente1"><?php $kilosaprox = sacar_porcentaje($row_orden_produccion['int_kilos_op'], $row_materiap['int_ref3_tol4_porc3_pm']);
                          echo $kilosaprox; ?></td>
      </tr>
      <tr>
        <td colspan="10" id="dato1">&nbsp;
      ...
      <tr>
        <td colspan="10" nowrap="nowrap" id="dato1">
          <p><strong>Nota:</strong> Los kilo aprox. son los kilos aproximados que se deben utilizar segun </p>
          <p>la cantidad requerida en la orden de produccion * el % de la mezcla .</p>
        </td>
      </tr>
      <tr>
