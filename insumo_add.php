...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf(
    "INSERT INTO insumo (id_insumo, codigo_insumo, descripcion_insumo, clase_insumo, medida_insumo, tipo_insumo, valor_unitario_insumo, stok_insumo,quimicos) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertSQL2 = sprintf(
    "INSERT INTO TblProveedorInsumo (id_p,id_in) VALUES (%s, %s)",
                  ...
                  <td colspan="2" align="center" id="linea1">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onSubmit="MM_validateForm('id_p','','R');return document.MM_returnValue">
                      <table id="tabla2">
                        ...
                        <tr>
                          <td id="fuente1"><input type="number" min="1" step="1" style="width:120px" name="codigo_insumo" value="<?php echo $row_ultimo['codigo_insumo'] + 1; ?>" required></td>
                        </tr>
                        <tr>
                          <td id="fuente1">TIPO DE INSUMO </td>
                        </tr>
                        <tr>
                          <td id="fuente1"><select name="tipo_insumo" id="tipo_insumo" style="width:120px">
                              <?php
                              do {
                              ?>
                        ...
                        <tr>
                          <td id="dato1">
                            <select name="clase_insumo" id="clase_insumo" style="width:240px">
                          ...
                          <td>
                            <a href="javascript:verFoto('indices_insumos.php','900','700')">
                              <img src="images/6.png" alt="CONF CLASE DE INSUMO" title="CONF CLASE DE INSUMOS" border="0" style="cursor:hand;" />
                            </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td id="dato3">
                            <select class="form-control" style="width:50px;" name="indice_insumo" id="indice_insumo"></select>
                          </td>
                        ...
                        <tr>
                        <td id="fuente1"></td>
                        <td id="dato1"><select name="medida_insumo" id="medida_insumo" style="width:120px">
                              <?php do { ?>
                        ...
                        <tr>
                        <td id="fuente1"></td>
                        <td id="dato1"><input type="text" name="valor_unitario_insumo" value="" required style="width:120px"></td>
                        </tr>
                        <tr>
                          <td id="fuente1"></td>
                        ...
                        <tr>
                          <td id="fuente1"></td>
                          <td id="dato1"><input type="number" name="stok_insumo" id="stok_insumo" min="0" step="any" required value="" style=" width:120px" /></td>
                        </tr>
                        <tr>
                          <td id="fuente1"></td>
                        ...
                        <tr>
                          ...
                          <td colspan="2" id="fuente4">
                            <select name="id_p" id="id_p" style="width:240px">
...
<script>
  $('#clase_insumo').change(function() {
    let id_insumo = $('#clase_insumo').val()
    ...
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        document.querySelector("#indice_insumo").innerHTML = ""; //Borra todo lo que tenga el select

        if (data != 0) {
          object = JSON.parse(data);
          object.forEach((element) => {
            $("#indice_insumo").append(
              $("<option>", {
    ...
    if(id_insumo == 8){ //Impresion(materia prima)
