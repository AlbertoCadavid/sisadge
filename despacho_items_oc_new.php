  ...
  <?php echo $conexion->header('vistas'); ?>
           <table align="center" id="tabla"><tr align="center"><td>    
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <td id="numero2">N&deg;
                        <input name="int_remision" type="text"size="15"class="rojo_inteso" value="<?php echo $numeroRemision == '' ? $row_remision['int_remision']+1 : $numeroRemision; ?>" readonly/></td>
                      ...
                      <tr>
                        <td colspan="2" id="dato1">ORDEN DE COMPRA N&deg : <b> <?php echo $row_orden_compra['str_numero_oc']; ?></b></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="3" id="detalle2">
                          ...
                          <?php if(!$numeroRemision): ?>

                          <tr id="imprime" >
                            <td colspan="4" id="dato2">
                            <input type="button" class="botonGigante" onclick="imprimeMuestra()" name="idGuardar" id="idGuardar" value="IMPRIMIR PARA VISUALIZAR ITEMS"/> 
                            </td> 
                          </tr>
                          ...
                          <tr id="tr2" style="display:none;" >
                            <td colspan="4" id="dato2">
                              ...
                              <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF"> 
                                <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_consecutivo_io']; ?></a></td>
                                <td id="talla1"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_cod_ref_io']; ?></a></td>
                                
                                <td id="talla1"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000">
                                  ...
                                  if($mp!='')
                                  {
                                    ...
                                    <td id="talla3"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_cod_cliente_io']; ?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_cantidad_io']; ?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php if($row_items['int_cantidad_rest_io']==''){echo '0';}else{echo $row_items['int_cantidad_rest_io'];} ?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['str_unidad_io']; ?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['fecha_entrega_io']; ?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_precio_io']; ?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_total_item_io'];$total=$subtotal+$row_items['int_total_item_io'];?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['str_moneda_io']; ?></a></td>
                                    <td id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php $dd = htmlentities($row_items['str_direccion_desp_io']);echo $dd; ?></a></td>
                                    <td nowrap="nowrap" id="talla2"><a href="javascript:verPopUp('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']+1; ?>','900','400')" target="_top" style="text-decoration:none; color:#000000"><?php if($row_items['b_estado_io']=='5'){echo "Facturado Total";}else if($row_items['b_estado_io']=='4'){echo "Facturado Parcial";}else if($row_items['b_estado_io']=='1'){echo "Ingresado";}else if($row_items['b_estado_io']=='2'){echo "Programado";}else if($row_items['b_estado_io']=='3'){echo "Remisionado";}else if($row_items['b_estado_io']=='6'){echo "Muestras reposicion";}  ?></a>
                                    </td>
                                    <td id="talla3">
                                      <?php 
...
//SI EL ITEM TIENE REMISIONES 
     ...
     $(document).ready(function(){
                        ...
                        var existe = '<?php echo $numeroRemision;?>';
                         if(existe){
                            $('#tr2').show();
                         }
       });                   
