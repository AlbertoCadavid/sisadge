...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO movi (Almacen, Clase, Nro_Voucher, Codigo, Cantidad) VALUES (%s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="Almacen" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Clase:</td>
      <td><input type="text" name="Clase" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Nro_Voucher:</td>
      <td><input type="text" name="Nro_Voucher" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
