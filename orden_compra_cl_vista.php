...
<body>
      ...
      <tr>
        <td align="center">
          ...
          <table id="tabla3">
            ...
            <tr>
              <td colspan="2" id="dato1"><strong>DIRECCION C: </strong><?php $dir = ($row_orden_compra['str_dir_entrega_oc']);
                                                                        echo $dir; ?></td>
            </tr>
            <tr>
              <td colspan="2" id="dato1"><strong>DIRECCION ENVIO FACTURA: </strong><?php $dir = ($row_cliente_oc['direccion_envio_factura_c']);
                                                                                    echo $dir; ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td id="dato1"><strong>Adjuntar Comprobante: <?php echo $row_orden_compra['comprobante_ent']; ?></strong>
                <a class="editar" href="javascript:verFoto('Archivosdesp/<?php echo $row_remadjunto['comprobante_file']; ?>','610','490')">
                  <?php if ($row_remadjunto['comprobante_file'] != '') {
              ...
              <td colspan="2" id="dato1">
                ...
                <?php echo $row_orden_compra['cobra_flete'] == 1 ?  "SI" : 'NO'; ?> <?php if ($row_orden_compra['cobra_flete'] == 1) {
                                                                                      echo 'valor: '  . $row_orden_compra['precio_flete'];
                                                                                    } ?>
            ...
            <tr>
              <td colspan="20">
                <div class="alert alert-danger" id="verAlert" style="display: none;"></div>
              </td>
            </tr>
          </table>
            ...
            <table id="tabla3">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td id="fondo2"><?php if ($row_remision['int_cantidad_rest_io'] == '') {
                                    echo '0';
                                  } else {
                                    echo $row_remision['int_cantidad_rest_io'];
                                  } ?></td>
                  ...
                  <td id="fondo2"><?php echo $row_remision['N_precio_old'] //$row_remision['int_precio_io']; 
                                  ?></td>
                  <td id="fondo2"><?php echo $row_remision['impuesto'] == 1 ? 'SI' : 'NO'; ?></td>
                  <td id="fondo2"><?php echo $tota = ($row_remision['int_cantidad_io'] * $row_remision['N_precio_old']) //$row_detalle['int_total_item_io'];
                                  ?><?php  //$tota=$row_remision['int_total_item_io']; echo number_format($tota, 2, ",", ".");  
                                                                                                                                                          ?></td>
                  <td id="fondo1"><?php echo $row_remision['str_direccion_desp_io']; ?></td>
                  <td nowrap="nowrap" id="fondo3">
                    <?php if ($row_remision['b_estado_io'] == '1') {
                      echo "Ingresado";
                    } else if ($row_remision['b_estado_io'] == '5') {
                      echo "Facturado Total";
                    } else if ($row_remision['b_estado_io'] == '4') {
                      echo "Facturado parcial";
                    } else if ($row_remision['b_estado_io'] == '2') {
                      echo "Programado";
                    } else if ($row_remision['b_estado_io'] == '3') {
                      echo "Remisionado";
                    } ?>
                  </td>
                  ...
                  <td id="fondo2"><?php $cant = $row_remision['int_cant_rd'];
                                  echo number_format($cant, 0, ",", "."); ?></td>
                  <td id="fondo2"><?php echo $row_remision['int_peso_rd'];
                                  $peso = (float)$peso + $row_remision['int_peso_rd']; ?></td>
                  <td id="fondo2"><?php echo $row_remision['int_pesoneto_rd'];
                                  $peson = (float)$peson + $row_remision['int_pesoneto_rd']; ?></td>
                </tr>
                <tr>
                  <td id="detalle4">&nbsp;</td>
                  <td id="detalle4">&nbsp;</td>
                  ...
                  <td id="detalle4">&nbsp;</td>
                  <td nowrap="nowrap" id="fondo2">Sub Total $</td>
                  <td id="fondo2"><?php echo number_format($row_remision['int_cant_rd'], 0, ",", ".");
                                  $totalrm = $totalrm + $row_remision['int_cant_rd']; ?></td>
              ...
              <tr>
                ...
                <td colspan="4" id="fondo2">
                  <?php if ($row_orden_compra['b_estado_oc'] == '4' && $row_cliente_oc['str_condicion_pago_oc'] != "ANTICIPADO") {
                    echo "O.C Facturada Parcial";
                  } else if ($row_orden_compra['b_estado_oc'] == '5' && $row_cliente_oc['str_condicion_pago_oc'] != "ANTICIPADO") {
                    echo "O.C Facturada Total";
                  } else if ($row_orden_compra['b_estado_oc'] == '4' && $row_cliente_oc['str_condicion_pago_oc'] == "ANTICIPADO") {
                    echo "O.C Facturada Parcial Anticipado";
                  } else if ($row_orden_compra['b_estado_oc'] == '5' && $row_cliente_oc['str_condicion_pago_oc'] == "ANTICIPADO") {
                    echo "O.C Facturada Total Anticipado";
                  }; ?></td>
                <td id="nivel2">TOTALES</td>
            ...
            <table width="123%" id="tabla3">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td id="fondo2"><?php if ($row_detalle['int_cantidad_rest_io'] == '') {
                                    echo '0';
                                  } else {
                                    echo ($row_detalle['int_cantidad_rest_io']);
                                  } ?></td>
                  ...
                  <td id="fondo2"><?php $rem = ($row_detalle['int_cantidad_io'] - $row_detalle['int_cantidad_rest_io']);
                                  $remisionado = $rem * $row_detalle['N_precio_old'];
                                  echo number_format($remisionado, 2, ",", "."); ?></td>
  ...
  <td id="fondo2"><?php echo $row_detalle['int_comision_io']; ?></td>  -->
                  <td nowrap="nowrap" id="fondo2"><?php if ($row_detalle['b_estado_io'] == '1') {
                                                    echo "Ingresado";
                                                  } else if ($row_detalle['b_estado_io'] == '5') {
                                                    echo "Facturado Total";
                                                  } else if ($row_detalle['b_estado_io'] == '4') {
                                                    echo "Facturado Parcial";
                                                  } else if ($row_detalle['b_estado_io'] == '2') {
                                                    echo "Programado";
                                                  } else if ($row_detalle['b_estado_io'] == '3') {
                                                    echo "Remisionado";
                                                  } ?>
                  </td>
            ...
            <tr>
              ...
              <td id="fondo2"><strong>
                  <?php if ($row_orden_compra['b_factura_cirel_oc'] == '0') {
                    echo "NO";
                  } else {
                    echo "SI";
                  } ?>
              ...
              <td id="fondo2"><strong>
                  <?php if ($row_orden_compra['vta_web_oc'] == '0') {
                    echo "NO";
                  } else {
                    echo "SI";
                  } ?>
              ...
              <td id="fondo2"><strong>
                  <?php if ($row_orden_compra['expo_co'] == '0') {
                    echo "NO";
                  } else {
                    echo "SI";
                  } ?>
