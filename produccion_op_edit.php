...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  //if ($_POST["tipo_tras"] == ""){
  $updateSQL = sprintf(
    "UPDATE Tbl_orden_produccion SET fecha_registro_op=%s, fecha_entrega_op=%s, str_responsable_op=%s, str_numero_oc_op=%s, int_cod_ref_op=%s, id_ref_op=%s, version_ref_op=%s, int_cotiz_op=%s, str_entrega_op=%s, str_nit_op=%s, int_cliente_op=%s, int_desperdicio_op=%s, int_cantidad_op=%s, str_tipo_bolsa_op=%s, int_pesom_op=%s, str_matrial_op=%s, str_presentacion_op=%s, metroLineal_op=%s, int_kilos_op=%s, int_calibre_op=%s, int_ancho_rollo_op=%s, int_micras_op=%s, str_interno_op=%s, str_externo_op=%s, str_tratamiento_op=%s, int_undxcaja_op=%s, int_undxpaq_op=%s,undxpaqreal=%s, numInicio_op=%s, observ_extru_op=%s, maquina_imp_op=%s, 
  kls_req_imp_op=%s, mts_req_imp_op=%s, margen_izq_imp_op=%s, margen_anc_imp_op=%s, margen_anc_mm_imp_op=%s, margen_der_imp_op=%s, margen_peri_imp_op=%s, margen_per_mm_imp_op=%s, margen_z_imp_op=%s, observ_impre_op=%s, mts_cinta_sellado_op=%s, kls_sellado_op=%s, kls_sellado_bol_op=%s, und_prod_sellado_op=%s, observ_sellado_op=%s, b_estado_op=%s, b_visual_op=%s, id_termica_op=%s, cinta_termica_op=%s, numeracion_inicial=%s, imprimiop=%s, lote=%s , charfin=%s , coextrusion=%s, sinnumeracion=%s  WHERE id_op=%s",
  ...
  $updateSQL2 = sprintf(
    "UPDATE Tbl_numeracion SET int_bolsas_n=%s, int_undxpaq_n=%s, int_undxcaja_n=%s WHERE int_op_n=%s",
    GetSQLValueString($_POST['int_cantidad_op'], "double"),
    GetSQLValueString($_POST['int_undxpaq_op'], "int"),
    GetSQLValueString($_POST['int_undxcaja_op'], "int"),
              ...
              <div class="span8 offset2"> <!--span8 offset2   esto da el tamaño pequeño -->
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    <h2>ORDEN DE PRODUCCI&Oacute;N</h2>
                  </div>
                  ...
                  <div class="panel-body">
                    ...
                    <table id="tabla1">
                      ...
                      <tr>
                        <td id="nombreusuario"><?php echo $_SESSION['Usuario']; ?></td>
                        <td id="cabezamenu">
                      ...
                      <tr>
                        <td colspan="2" align="center">
                          <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return (metrosAkilos() && funcion() && validacion_tipocinta());">
                                ...
                                <td id="fuente1">
                                  <table id="tabla3">
                                    ...
                                    <tr id="tr3">
                                      ...
                                      <td nowrap="nowrap" id="numero1"><?php foreach ($row_orden as $row_orden) {
                                                                          $row_orden;
                                                                        } ?>
                                      ...
                                      <td colspan="3" id="fuente1"><input type="hidden" name="kilo_origen" id="kilo_origen" style="width:100px" value="" />
                                        <input type="number" name="kilo_destino" min="0" step="0.01" id="kilo_destino" value="" style="width:100px" onchange="trasladOp()" readonly="readonly" />
                                      </td>
                                    ...
                                    <tr>
                                      ...
                                      <td colspan="2" id="dato1">
                                        <input name="b_visual_op" id="b_visual_op" min="0" max="99" type="number" value="<?php echo $row_orden_produccion['b_visual_op']; ?>" style="width:40px" />

                                        <!-- <select name="b_visual_op" id="b_visual_op">
                                    ...
                                    <tr>
                                      ...
                                      <td nowrap="nowrap" id="talla1">EXTRUSION-</td>
                                    ...
                                    <tr>
                                      ...
                                      <td id="talla1">
                                        <select name="sinnumeracion" id="sinnumeracion">
                                          <option value="0" <?php if (!(strcmp("0", $row_orden_produccion['sinnumeracion']))) {
                                                              echo "selected=\"selected\"";
                                                            } ?>>NO</option>
                                          <option value="1" <?php if (!(strcmp("1", $row_orden_produccion['sinnumeracion']))) {
                                                              echo "selected=\"selected\"";
                                                            } ?>>SI</option>
                                        </select>
                                      </td>
                                    ...
                                    <tr id="tr1">
                                      <td colspan="12" id="fuente1"><textarea name="observ_extru_op" style="width: 100%" rows="3"><?php echo $row_orden_produccion['observ_extru_op'] ?></textarea></td>
                                    </tr>
                                    <tr id="tr1">
                                   ...
                                   <td colspan="12"> 
                                    ...
                                    <?php if ($row_cualexiste['id_ref_pm'] == '') : ?>
                                                  ...
                                                  <?php if ($totalRows_unidad_uno != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($y = 0; $y <= 5; $y++) { ?><!--for ($y=0;$y<=$totalRows_unidad_uno-1;$y++)// TRAE TODOS LOS REGISTROS-->
                                                        <tr>
                                                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_uno, $y, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="talla1"><?php $var = mysql_result($unidad_uno, $y, descripcion_insumo);
                                                                          echo $var; ?></td>
                                                          <td id="talla3"><?php $var1 = mysql_result($unidad_uno, $y, str_valor_pmi);
                                                                          echo $var1; ?></td>
                                                        </tr> <?php  } ?>
                                                    </table>
                                                  <?php  } ?>
                                                  ...
                                                  <?php if ($totalRows_unidad_dos != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($x = 0; $x <= 5; $x++) { ?><tr>
                                                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_dos, $x, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="talla1"><?php $var = mysql_result($unidad_dos, $x, descripcion_insumo);
                                                                          echo $var; ?></td>
                                                          <td id="talla3"><?php $var1 = mysql_result($unidad_dos, $x, str_valor_pmi);
                                                                          echo $var1; ?></td>
                                                        </tr> <?php  } ?>
                                                    </table>
                                                  <?php  } ?>
                                                  ...
                                                  <?php if ($totalRows_unidad_tres != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                                                          ...
                                                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_tres, $y, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="talla1"><?php $var = mysql_result($unidad_tres, $y, descripcion_insumo);
                                                                          echo $var; ?></td>
                                                          <td id="talla3"><?php $var1 = mysql_result($unidad_tres, $y, str_valor_pmi);
                                                                          echo $var1; ?></td>
                                                        </tr>
                                                      <?php  } ?>
                                                    </table>
                                                  ...
                                                  <?php if ($totalRows_unidad_cuatro != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                                                          ...
                                                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_cuatro, $y, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="fuente1"><?php $var = mysql_result($unidad_cuatro, $y, descripcion_insumo);
                                                                            echo $var; ?></td>
                                                          <td id="talla3"><?php $var = mysql_result($unidad_cuatro, $y, str_valor_pmi);
                                                                          echo $var; ?></td>
                                                        </tr>
                                                      <?php  } ?>
                                                    </table>
                                                  ...
                                                  <?php if ($totalRows_unidad_cinco != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                                                          ...
                                                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_cinco, $y, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="talla1"><?php $var = mysql_result($unidad_cinco, $y, descripcion_insumo);
                                                                          echo $var; ?></td>
                                                          <td id="talla3"><?php $var = mysql_result($unidad_cinco, $y, str_valor_pmi);
                                                                          echo $var; ?></td>
                                                        </tr>
                                                      <?php  } ?>
                                                    </table>
                                                  ...
                                                  <?php if ($totalRows_unidad_seis != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                                                          ...
                                                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_seis, $y, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="talla1"><?php $var = mysql_result($unidad_seis, $y, descripcion_insumo);
                                                                          echo $var; ?></td>
                                                          <td id="talla3"><?php $var = mysql_result($unidad_seis, $y, str_valor_pmi);
                                                                          echo $var; ?></td>
                                                        </tr>
                                                      <?php  } ?>
                                                    </table>
                                                  ...
                                                  <?php if ($totalRows_unidad_siete != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                                                          ...
                                                          <td nowrap id="talla1"><?php $id_m = mysql_result($unidad_siete, $y, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="talla1"><?php $var = mysql_result($unidad_siete, $y, descripcion_insumo);
                                                                          echo $var; ?></td>
                                                          <td id="talla3"><?php $var = mysql_result($unidad_siete, $y, str_valor_pmi);
                                                                          echo $var; ?></td>
                                                        </tr>
                                                      <?php  } ?>
                                                    </table>
                                                  ...
                                                  <?php if ($totalRows_unidad_ocho != '0') { ?>
                                                    <table>
                                                      ...
                                                      <?php for ($y = 0; $y <= 5; $y++) { ?><tr>
                                                          ...
                                                          <td nowrap id="fuente1"><?php $id_m = mysql_result($unidad_ocho, $y, str_nombre_m);
                                                                                  echo $id_m; ?></td>
                                                          <td id="fuente1"><?php $var = mysql_result($unidad_ocho, $y, descripcion_insumo);
                                                                            echo $var; ?></td>
                                                          <td id="fuente1"><?php $var = mysql_result($unidad_ocho, $y, str_valor_pmi);
                                                                            echo $var; ?></td>
                                                        </tr>
                                                      <?php  } ?>
                                                    </table>
                                      ...
                                      <tr>
                                        <?php for ($x = 0; $x <= $totalRows_caract_valor - 1; $x++) { ?>
                                          <td width="130" id="talla1"><?php $id_cv = mysql_result($caract_valor, $x, id_cv);
                                                                      $var = mysql_result($caract_valor, $x, str_nombre_caract_c);
                                                                      if ($var != '') {
                                                                        echo $var;
                                                                      } else {
                                                                        echo "MP eliminada";
                                                                      } ?>
                                            <?php $valor = mysql_result($caract_valor, $x, str_valor_cv);
                                            echo $valor; ?>
                                          </td>
                                        <?php  } ?>
                                      </tr>
                                    ...
                                    <?php else : ?>
                                      ...
                                      <tr>
                                        <td colspan="1" id="talla1">Cantidad de Unidades</td>
                                        <td colspan="1" id="talla1">Temp Secado Tunel</td>
                                        <td colspan="1" id="talla1">Temp Secado Tinteros</td>
                                        <td colspan="1" id="talla1">Numero de Pistas</td>
                                        <td colspan="1" id="talla1">Rep. Perimetro</td>
                                        <td colspan="1" id="talla1">Arte Aprobado</td>
                                        <td colspan="1" id="talla1">Guia Fotocelda</td>
                                        <td colspan="1" id="talla1">Velocidad Maquina</td>
                                        <td colspan="1" id="talla1">Z</td>
                                      </tr>
                                      <tr>
                                        <td colspan="1" id="talla1">
                                      ...
                                      <tr>
                                        <td colspan="1" id="talla1">Tension Desbobinador</td>
                                        <td colspan="1" id="talla1">Tension Refrescador</td>
                                        <td colspan="1" id="talla1">Tension Rebobinador</td>
                                      </tr>
                                      <tr>
                                        <td id="talla1">
                            ...
                            <tr id="tr1">
                              <td colspan="12" id="fuente1"><textarea name="observ_impre_op" style="width: 100%" rows="3" id="observ_impre_op"><?php echo $row_orden_produccion['observ_impre_op']; ?></textarea></td>
                            </tr>
                                ...
                                <table>
                                  ...
                                  <tr>
                                    <td id="talla1"><?php echo $row_datos_ref['ancho_ref']; ?>
                                      <input type="hidden" name="ancho" id="ancho" value="<?php echo $row_datos_oc['ancho_ref']; ?>" />
                                    </td>
                                    <td id="talla1"><?php echo $row_datos_ref['largo_ref']; ?>
                                      <input type="hidden" name="largo" id="largo" value="<?php echo $row_datos_oc['largo_ref']; ?>" />
                                    </td>
                                    <td nowrap="nowrap" id="talla1"><?php echo $row_datos_ref['solapa_ref']; ?>
                                      <input type="hidden" name="solapa" id="solapa" value="<?php echo $row_datos_oc['solapa_ref']; ?>" />
                                    </td>
                                    <td id="talla1">&nbsp;</td>
                                  ...
                                  <tr>
                                    ...
                                    <td id="talla1"><?php echo $row_datos_ref['N_fuelle']; ?>
                                      <input type="hidden" name="fuelle" id="fuelle" value="<?php echo $row_datos_ref['N_fuelle']; ?>" />
                                    </td>
                                    <td id="talla1">&nbsp; </td>
                                  ...
                                  <tr>
                                    ...
                                    <td id="talla1"><input name="int_undxcaja_op" type="number" id="int_undxcaja_op" style="width:50px" min="0" <?php if ($row_orden_produccion['int_undxcaja_op'] != $row_datos_oc['unids_caja_egp']) { ?> class="rojo_normal" onclick="return valida_paqycaj()" <?php } ?> value="<?php echo $row_orden_produccion['int_undxcaja_op']==''? $row_datos_oc['unids_caja_egp']:$row_orden_produccion['int_undxcaja_op']; ?>" size="12" onBlur="alerta()" /></td>
                                    ...
                                    <td id="talla2">
                                      <?php if ($row_datos_oc['B_troque'] == '1') {
                                        echo "SI";
                                      } else {
                                        echo "NO";
                                      }; ?>
                            ...
                            <tr id="tr1">
                              <td colspan="12" id="fuente1"><textarea name="observ_sellado_op" style="width: 100%" rows="3" id="observ_sellado_op"><?php echo $row_orden_produccion['observ_sellado_op']; ?></textarea></td>
                            </tr>
                            <?php //}
                            ?>
                            <tr>
