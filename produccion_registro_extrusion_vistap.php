  ...
  <div align="center">
    <table id="tablainterna">
      ...
      <tr>
        ...
        <td id="fuente3"><?php echo $totaltiem;?>
        </td>
        ...
        <table border="0">
          ...
          <?php do { ?>
            <tr>
              ...
              <td id="fuente2"><?php echo horadecimalUna($row_extrusion_vista['total_horas_rp']);
                                $totalf += horadecimalUna($row_extrusion_vista['total_horas_rp']); ?></td>
              <!-- <td id="fuente2">
                <?php
              ...
              <td id="fuente2"><?php $rodami_horas = ($totalh * 60) - $tiempoM;
                                echo horadecimalUna($rodami_horas / 60) ?></td>
              <td id="fuente2"><?php
          ...
          <?php } while ($row_extrusion_vista = mysql_fetch_assoc($extrusion_vista)); ?> <tr>
           ...
           <!--  <td id="fuente2"><strong><?php echo redondear_decimal($totalhorasTodosRollos); ?></strong></td> -->
            <td id="fuente2"><strong><?php echo redondear_decimal($totalf); ?></strong></td>
            <td id="fuente2">&nbsp;</td>
