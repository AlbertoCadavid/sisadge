...
//ENVIO DE E-MAIL A FACTURACION
    ...
    if ((isset($cambioEstado) && ($cambioEstado=='5')||$cambioEstado=='4')){
      ...
      if($cambioEstado=='4'){$facpot="Parcial";}else if($cambioEstado=='5'){
        $facpot="Total";
      }
                        ...
                        <?php do { ?>
                          <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF"> 
                            ...
                            if($mp!='')
                            {
                              ...
                              }  ?><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $nombre_mp; }?></a></td>
                              ...
                              <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php if($row_items['int_cantidad_rest_io']==''){echo '0.00';}else{echo $row_items['int_cantidad_rest_io'];} ?></a></td>
                            ...
                            <?php do { ?>
                                ...
                                <td id="talla2">                 
                                  ...
                                  if($mp!='')
                                  {
                                    ...
                                    <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_cant_rd']; ?></a>
                                      ...
                                      <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_caja_rd'];$cajas=$cajas+$row_remision_detalle['int_total_cajas_rd']; ?></a></td>
                                      ...
                                      <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_numh_rd'];$total=$subtotal+$row_remision_detalle['int_total_item_io'];?></a></td>
                              ...
                              <tr>
                                <td colspan="4"id="nivel3"><strong>TOTAL CAJAS:</strong>
                                  <input type="text" name="FG" id="FG" size="5" value="<?php echo $cajas; ?>"></td>
                                </tr>
                                <tr>
                                  <td colspan="4"id="nivel3"><strong>TOTAL PESO:</strong>
                                    <input type="text" name="FG2" id="FG2" size="5" value="<?php echo $peso ?>"readonly></td>
                                  </tr>
                                  <tr>
                                    <td colspan="4"id="nivel3"><strong>TOTAL P/NETO:</strong>
                                      <input type="text" name="FG3" id="FG3" size="5"value="<?php echo $peson ?>"readonly></td>
                                    </tr>
                                    <tr>
