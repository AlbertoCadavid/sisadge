...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && ($_POST['remision']
  == '')) {




  echo "<script type=\"text/javascript\">alert(\"NO SE PUEDE GUARDAR, REMISION SIN ITEMS INGRESADOS\");history.go(-1)</script>";
}
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && ($_POST['remision'] != '')) {
  ...
  if (isset($_FILES['comprobante_file']) && $_FILES['comprobante_file']['name'] != "") {
    ...
    $tieneadjunto1 = adjuntarArchivo($tieneadjunto1, $directorio, $name, $_FILES['comprobante_file']['tmp_name'], 'UPDATES');
  ...
  //ACTUALIZO A REMISIONADA LA O.C SI TIENE UNA NUEVA REMISION
  $conexion = new ApptivaDB();

  $cambioestadosoc = $conexion->conteos("tbl_remision_detalle", "int_remision_r_rd", "WHERE str_numero_oc_rd='" . $_POST['str_numero_oc_r'] . "' ", " ");

  if ($cambioestadosoc['total'] > 1) {

    $cambioEstado = '3';
  } else {
    $cambioEstado = $_POST['b_estado_oc'];
  }
  //FIN


  $updateSQL = sprintf(
    "UPDATE Tbl_remisiones SET str_numero_oc_r=%s,fecha_r=%s,str_encargado_r=%s,str_transportador_r=%s,str_guia_r=%s,
  ...
  $actualiza = $conexion->actualizar("tbl_orden_compra", "b_estado_oc='" . $cambioEstado . "' ", " str_numero_oc='" . $_POST['str_numero_oc_r'] . "' ");


  /*$updateSQL2 = sprintf("UPDATE tbl_orden_compra SET b_estado_oc=%s WHERE str_numero_oc=%s", 
    GetSQLValueString($cambioEstado, "int"),
    GetSQLValueString($_POST['str_numero_oc_r'], "text"));
  ...
  if ((isset($cambioEstado) && ($cambioEstado == '5') || $cambioEstado == '4')) {

    $fac = $cambioEstado;

    if ($cambioEstado == '4') {
      $facpot = "Parcial";
    } else if ($cambioEstado == '5') {
      $facpot = "Total";
    }
  }

  $updateGoTo = "despacho_items_oc_vista.php?mostrar=" . $_POST['mostrar_ob'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<body>
  ...
  <table align="center" id="tabla">
    <tr align="center">
      <td>
        <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" onSubmit="MM_validateForm('fecha_r','','R','str_encargado_r','','R','str_guia_r','','R','str_transportador_r','','R','str_elaboro_r','','R','str_aprobo_r','','R');return document.MM_returnValue">
          <table class="table">
            <tr id="tr1">
            ...
            <tr>
              ...
              <td id="dato2">
                ...
                if ($existe_op == '0') {
                ?>
                  <a href="javascript:eliminar1('int_remision',<?php echo $row_remision['int_remision']; ?>,'despacho_oc.php')"><img src="images/por.gif" alt="ELIMINAR REMISION" title="ELIMINAR REMISION" border="0" style="cursor:hand;" /></a><?php } else { ?><img src="images/por.gif" alt="ELIMINAR O.C." title="ELIMINAR O.C." border="0" style="cursor:hand;" onClick="enProduccion();" /><?php } ?><a href="despacho_items_oc_vista.php?int_remision=<?php echo $row_remision['int_remision']; ?>&str_numero_r=<?php echo $row_remision['str_numero_oc_r']; ?>"><img src="images/hoja.gif" alt="VISTA IMPRESION" title="VISTA IMPRESION" border="0" style="cursor:hand;" /></a><a href="despacho_oc.php"><img src="images/r.gif" style="cursor:hand;" alt="LISTADO_DESPACHOS" title="LISTADO DESPACHOS" border="0" /></a><a href="menu.php"><img src="images/identico.gif" style="cursor:hand;" alt="MENU PRINCIPAL" title="MENU PRINCIPAL" border="0" /></a><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;" onClick="window.history.go()" />
              </td>
            </tr>
            <tr>
              <td id="numero2">N&deg;
                <input name="int_remision" type="text" size="15" class="rojo_inteso" value="<?php echo $row_remision['int_remision']; ?>" readonly />
              </td>
              <td id="dato_1">
            ...
            <tr>
              <td colspan="2" id="dato1">ORDEN DE COMPRA N&deg : <b><?php echo $row_remision['str_numero_oc_r']; ?></b></td>
            </tr>
            <tr>
                ...
                <table class="table"><!--se cambio tabla2 x tabla1-->
                  <tr>
                    <td colspan="2" id="dato1"><strong>CLIENTE: </strong>
                      <?php $cad4 = htmlentities($row_orden_compra['nombre_c']);
                      echo $cad4; ?></td>
                    <td width="50%" colspan="2" id="dato1"><strong>PAIS / CIUDAD : </strong><?php $cad2 = htmlentities($row_remision['ciudad_pais']); ?>
                      <input type="text" name="ciudad_pais" id="ciudad_pais" size="40" maxlength="200" value="<?php echo $cad . ' / ' . $cad2; ?>" onKeyUp="conMayusculas(this)">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="4" id="dato1"><strong>DIRECCCION COMERCIAL:</strong>
                      <?php $cade = htmlentities($row_orden_compra['str_dir_entrega_oc']);
                      echo $cade; ?>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="4" id="dato1"><strong>DIRECCCION ENVIO FACTURA:</strong>
                      <?php $cade2 = htmlentities($row_orden_compra['direccion_envio_factura_c']);
                      echo $cade2; ?>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="4" id="dato1"><strong>SALIDAS TIPO: </strong>
                      <?php if (!(strcmp("0", $row_orden_compra['salida_oc']))) {
                        echo "Normal";
                      } ?>
                      <?php if (!(strcmp("1", $row_orden_compra['salida_oc']))) {
                        echo "Reposiciones";
                      } ?>
                      <?php if (!(strcmp("2", $row_orden_compra['salida_oc']))) {
                        echo "Muestras";
                      } ?>
                      <?php if (!(strcmp("3", $row_orden_compra['salida_oc']))) {
                        echo "Salidas especiales";
                      } ?></td>
                  </tr>
                  <tr>
                    <td width="14%" id="dato1"><strong>ENCARGADO:</strong> </td>
                    <td width="36%" id="dato1"><input name="str_encargado_r" type="text" id="str_encargado_r" value="<?php echo $row_remision['str_encargado_r']; ?>" onKeyUp="conMayusculas(this)" required="required"></td>
                    <td id="dato1"><strong>GUIA : </strong> </td>
                    <td id="dato1"><input type="text" name="str_guia_r" id="str_guia_r" size="15" value="<?php echo $row_remision['str_guia_r']; ?>" onKeyUp="conMayusculas(this)" onBlur="MM_validateForm('str_guia_r','','R');return document.MM_returnValue" required="required"></td>
                  </tr>
                  <tr>
                    <td id="dato1"><strong>TRANSPORTADOR:</strong></td>
                    <td id="dato1"><strong>
                        <input type="text" name="str_transportador_r" id="str_transportador_r" value="<?php echo $row_remision['str_transportador_r']; ?>" onKeyUp="conMayusculas(this)" onBlur="MM_validateForm('str_transportador_r','','R');return document.MM_returnValue" required="required">
                      </strong></td>
                    <td id="dato1"><strong>DESPACHADO POR :

                      </strong></td>
                    <td id="dato1"><strong>
                        <input name="str_elaboro_r" type="text" onKeyUp="conMayusculas(this)" id="str_elaboro_r" value="<?php echo $row_remision['str_elaboro_r']; ?>" size="15" required="required">
                      </strong></td>
                  </tr>
                  <tr>
                    <td id="dato1"><strong>APROBADO POR</strong></td>
                    <td id="dato1"><input name="str_aprobo_r" type="text" id="str_aprobo_r" value="<?php echo $row_remision['str_aprobo_r']; ?>" onKeyUp="conMayusculas(this)" required></td>
                    <td id="dato1"><strong>FACTURA:</strong></td>
                    <td id="dato1"><input style="width: 140px" type="text" name="factura_r" id="factura_r" min="0" size="15" required value="<?php echo $row_remision['factura_r']; ?>"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="4" id="dato1">Adjuntar Comprobante de Entrega:
                      <input name="comprobante_file" type="file" size="100" maxlength="100" class="botones_file">
                      ...
                      <a href="javascript:verFoto('Archivosdesp/<?php echo $row_remision['comprobante_file']; ?>','610','490')">
                        <?php if ($row_remision['comprobante_file'] != '') {
                          echo "VER COMPROBANTE";
                        } else {
                          'Sin Adjunto';
                        } ?>
                      </a>
                  ...
                  <tr>
                    <td colspan="4" id="dato2"><textarea name="str_observacion_r" cols="70" onKeyUp="conMayusculas(this)" rows="8" id="str_observacion_oc"><?php echo $row_remision['str_observacion_r']; ?></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="4" id="dato1"></td>
                  ...
                  <table class="table">
                    ...
                    <?php do { ?>
                      <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_consecutivo_io']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_cod_ref_io']; ?></a></td>
                        <td id="talla2"><?php $mp = $row_items['id_mp_vta_io'];
                                        if ($mp != '') {
                                          ...
                                          }  ?><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $nombre_mp;
                                                                                                                                                                                                                                                                              } ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_cod_cliente_io']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_cantidad_io']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php if ($row_items['int_cantidad_rest_io'] == '') {
                                                                                                                                                                                                                                                                                      echo '0.00';
                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                      echo $row_items['int_cantidad_rest_io'];
                                                                                                                                                                                                                                                                                    } ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['str_unidad_io']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['fecha_entrega_io']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['impuesto'] == 1 ? 'SI' : 'NO'; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_items['int_precio_io']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php //echo $row_items['int_total_item_io'];$total=$subtotal+$row_items['int_total_item_io'];
                                                                                                                                                                                                                                                                                    ?>
                            <?php echo $total = $subtotal + ($row_items['int_cantidad_io'] * $row_items['N_precio_old']); ?>
                          </a></td>
                        ...
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php $ca = htmlentities($row_items['str_direccion_desp_io']);
                                                                                                                                                                                                                                                                                    echo $ca; ?></a></td>
                        <td nowrap="nowrap" id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_items=<?php echo $row_items['id_items']; ?>&int_remision=<?php echo $row_remision['int_remision']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000">
                            <?php if ($row_items['b_estado_io'] == '5') {
                              echo "Facturado Total";
                            } else if ($row_items['b_estado_io'] == '4') {
                              echo "Facturado Parcial";
                            } else if ($row_items['b_estado_io'] == '1') {
                              echo "Ingresado";
                            } else if ($row_items['b_estado_io'] == '2') {
                              echo "Programado";
                            } else if ($row_items['b_estado_io'] == '3') {
                              echo "Remisionado";
                            } else if ($row_items['b_estado_io'] == '6') {
                              echo "Muestras reposicion";
                            }  ?>
                          </a></td>
                      </tr>
                ...
                <td colspan="4" id="dato2">
                  <table id="tabla1">
                    ...
                    <?php do { ?>
                      <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                        <td id="talla1">
                          <a href="javascript:eliminar1('id_rd',<?php echo $row_remision_detalle['id_rd']; ?>,'despacho_oc_add_detalle.php')"><img src="images/por.gif" alt="ELIMINAR REMISION" title="ELIMINAR REMISION" border="0" style="cursor:hand;" /></a>
                        </td>
                        <td id="talla2">
                          <input type="hidden" name="remision" id="remision" value="<?php echo $row_remision_detalle['int_remision_r_rd']; ?>">
                          <input type="hidden" name="refac" id="refac" value="<?php $r = $row_remision_detalle['int_ref_io_rd'];
                                                                              echo $r; ?>">
                          <a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_ref_io_rd']; ?></a>
                        </td>
                        ...
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['str_ref_cl_io_rd']; ?></a></td>
                        ...
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_cant_rd']; ?></a>
                          <input type="hidden" name="cant" id="cant" value="<?php $can = $row_remision_detalle['int_cant_rd'];
                                                                            echo $can; ?>">
                        </td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_caja_rd'];
                                                                                                                                                                                                                                $cajas = $cajas + $row_remision_detalle['int_total_cajas_rd']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_numd_rd']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_numh_rd'];
                                                                                                                                                                                                                                $total = $subtotal + $row_remision_detalle['int_total_item_io']; ?></a></td>
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_peso_rd'];
                                                                                                                                                                                                                                $peso = $peso + $row_remision_detalle['int_peso_rd']; ?></a></td>
                        ...
                        <td id="talla2"><a href="javascript:verFoto('despacho_oc_edit_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_remision_detalle['int_pesoneto_rd'];
                                                                                                                                                                                                                                $peson = $peson + $row_remision_detalle['int_pesoneto_rd']; ?></a></td>
                        ...
                        <td nowrap="nowrap" id="talla2"><a href="javascript:verFoto('despacho_oc_add_detalle.php?id_rd=<?php echo $row_remision_detalle['id_rd']; ?>','1100','600')" target="_top" style="text-decoration:none; color:#000000">
                            <?php if ($row_remision_detalle['b_estado_io'] == '5') {
                              echo "Facturado Total";
                            } else if ($row_remision_detalle['b_estado_io'] == '4') {
                              echo "Facturado Parcial";
                            } else if ($row_remision_detalle['b_estado_io'] == '1') {
                              echo "Ingresado";
                            } else if ($row_remision_detalle['b_estado_io'] == '2') {
                              echo "Programado";
                            } else if ($row_remision_detalle['b_estado_io'] == '3') {
                              echo "Remisionado";
                            } else if ($row_items['b_estado_io'] == '6') {
                              echo "Muestras reposicion";
                            }  ?>
            ...
            <tr>
              <td colspan="13" id="fuente2"><?php
                                            ...
                                            if ($row_orden_compra['str_archivo_oc'] == '') {
                                              echo "Sin Archivo";
                                            } else { ?><a href="javascript:verFoto('pdfacturasoc/<?php echo $muestra; ?>','610','490')"> <?php echo "ARCHIVO"; ?></a><?php } ?>
              </td>
            </tr>
            <tr>
              <td colspan="4" id="fuente2"><strong>ESTADO DE LA ORDEN DE COMPRA</strong>
                <select name="b_estado_oc" id="b_estado_oc" onChange="ActualizarEstadosRemision(this)">
                  <option value="3" <?php if (!(strcmp("3", $row_orden_compra['b_estado_oc']))) {
                                      echo "selected=\"selected\"";
                                    } ?>>REMISIONADA</option>
                  <option value="4" <?php if (!(strcmp("4", $row_orden_compra['b_estado_oc']))) {
                                      echo "selected=\"selected\"";
                                    } ?>>FACTURADA PARCIAL</option>
                  <option value="5" <?php if (!(strcmp("5", $row_orden_compra['b_estado_oc']))) {
                                      echo "selected=\"selected\"";
                                    } ?>>FACTURADA TOTAL</option>
                </select>
              </td>
            </tr>
            <tr>
              <td colspan="4" id="nivel3"><strong>TOTAL CAJAS:</strong>
                <input type="text" name="FG" id="FG" size="5" value="<?php echo $cajas; ?>">
              </td>
            </tr>
            <tr>
              <td colspan="4" id="nivel3"><strong>TOTAL PESO:</strong>
                <input type="text" name="FG2" id="FG2" size="5" value="<?php echo $peso ?>" readonly>
              </td>
            </tr>
            <tr>
              <td colspan="4" id="nivel3"><strong>TOTAL P/NETO:</strong>
                <input type="text" name="FG3" id="FG3" size="5" value="<?php echo $peson ?>" readonly>
              </td>
            </tr>
            <tr>
              <td colspan="3" id="fuente2"><input type="checkbox" <?php echo "checked=\"checked\""; ?> name="mostrar_ob" id="mostrar_ob" value="1">
                <label for="mostrar_ob">Mostrar observaciones</label>
              </td>
            </tr>
            <tr>
              <td colspan="3" id="dato3">
                <p><br>
                  <a class="botonGMini" target="_blank" href="view_index.php?c=cremision&a=Crud&id=<?php echo $row_remision['int_remision']; ?>&columna=int_remision&tabla=tbl_remisiones_historico">VER HISTORICO DE MODIFICACIONES</a>
                </p>
            ...
            <tr>
              <td colspan="3" id="fuente2">
                ...
                <input class="botonFinalizar" type="submit" value="FINALIZAR">
              </td>
            </tr>
          </table>
        </form>
