  ...
  <div class="spiffy_content"> <!-- este define el fondo gris de lado a lado si se coloca dentro de tabla inicial solamente coloca borde gris -->
    <div align="center">
      <table id="tabla1">
                      ...
                      <form action="guardar.php" method="post" id="form1" name="form1">
                        <table id="tabla1">
                          <tr>
                            ...
                            <option value=""<?php if (!(strcmp("", $row_existe['cliente']))) {
                                              echo "selected=\"selected\"";
                                            } ?>>Seleccione Cliente</option>
                            <?php foreach ($proveedores as $row_proveedores) { ?>
                            <option value="<?php echo $row_proveedores['id_p']; ?>"<?php if (!(strcmp($row_proveedores['id_p'], $row_existe['cliente']))) {
                                                                                      echo "selected=\"selected\"";
                            ...
                            <td>
                              ...
                              <select id="entrada" name="entrada" required="required" class="form-control">
                                ...
                                <option value="Entrada" <?php if (!(strcmp("Entrada", $row_existe['entrada']))) {
                                                          echo "selected=\"selected\"";
                                                        } ?>>Entrada</option>
                                <option value="Salida" <?php if (!(strcmp("Salida", $row_existe['entrada']))) {
                                                          echo "selected=\"selected\"";
                                                        } ?>>Salida</option>
                              </select>
                            </td>
                                  ...
                                  <tr>
                                    <td colspan="12" id="dato1">
                                      ...
                                      <select id="medida[]" name="medida[]" required="required" style="width:70px">
                                        <option value="" <?php if (!(strcmp("", $row_existe['medida']))) {
                                                            echo "selected=\"selected\"";
                                                          } ?>>Seleccione</option>
                                        <option value="unidad" <?php if (!(strcmp("unidad", $row_existe['medida']))) {
                                                                  echo "selected=\"selected\"";
                                                                } ?>>Unidad</option>
                                        <option value="kilo" <?php if (!(strcmp("kilo", $row_existe['medida']))) {
                                                                echo "selected=\"selected\"";
                                                              } ?>>Kilo</option>
                                        <option value="rollo" <?php if (!(strcmp("rollo", $row_existe['medida']))) {
                                                                echo "selected=\"selected\"";
                                                              } ?>>Rollo</option>
                                      </select> &nbsp;
                                      <input onChange="multiplicaTotal(<?php echo $i; ?>,this)" type="text" required="required" placeholder="Cantidad" id="cantidad<?php echo $i; ?>" name="cantidad[]" value="<?php echo $row_insumos['cantidad']; ?>" style="width:70px">&nbsp;
                                      <input onChange="multiplicaTotal(<?php echo $i; ?>,this)" type="text" required="required" placeholder="Peso" id="peso<?php echo $i; ?>" name="peso[]" value="<?php echo $row_insumos['peso']; ?>" style="width:80px">&nbsp;
        ...
        <tr>
          <td>
            <div class="panel-footer" id="continuar" style="align-items: left;">
