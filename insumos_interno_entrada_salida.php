                  ...
                  <tr>
                      <td colspan="12" id="dato1">
                        ...
                        <select id="medida[]" name="medida[]" required="required" style="width:70px">
                             <option value=""<?php if (!(strcmp("", $row_existe['medida']))) {echo "selected=\"selected\"";} ?>>Seleccione</option>
                             <option value="unidad"<?php if (!(strcmp("unidad", $row_existe['medida']))) {echo "selected=\"selected\"";} ?>>Unidad</option>
                             <option value="kilo"<?php if (!(strcmp("kilo", $row_existe['medida']))) {echo "selected=\"selected\"";} ?>>Kilo</option>
                             <option value="rollo"<?php if (!(strcmp("rollo", $row_existe['medida']))) {echo "selected=\"selected\"";} ?>>Rollo</option>
                        </select> &nbsp;
