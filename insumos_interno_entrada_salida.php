                    ...
                    <div class="container">
                      ...
                      <form action="guardar.php" method="post" id="form1" name="form1">
                        <table id="tabla1">
                          ...
                          <tr>
                            <td>
                              <strong>NIT / C.C:</strong>&nbsp;&nbsp;<input readonly type="text" required="required" id="documento" name="documento" value="" class="form-control negro_inteso">
                            </td>
                            <td>
                                ...
                                <?php for ($i = 1; $i <= 8; $i++) { ?>
                                  ...
                                  <tr>
                                    <td colspan="12" id="dato1">
                                      ...
                                      <select class="medida" oninput="unlock()" id="medida[]" name="medida[]" required="required" style="width:70px">
...
<script type="text/javascript">
  ...
  function subtotal() {
    var total = 0;
    cant = document.getElementsByClassName('cantidad')
