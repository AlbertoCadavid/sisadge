...
class cmezclasimController
{
    ...
    {
        $ordenc = new oMmezclasIm();
        $vista = 'produccion_registro_impresion_listado.php';
    ...
    public function Mezcla()
    {
        ...
        if (isset($_REQUEST['cod_ref'])) {
            ...
            if ($_REQUEST['cod_refcopia']) {
                ...
                $this->row_caract = $row_caract->Obtener('tbl_caracteristicas_impresion cp ', " cp.cod_ref_ci ", "" . $_REQUEST['cod_ref'] . "");
    ...
    public function Carat()
    {
        ...
        if (isset($_REQUEST['cod_ref'])) {
            ...
            if ($_REQUEST['cod_refcopia']) {
                $this->row_caract = $row_caract->Obtener('tbl_caracteristicas_impresion cp ', " cp.cod_ref_ci ", "" . $_REQUEST['cod_refcopia'] . "");
                //$this->row_caract = $row_caract->Obtener('tbl_caracteristicas_prod cp LEFT JOIN tbl_produccion_mezclas pm ON pm.int_cod_ref_pm = cp.cod_ref', " proceso=2 AND cp.cod_ref ", "" . $_REQUEST['cod_refcopia'] . "");
                //$this->row_mezcla = $row_mezcla->Obtener('tbl_produccion_mezclas', "id_proceso=2 AND int_cod_ref_pm ", "" . $_REQUEST['cod_refcopia'] . "");
            } else {
    ...
    public function Guardar()
    {
        ...
        $this->mezclas->RegistrarCaracteristicas("tbl_caracteristicas_impresion", "id_ref_ci, cod_ref_ci, fecha_registro, usuario, modifico, fecha_modif, maquina, version_ref_ci, color1, val_color1, color2, val_color2, color3, val_color3, color4, val_color4, color5, val_color5, color6, val_color6, color7, val_color7, color8, val_color8, mezcla1, val_mezcla1, mezcla2, val_mezcla2, mezcla3, val_mezcla3, mezcla4, val_mezcla4, mezcla5, val_mezcla5, mezcla6, val_mezcla6, mezcla7, val_mezcla7, mezcla8, val_mezcla8, mezcla9, val_mezcla9, mezcla10, val_mezcla10, mezcla11, val_mezcla11, mezcla12, val_mezcla12, mezcla13, val_mezcla13, mezcla14, val_mezcla14, mezcla15, val_mezcla15, mezcla16, val_mezcla16, mezcla17, val_mezcla17, mezcla18, val_mezcla18, mezcla19, val_mezcla19, mezcla20, val_mezcla20, mezcla21, val_mezcla21, mezcla22, val_mezcla22, mezcla23, val_mezcla23, mezcla24, val_mezcla24, mezcla25, val_mezcla25, mezcla26, val_mezcla26, mezcla27, val_mezcla27, mezcla28, val_mezcla28, mezcla29, val_mezcla29, mezcla30, val_mezcla30, mezcla31, val_mezcla31, mezcla32, val_mezcla32, alcohol1, val_alcohol1, alcohol2, val_alcohol2, alcohol3, val_alcohol3, alcohol4, val_alcohol4, alcohol5, val_alcohol5, alcohol6, val_alcohol6, alcohol7, val_alcohol7, alcohol8, val_alcohol8, acetato1, val_acetato1, acetato2, val_acetato2, acetato3, val_acetato3, acetato4, val_acetato4, acetato5, val_acetato5, acetato6, val_acetato6, acetato7, val_acetato7, acetato8, val_acetato8, metoxi1, val_metoxi1, metoxi2, val_metoxi2, metoxi3, val_metoxi3, metoxi4, val_metoxi4, metoxi5, val_metoxi5, metoxi6, val_metoxi6, metoxi7, val_metoxi7, metoxi8, val_metoxi8, stik1, stik2, stik3, stik4, stik5, stik6, stik7, stik8, visco1, visco2, visco3, visco4, visco5, visco6, visco7, visco8, anilox1, anilox2, anilox3, anilox4, anilox5, anilox6, anilox7, anilox8, observ_ci, cant_unidades, temp_tunel, temp_tintas, rep_ancho, rep_perimetro, arte, z, guia_fotoc, velocidad, tension_desbo, tension_refres, tension_rebo", "cod_ref_ci", $_POST['cod_ref_ci'],  $this->proforma);
        $this->mezclas->RegistrarHistorico("tbl_historico_caracteristicas_impresion", "id_ref_ci, cod_ref_ci, fecha_registro, usuario, modifico, fecha_modif, maquina, version_ref_ci, color1, val_color1, color2, val_color2, color3, val_color3, color4, val_color4, color5, val_color5, color6, val_color6, color7, val_color7, color8, val_color8, mezcla1, val_mezcla1, mezcla2, val_mezcla2, mezcla3, val_mezcla3, mezcla4, val_mezcla4, mezcla5, val_mezcla5, mezcla6, val_mezcla6, mezcla7, val_mezcla7, mezcla8, val_mezcla8, mezcla9, val_mezcla9, mezcla10, val_mezcla10, mezcla11, val_mezcla11, mezcla12, val_mezcla12, mezcla13, val_mezcla13, mezcla14, val_mezcla14, mezcla15, val_mezcla15, mezcla16, val_mezcla16, mezcla17, val_mezcla17, mezcla18, val_mezcla18, mezcla19, val_mezcla19, mezcla20, val_mezcla20, mezcla21, val_mezcla21, mezcla22, val_mezcla22, mezcla23, val_mezcla23, mezcla24, val_mezcla24, mezcla25, val_mezcla25, mezcla26, val_mezcla26, mezcla27, val_mezcla27, mezcla28, val_mezcla28, mezcla29, val_mezcla29, mezcla30, val_mezcla30, mezcla31, val_mezcla31, mezcla32, val_mezcla32, alcohol1, val_alcohol1, alcohol2, val_alcohol2, alcohol3, val_alcohol3, alcohol4, val_alcohol4, alcohol5, val_alcohol5, alcohol6, val_alcohol6, alcohol7, val_alcohol7, alcohol8, val_alcohol8, acetato1, val_acetato1, acetato2, val_acetato2, acetato3, val_acetato3, acetato4, val_acetato4, acetato5, val_acetato5, acetato6, val_acetato6, acetato7, val_acetato7, acetato8, val_acetato8, metoxi1, val_metoxi1, metoxi2, val_metoxi2, metoxi3, val_metoxi3, metoxi4, val_metoxi