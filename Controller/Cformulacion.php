...
class CformulacionController{
    ...
    public function Inicio(){
        $modelos = new oFormulacion(); 
        $this->modelos=$modelos->Obtener("tbl_formulacion "," * "," " );
           /* echo '<pre>';
    ...
    public function Editar(){  
        ...
        if($_REQUEST['MM_update']=='form2' ){
          ...
          $this->modelos_editar=$modelos_editar->Update("UPDATE tbl_formulacion SET nombre='".$_REQUEST['nombre']."',formulacion='".$_REQUEST['formulacion']."' WHERE id_for=$id_for ");
         header("Location:view_index.php?c=cformulacion&a=Inicio"); 
    ...
    public function Guardar($vista=''){
        ...
        $this->modelos->Registrar("tbl_formulacion", "nombre,formulacion", $_REQUEST);  
