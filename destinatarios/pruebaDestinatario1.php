...
mysql_select_db($database_conexion1, $conexion1);
$query_n_ciudad = "select * FROM ciudades_col ";
...
/*					   GetSQLValueString(isset($_POST['bolsa_plastica_c']) ? "true" : "", "defined","1","0"),
                       ...
                       GetSQLValueString($_POST['ciudad_c'], "text"),
                       ...
                       GetSQLValueString(isset($_POST['otros_doc_c']) ? "true" : "", "defined","1","0"),
     ...
     <form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso_c','','R','fecha_solicitud_c','','R','nombre_c','','R','nit_c','','R','rep_legal_c','','R','telefono_c','','R','direccion_c','','R','pais_c','','R','ciudad_c','','R','registrado_c','','R');return document.MM_returnValue">
       <table width="63%" id="tabla_formato2">
         ...
         <tr>
           ...
           <td width="16%" id="dato_1">Fecha de Solicitud</td>
...
/*		   mysql_select_db($database_conexion1, $conexion1);		  
    ...
    ?>
         ...
         <tr>
           <td colspan="4" id="dato_5"><textarea name="observ_inf_c" cols="100" rows="2"onChange="conMayusculas(this)"></textarea></td>
         </tr>
       
           <td colspan="4" id="dato_1"><table width="822" border="1">
             <tr>
               <td width="87">NIT</td>
               <td width="117">RESPONSABLE</td>
               <td width="108">DIRECCION</td>
               <td width="114">TELEFONO</td>
               <td width="129">CIUDAD</td>
               <td width="227"><input name="destinatario" type="button" value="AGREGAR" /></td>
             </tr>
             <tr>
    <td><input type="varchar" name="nit" id="nit" size="10"/></td>
    <td><input type="varchar" name="responsable" id="responsable" size="10"/></td>
    <td><input type="varchar" name="direccion" id="direccion"size="10" /></td>
    <td><input type="varchar" name="telefono" id="telefono"size="10" /></td>
    <td><input type="varchar" name="ciudad" id="ciudad" size="10"/></td>
    <td><?php 
 $insertSQL ="INSERT INTO Tbl_Destinatarios (nit, nombre_responsable, direccion, telefono, ciudad ) VALUES ('$_POST[nit]', '$_POST[responsable]', '$_POST[direccion]', '$_POST[telefono]', '$_POST[ciudad]')";
/*                       GetSQLValueString($_POST['nit'], "varchar"),
                       GetSQLValueString($_POST['nombre_responsable'], "varchar"),
                       GetSQLValueString($_POST['direccion'], "varchar"),
                       GetSQLValueString($_POST['telefono'], "varchar"),
                       GetSQLValueString($_POST['ciudad'], "varchar"));*/
